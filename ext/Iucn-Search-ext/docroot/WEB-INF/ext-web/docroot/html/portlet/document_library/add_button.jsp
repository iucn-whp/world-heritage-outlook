...
/*   				System.out.println(fileEntryType.getName()+" "+fileEntryType.getFileEntryTypeId());
 */  				
 		%>
				...
				<portlet:renderURL var="addFileEntryTypeURL">
                    ...
                    <c:if test='<%= fileEntryType.getName().equals("Document") || fileEntryType.getName().equals("Image")%>'>
