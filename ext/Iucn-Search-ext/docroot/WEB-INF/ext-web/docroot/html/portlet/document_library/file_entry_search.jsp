...
<div id="<portlet:namespace />fileEntrySearchContainer">
	<aui:form action="<%= searchURL.toString() %>" method="get" name="fm1" onSubmit='<%= "event.preventDefault(); " + liferayPortletResponse.getNamespace() + "searchFileEntry();" %>'>
		...
		<aui:layout>
			<aui:column columnWidth="70">
				<aui:input cssClass="keywords lfr-search-combobox-item" id="keywords" label="" placeholder="Type to search" name="keywords" type="text" />
			</aui:column>
...
$(window).load(function() {
	//$('#_20_keywords').val("iucn");
$('#_20_search').click();
//$('#_20_documentContainer').hide();
if($('#_20_keywords').val()=='advance_search'){
$('#_20_keywords').val("");
}
else{
