...
<c:if test="<%= !user.isDefaultUser() %>">
	<aui:input cssClass="select-documents aui-state-default checkboxCustom" inline="<%= true %>" label="" name="<%= RowChecker.ALL_ROW_IDS %>" type="checkbox" />
</c:if>
...
<span class="sort-button" id="<portlet:namespace />sortButtonContainer" style="display: none;">
