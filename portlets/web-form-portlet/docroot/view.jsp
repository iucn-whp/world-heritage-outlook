...
<script type="text/javascript" src="${pageContext.request.contextPath}/js/jquery.session.js"></script>
<style>
...
if(typeof($.session.get("backUrl")) === "undefined")
{ $.session.set("backUrl", document.referrer);}
...
<a  href="#"  onclick="javascript:redirectBack()">
<span style="float:right; color:black;"><b>Back   </b></span>
</a>
