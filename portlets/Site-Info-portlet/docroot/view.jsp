...
<%
    ...
    {
        if("Administrator".equalsIgnoreCase(userRoles.get(iUserRole).getName()) ||
                ("WHP Staff".equalsIgnoreCase(userRoles.get(iUserRole).getName()))
                || ("Coordinator".equalsIgnoreCase(userRoles.get(iUserRole).getName())) )
        {
            blnAdminUser = true;
            break;
        }else{
...
<div id="wrapper">
    ...
    <div class="pageHeadingSiteInfoDashboardWrapper">
        <h2 class="pageHeaderTitle">Site Data</h2>
	    ...
	    /* if(siteIds.endsWith(","))
			...
			/*if site has more than one assessment - check all versions */
                            if(tempSiteAssessmentArr.size() > 1){
                                ...
                                if(!cycle2016.isEmpty() && !cycle2016.equals(" ")){
	...
	/*
         ...
         */
                            try {
                                if(assessment_cycle.length() > 0 && assessment_cycle.charAt(0) == ','){
                                    assessment_cycle = assessment_cycle.replaceFirst("^,", "");
                                }
                            } catch (Exception e) {
                                e.printStackTrace();
                            }
