 ...
 * @author alok.sen
 */
public class whp_sites_mgmt_plan_stateClp extends BaseModelImpl<whp_sites_mgmt_plan_state>
	implements whp_sites_mgmt_plan_state {
	public whp_sites_mgmt_plan_stateClp() {
	}
	...
	public void setPrimaryKey(long primaryKey) {
		setWhp_sites_mgmt_plan_state_id(primaryKey);
	}

	public Serializable getPrimaryKeyObj() {
		return new Long(_whp_sites_mgmt_plan_state_id);
	}
	...
	public BaseModel<?> getwhp_sites_mgmt_plan_stateRemoteModel() {
		return _whp_sites_mgmt_plan_stateRemoteModel;
	}

	public void setwhp_sites_mgmt_plan_stateRemoteModel(
		BaseModel<?> whp_sites_mgmt_plan_stateRemoteModel) {
		_whp_sites_mgmt_plan_stateRemoteModel = whp_sites_mgmt_plan_stateRemoteModel;
	}
	...
	public whp_sites_mgmt_plan_state toEscapedModel() {
		return (whp_sites_mgmt_plan_state)Proxy.newProxyInstance(whp_sites_mgmt_plan_state.class.getClassLoader(),
			new Class[] { whp_sites_mgmt_plan_state.class },
			new AutoEscapeBeanHandler(this));
	}

	@Override
	public Object clone() {
		whp_sites_mgmt_plan_stateClp clone = new whp_sites_mgmt_plan_stateClp();

		clone.setWhp_sites_mgmt_plan_state_id(getWhp_sites_mgmt_plan_state_id());
	...
	public int compareTo(whp_sites_mgmt_plan_state whp_sites_mgmt_plan_state) {
		long primaryKey = whp_sites_mgmt_plan_state.getPrimaryKey();
	...
	public boolean equals(Object obj) {
		...
		whp_sites_mgmt_plan_stateClp whp_sites_mgmt_plan_state = null;

		try {
			whp_sites_mgmt_plan_state = (whp_sites_mgmt_plan_stateClp)obj;
		}
	...
	public String toString() {
		...
		sb.append(getWhp_sites_mgmt_plan_state_id());
		sb.append(", site_id=");
	...
	public String toXmlString() {
		...
		sb.append("com.iucn.whp.dbservice.model.whp_sites_mgmt_plan_state");
		sb.append("</model-name>");

		sb.append(
			"<column><column-name>whp_sites_mgmt_plan_state_id</column-name><column-value><![CDATA[");
		sb.append(getWhp_sites_mgmt_plan_state_id());
	...
	private BaseModel<?> _whp_sites_mgmt_plan_stateRemoteModel;
}