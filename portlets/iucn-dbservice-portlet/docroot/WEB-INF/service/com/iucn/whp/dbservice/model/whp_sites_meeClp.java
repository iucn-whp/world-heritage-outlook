 ...
 * @author alok.sen
 */
public class whp_sites_meeClp extends BaseModelImpl<whp_sites_mee>
	implements whp_sites_mee {
	public whp_sites_meeClp() {
	}
	...
	public void setPrimaryKey(long primaryKey) {
		setWhp_sites_mee_id(primaryKey);
	}

	public Serializable getPrimaryKeyObj() {
		return new Long(_whp_sites_mee_id);
	}
	...
	public BaseModel<?> getwhp_sites_meeRemoteModel() {
		return _whp_sites_meeRemoteModel;
	}

	public void setwhp_sites_meeRemoteModel(
		BaseModel<?> whp_sites_meeRemoteModel) {
		_whp_sites_meeRemoteModel = whp_sites_meeRemoteModel;
	}
	...
	@Override
	public whp_sites_mee toEscapedModel() {
		return (whp_sites_mee)Proxy.newProxyInstance(whp_sites_mee.class.getClassLoader(),
			new Class[] { whp_sites_mee.class }, new AutoEscapeBeanHandler(this));
	}

	@Override
	public Object clone() {
		whp_sites_meeClp clone = new whp_sites_meeClp();

		clone.setWhp_sites_mee_id(getWhp_sites_mee_id());
	...
	public int compareTo(whp_sites_mee whp_sites_mee) {
		long primaryKey = whp_sites_mee.getPrimaryKey();
	...
	public boolean equals(Object obj) {
		...
		whp_sites_meeClp whp_sites_mee = null;

		try {
			whp_sites_mee = (whp_sites_meeClp)obj;
		}
	...
	public String toString() {
		...
		sb.append("{whp_sites_mee_id=");
		sb.append(getWhp_sites_mee_id());
		sb.append(", site_id=");
	...
	public String toXmlString() {
		...
		sb.append("com.iucn.whp.dbservice.model.whp_sites_mee");
		sb.append("</model-name>");

		sb.append(
			"<column><column-name>whp_sites_mee_id</column-name><column-value><![CDATA[");
		sb.append(getWhp_sites_mee_id());
	...
	private BaseModel<?> _whp_sites_meeRemoteModel;
}