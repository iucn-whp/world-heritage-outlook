...
/**
 * The persistence utility for the whp_sites_dsocr service. This utility wraps {@link whp_sites_dsocrPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 * @generated
 */
public class whp_sites_dsocrUtil {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 ...
	 */
	public static void clearCache(whp_sites_dsocr whp_sites_dsocr) {
		getPersistence().clearCache(whp_sites_dsocr);
	}
	 ...
	 */
	public static List<whp_sites_dsocr> findWithDynamicQuery(
	 ...
	 */
	public static whp_sites_dsocr update(whp_sites_dsocr whp_sites_dsocr,
		boolean merge) throws SystemException {
		return getPersistence().update(whp_sites_dsocr, merge);
	}
	...
	public static whp_sites_dsocr update(whp_sites_dsocr whp_sites_dsocr,
		...
		return getPersistence().update(whp_sites_dsocr, merge, serviceContext);
	}
	...
	*/
	public static void cacheResult(
		...
		getPersistence().cacheResult(whp_sites_dsocr);
	}
	...
	*/
	public static void cacheResult(
		...
		getPersistence().cacheResult(whp_sites_dsocrs);
	}
	...
	*/
	public static com.iucn.whp.dbservice.model.whp_sites_dsocr create(
		long whp_sites_dsocr_id) {
		return getPersistence().create(whp_sites_dsocr_id);
	}
	...
	*/
	...
	public static com.iucn.whp.dbservice.model.whp_sites_dsocr updateImpl(
		com.iucn.whp.dbservice.model.whp_sites_dsocr whp_sites_dsocr,
		boolean merge)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().updateImpl(whp_sites_dsocr, merge);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.iucn.whp.dbservice.model.whp_sites_dsocr findByPrimaryKey(
		long whp_sites_dsocr_id)
		throws com.iucn.whp.dbservice.NoSuch_sites_dsocrException,
			com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().findByPrimaryKey(whp_sites_dsocr_id);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.iucn.whp.dbservice.model.whp_sites_dsocr fetchByPrimaryKey(
		long whp_sites_dsocr_id)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().fetchByPrimaryKey(whp_sites_dsocr_id);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<com.iucn.whp.dbservice.model.whp_sites_dsocr> findAll()
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	*/
	...
	public static whp_sites_dsocrPersistence getPersistence() {
		if (_persistence == null) {
			_persistence = (whp_sites_dsocrPersistence)PortletBeanLocatorUtil.locate(com.iucn.whp.dbservice.service.ClpSerializer.getServletContextName(),
					whp_sites_dsocrPersistence.class.getName());

			ReferenceRegistry.registerReference(whp_sites_dsocrUtil.class,
				"_persistence");
		}
	 ...
	 * @deprecated
	 */
	public void setPersistence(whp_sites_dsocrPersistence persistence) {
	}

	private static whp_sites_dsocrPersistence _persistence;
}