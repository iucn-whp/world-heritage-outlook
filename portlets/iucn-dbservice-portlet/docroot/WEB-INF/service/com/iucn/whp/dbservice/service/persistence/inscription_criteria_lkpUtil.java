...
/**
 * The persistence utility for the inscription_criteria_lkp service. This utility wraps {@link inscription_criteria_lkpPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 * @generated
 */
public class inscription_criteria_lkpUtil {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	...
	public static void clearCache(
		...
		getPersistence().clearCache(inscription_criteria_lkp);
	}
	 ...
	 */
	public static List<inscription_criteria_lkp> findWithDynamicQuery(
	 ...
	 */
	public static inscription_criteria_lkp update(
		inscription_criteria_lkp inscription_criteria_lkp, boolean merge)
		throws SystemException {
		return getPersistence().update(inscription_criteria_lkp, merge);
	}
	...
	public static inscription_criteria_lkp update(
		...
		return getPersistence()
				   .update(inscription_criteria_lkp, merge, serviceContext);
	}
	...
	*/
	public static void cacheResult(
		...
		getPersistence().cacheResult(inscription_criteria_lkp);
	}
	...
	*/
	public static void cacheResult(
		...
		getPersistence().cacheResult(inscription_criteria_lkps);
	}
	...
	*/
	public static com.iucn.whp.dbservice.model.inscription_criteria_lkp create(
		int criteria_id) {
	...
	*/
	public static com.iucn.whp.dbservice.model.inscription_criteria_lkp remove(
		int criteria_id)
	...
	public static com.iucn.whp.dbservice.model.inscription_criteria_lkp updateImpl(
		com.iucn.whp.dbservice.model.inscription_criteria_lkp inscription_criteria_lkp,
		boolean merge)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().updateImpl(inscription_criteria_lkp, merge);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.iucn.whp.dbservice.model.inscription_criteria_lkp findByPrimaryKey(
		int criteria_id)
		throws com.iucn.whp.dbservice.NoSuchinscription_criteria_lkpException,
			com.liferay.portal.kernel.exception.SystemException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.iucn.whp.dbservice.model.inscription_criteria_lkp fetchByPrimaryKey(
		int criteria_id)
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<com.iucn.whp.dbservice.model.inscription_criteria_lkp> findAll()
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	*/
	...
	public static inscription_criteria_lkpPersistence getPersistence() {
		if (_persistence == null) {
			_persistence = (inscription_criteria_lkpPersistence)PortletBeanLocatorUtil.locate(com.iucn.whp.dbservice.service.ClpSerializer.getServletContextName(),
					inscription_criteria_lkpPersistence.class.getName());

			ReferenceRegistry.registerReference(inscription_criteria_lkpUtil.class,
				"_persistence");
		}
	 ...
	 * @deprecated
	 */
	public void setPersistence(inscription_criteria_lkpPersistence persistence) {
	}

	private static inscription_criteria_lkpPersistence _persistence;
}