 ...
 * @generated
 */
public class advance_query_assessmentSoap implements Serializable {
	public static advance_query_assessmentSoap toSoapModel(
		advance_query_assessment model) {
		advance_query_assessmentSoap soapModel = new advance_query_assessmentSoap();
	...
	public static advance_query_assessmentSoap[] toSoapModels(
		advance_query_assessment[] models) {
		advance_query_assessmentSoap[] soapModels = new advance_query_assessmentSoap[models.length];
	...
	public static advance_query_assessmentSoap[][] toSoapModels(
		advance_query_assessment[][] models) {
		advance_query_assessmentSoap[][] soapModels = null;

		if (models.length > 0) {
			soapModels = new advance_query_assessmentSoap[models.length][models[0].length];
		}
		else {
			soapModels = new advance_query_assessmentSoap[0][0];
		}
	...
	public static advance_query_assessmentSoap[] toSoapModels(
		List<advance_query_assessment> models) {
		List<advance_query_assessmentSoap> soapModels = new ArrayList<advance_query_assessmentSoap>(models.size());

		for (advance_query_assessment model : models) {
			soapModels.add(toSoapModel(model));
		}

		return soapModels.toArray(new advance_query_assessmentSoap[soapModels.size()]);
	}

	public advance_query_assessmentSoap() {
	}
