 ...
 * @author alok.sen
 */
public class advance_query_assessmentClp extends BaseModelImpl<advance_query_assessment>
	implements advance_query_assessment {
	public advance_query_assessmentClp() {
	}
	...
	public BaseModel<?> getadvance_query_assessmentRemoteModel() {
		return _advance_query_assessmentRemoteModel;
	}

	public void setadvance_query_assessmentRemoteModel(
		BaseModel<?> advance_query_assessmentRemoteModel) {
		_advance_query_assessmentRemoteModel = advance_query_assessmentRemoteModel;
	}
	...
	public advance_query_assessment toEscapedModel() {
		return (advance_query_assessment)Proxy.newProxyInstance(advance_query_assessment.class.getClassLoader(),
			new Class[] { advance_query_assessment.class },
			new AutoEscapeBeanHandler(this));
	}

	@Override
	public Object clone() {
		advance_query_assessmentClp clone = new advance_query_assessmentClp();
	...
	public int compareTo(advance_query_assessment advance_query_assessment) {
		long primaryKey = advance_query_assessment.getPrimaryKey();
	...
	public boolean equals(Object obj) {
		...
		advance_query_assessmentClp advance_query_assessment = null;

		try {
			advance_query_assessment = (advance_query_assessmentClp)obj;
		}
	...
	public String toXmlString() {
		...
		sb.append("com.iucn.whp.dbservice.model.advance_query_assessment");
	...
	private BaseModel<?> _advance_query_assessmentRemoteModel;
}