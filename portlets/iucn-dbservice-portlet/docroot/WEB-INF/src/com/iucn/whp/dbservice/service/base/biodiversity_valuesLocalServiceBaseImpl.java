...
/**
 * The base implementation of the biodiversity_values local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.iucn.whp.dbservice.service.impl.biodiversity_valuesLocalServiceImpl}.
 * </p>
 *
 * @author alok.sen
 ...
 * @generated
 */
public abstract class biodiversity_valuesLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements biodiversity_valuesLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.iucn.whp.dbservice.service.biodiversity_valuesLocalServiceUtil} to access the biodiversity_values local service.
	 */
	...
	public biodiversity_values addbiodiversity_values(
		biodiversity_values biodiversity_values) throws SystemException {
		biodiversity_values.setNew(true);

		return biodiversity_valuesPersistence.update(biodiversity_values, false);
	}
	 ...
	 */
	public biodiversity_values createbiodiversity_values(long id) {
		return biodiversity_valuesPersistence.create(id);
	}
	...
	public biodiversity_values deletebiodiversity_values(long id)
		throws PortalException, SystemException {
		return biodiversity_valuesPersistence.remove(id);
	}
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public biodiversity_values deletebiodiversity_values(
		biodiversity_values biodiversity_values) throws SystemException {
		return biodiversity_valuesPersistence.remove(biodiversity_values);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(biodiversity_values.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return biodiversity_valuesPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return biodiversity_valuesPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public biodiversity_values fetchbiodiversity_values(long id)
		throws SystemException {
		return biodiversity_valuesPersistence.fetchByPrimaryKey(id);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public biodiversity_values getbiodiversity_values(long id)
		throws PortalException, SystemException {
		return biodiversity_valuesPersistence.findByPrimaryKey(id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return biodiversity_valuesPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<biodiversity_values> getbiodiversity_valueses(int start, int end)
		throws SystemException {
		return biodiversity_valuesPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getbiodiversity_valuesesCount() throws SystemException {
		return biodiversity_valuesPersistence.countAll();
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public biodiversity_values updatebiodiversity_values(
		biodiversity_values biodiversity_values) throws SystemException {
		return updatebiodiversity_values(biodiversity_values, true);
	}
	...
	public biodiversity_values updatebiodiversity_values(
		...
		return biodiversity_valuesPersistence.update(biodiversity_values, merge);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.iucn.whp.dbservice.model.biodiversity_values",
			biodiversity_valuesLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.iucn.whp.dbservice.model.biodiversity_values");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = biodiversity_valuesPersistence.getDataSource();
	...
	private biodiversity_valuesLocalServiceClpInvoker _clpInvoker = new biodiversity_valuesLocalServiceClpInvoker();
}