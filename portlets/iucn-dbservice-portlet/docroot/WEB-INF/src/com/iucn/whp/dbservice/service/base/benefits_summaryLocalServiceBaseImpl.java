...
/**
 * The base implementation of the benefits_summary local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.iucn.whp.dbservice.service.impl.benefits_summaryLocalServiceImpl}.
 * </p>
 *
 * @author alok.sen
 * @see com.iucn.whp.dbservice.service.impl.benefits_summaryLocalServiceImpl
 * @see com.iucn.whp.dbservice.service.benefits_summaryLocalServiceUtil
 * @generated
 */
public abstract class benefits_summaryLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements benefits_summaryLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.iucn.whp.dbservice.service.benefits_summaryLocalServiceUtil} to access the benefits_summary local service.
	 */
	...
	public benefits_summary addbenefits_summary(
		benefits_summary benefits_summary) throws SystemException {
		benefits_summary.setNew(true);

		return benefits_summaryPersistence.update(benefits_summary, false);
	}
	 ...
	 */
	public benefits_summary createbenefits_summary(long benefits_summary_id) {
		return benefits_summaryPersistence.create(benefits_summary_id);
	}
	...
	public benefits_summary deletebenefits_summary(long benefits_summary_id)
		throws PortalException, SystemException {
		return benefits_summaryPersistence.remove(benefits_summary_id);
	}
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public benefits_summary deletebenefits_summary(
		benefits_summary benefits_summary) throws SystemException {
		return benefits_summaryPersistence.remove(benefits_summary);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(benefits_summary.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return benefits_summaryPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return benefits_summaryPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public benefits_summary fetchbenefits_summary(long benefits_summary_id)
		throws SystemException {
		return benefits_summaryPersistence.fetchByPrimaryKey(benefits_summary_id);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public benefits_summary getbenefits_summary(long benefits_summary_id)
		throws PortalException, SystemException {
		return benefits_summaryPersistence.findByPrimaryKey(benefits_summary_id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return benefits_summaryPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<benefits_summary> getbenefits_summaries(int start, int end)
		throws SystemException {
		return benefits_summaryPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getbenefits_summariesCount() throws SystemException {
		return benefits_summaryPersistence.countAll();
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public benefits_summary updatebenefits_summary(
		benefits_summary benefits_summary) throws SystemException {
		return updatebenefits_summary(benefits_summary, true);
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	public benefits_summary updatebenefits_summary(
		benefits_summary benefits_summary, boolean merge)
		throws SystemException {
		benefits_summary.setNew(false);

		return benefits_summaryPersistence.update(benefits_summary, merge);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.iucn.whp.dbservice.model.benefits_summary",
			benefits_summaryLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = benefits_summaryPersistence.getDataSource();
	...
	private benefits_summaryLocalServiceClpInvoker _clpInvoker = new benefits_summaryLocalServiceClpInvoker();
}