...
/**
 * The base implementation of the contact_category local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.iucn.whp.dbservice.service.impl.contact_categoryLocalServiceImpl}.
 * </p>
 *
 * @author alok.sen
 ...
 * @generated
 */
public abstract class contact_categoryLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements contact_categoryLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.iucn.whp.dbservice.service.contact_categoryLocalServiceUtil} to access the contact_category local service.
	 */
	...
	public contact_category addcontact_category(
		contact_category contact_category) throws SystemException {
		contact_category.setNew(true);

		return contact_categoryPersistence.update(contact_category, false);
	}
	 ...
	 */
	public contact_category createcontact_category(int contact_category_id) {
		return contact_categoryPersistence.create(contact_category_id);
	}
	...
	public contact_category deletecontact_category(int contact_category_id)
		throws PortalException, SystemException {
		return contact_categoryPersistence.remove(contact_category_id);
	}
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public contact_category deletecontact_category(
		contact_category contact_category) throws SystemException {
		return contact_categoryPersistence.remove(contact_category);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(contact_category.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return contact_categoryPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return contact_categoryPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public contact_category fetchcontact_category(int contact_category_id)
		throws SystemException {
		return contact_categoryPersistence.fetchByPrimaryKey(contact_category_id);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public contact_category getcontact_category(int contact_category_id)
		throws PortalException, SystemException {
		return contact_categoryPersistence.findByPrimaryKey(contact_category_id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return contact_categoryPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<contact_category> getcontact_categories(int start, int end)
		throws SystemException {
		return contact_categoryPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getcontact_categoriesCount() throws SystemException {
		return contact_categoryPersistence.countAll();
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public contact_category updatecontact_category(
		contact_category contact_category) throws SystemException {
		return updatecontact_category(contact_category, true);
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	public contact_category updatecontact_category(
		contact_category contact_category, boolean merge)
		throws SystemException {
		contact_category.setNew(false);

		return contact_categoryPersistence.update(contact_category, merge);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.iucn.whp.dbservice.model.contact_category",
			contact_categoryLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.iucn.whp.dbservice.model.contact_category");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = contact_categoryPersistence.getDataSource();
