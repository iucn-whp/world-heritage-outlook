...
import com.iucn.whp.dbservice.NoSuchreferencesException;
import com.iucn.whp.dbservice.model.impl.referencesImpl;
import com.iucn.whp.dbservice.model.impl.referencesModelImpl;
...
public class referencesPersistenceImpl extends BasePersistenceImpl<references>
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_ASSESSMENT_VERSION_ID =
		new FinderPath(referencesModelImpl.ENTITY_CACHE_ENABLED,
			...
			referencesModelImpl.ASSESSMENT_VERSION_ID_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_ASSESSMENT_VERSION_ID = new FinderPath(referencesModelImpl.ENTITY_CACHE_ENABLED,
	 ...
	 */
	public references create(long reference_id) {
		references references = new referencesImpl();

		references.setNew(true);
		references.setPrimaryKey(reference_id);
	 ...
	 */
	public references remove(long reference_id)
		throws NoSuchreferencesException, SystemException {
		return remove(Long.valueOf(reference_id));
	}
		...
		if (isNew || !referencesModelImpl.COLUMN_BITMASK_ENABLED) {
			...
			if ((referencesModelImpl.getColumnBitmask() &
				...
				Object[] args = new Object[] {
						Long.valueOf(referencesModelImpl.getOriginalAssessment_version_id())
					};
				...
				args = new Object[] {
						Long.valueOf(referencesModelImpl.getAssessment_version_id())
					};
	...
	protected references toUnwrappedModel(references references) {
		...
		referencesImpl.setReference_id(references.getReference_id());
		referencesImpl.setAssessment_version_id(references.getAssessment_version_id());
		referencesImpl.setRn(references.getRn());
		referencesImpl.setReferences(references.getReferences());
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public references findByPrimaryKey(long reference_id)
		throws NoSuchreferencesException, SystemException {
		references references = fetchByPrimaryKey(reference_id);

		if (references == null) {
			if (_log.isWarnEnabled()) {
				_log.warn(_NO_SUCH_ENTITY_WITH_PRIMARY_KEY + reference_id);
			}
		...
		if (references == null) {
			...
			try {
				...
				if (references != null) {
					...
					EntityCacheUtil.putResult(referencesModelImpl.ENTITY_CACHE_ENABLED,
						referencesImpl.class, reference_id, _nullreferences);
				}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<references> findByassessment_version_id(
	...
	public List<references> findByassessment_version_id(
		...
		if ((list != null) && !list.isEmpty()) {
			for (references references : list) {
				if ((assessment_version_id != references.getAssessment_version_id())) {
					list = null;
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public references findByassessment_version_id_First(
		long assessment_version_id, OrderByComparator orderByComparator)
		throws NoSuchreferencesException, SystemException {
		references references = fetchByassessment_version_id_First(assessment_version_id,
				orderByComparator);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public references fetchByassessment_version_id_First(
		long assessment_version_id, OrderByComparator orderByComparator)
		throws SystemException {
		List<references> list = findByassessment_version_id(assessment_version_id,
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public references findByassessment_version_id_Last(
		long assessment_version_id, OrderByComparator orderByComparator)
		throws NoSuchreferencesException, SystemException {
		references references = fetchByassessment_version_id_Last(assessment_version_id,
				orderByComparator);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public references fetchByassessment_version_id_Last(
		long assessment_version_id, OrderByComparator orderByComparator)
		throws SystemException {
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public references[] findByassessment_version_id_PrevAndNext(
		long reference_id, long assessment_version_id,
		OrderByComparator orderByComparator)
		throws NoSuchreferencesException, SystemException {
		references references = findByPrimaryKey(reference_id);
		...
		try {
			...
			array[0] = getByassessment_version_id_PrevAndNext(session,
					references, assessment_version_id, orderByComparator, true);

			array[1] = references;

			array[2] = getByassessment_version_id_PrevAndNext(session,
					references, assessment_version_id, orderByComparator, false);
	...
	protected references getByassessment_version_id_PrevAndNext(
		Session session, references references, long assessment_version_id,
	...
	public void removeByassessment_version_id(long assessment_version_id)
		throws SystemException {
		for (references references : findByassessment_version_id(
				assessment_version_id)) {
			remove(references);
		}
	}
	...
	public void afterPropertiesSet() {
		String[] listenerClassNames = StringUtil.split(GetterUtil.getString(
					com.liferay.util.service.ServiceProps.get(
						"value.object.listener.com.iucn.whp.dbservice.model.references")));
	...
	private static final String _FINDER_COLUMN_ASSESSMENT_VERSION_ID_ASSESSMENT_VERSION_ID_2 =
		"references.assessment_version_id = ?";
