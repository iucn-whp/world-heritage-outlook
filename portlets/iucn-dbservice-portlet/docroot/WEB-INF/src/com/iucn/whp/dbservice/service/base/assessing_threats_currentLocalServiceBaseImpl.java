...
/**
 * The base implementation of the assessing_threats_current local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.iucn.whp.dbservice.service.impl.assessing_threats_currentLocalServiceImpl}.
 * </p>
 *
 * @author alok.sen
 ...
 * @generated
 */
public abstract class assessing_threats_currentLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements assessing_threats_currentLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.iucn.whp.dbservice.service.assessing_threats_currentLocalServiceUtil} to access the assessing_threats_current local service.
	 */
	...
	public assessing_threats_current addassessing_threats_current(
		assessing_threats_current assessing_threats_current)
		throws SystemException {
		assessing_threats_current.setNew(true);

		return assessing_threats_currentPersistence.update(assessing_threats_current,
			false);
	}
	 ...
	 */
	public assessing_threats_current createassessing_threats_current(
		long current_threat_id) {
		return assessing_threats_currentPersistence.create(current_threat_id);
	}
	...
	public assessing_threats_current deleteassessing_threats_current(
		long current_threat_id) throws PortalException, SystemException {
		return assessing_threats_currentPersistence.remove(current_threat_id);
	}
	...
	public assessing_threats_current deleteassessing_threats_current(
		assessing_threats_current assessing_threats_current)
		throws SystemException {
		return assessing_threats_currentPersistence.remove(assessing_threats_current);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(assessing_threats_current.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return assessing_threats_currentPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return assessing_threats_currentPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public assessing_threats_current fetchassessing_threats_current(
		long current_threat_id) throws SystemException {
		return assessing_threats_currentPersistence.fetchByPrimaryKey(current_threat_id);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public assessing_threats_current getassessing_threats_current(
		long current_threat_id) throws PortalException, SystemException {
		return assessing_threats_currentPersistence.findByPrimaryKey(current_threat_id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return assessing_threats_currentPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<assessing_threats_current> getassessing_threats_currents(
		int start, int end) throws SystemException {
		return assessing_threats_currentPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getassessing_threats_currentsCount() throws SystemException {
		return assessing_threats_currentPersistence.countAll();
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public assessing_threats_current updateassessing_threats_current(
		assessing_threats_current assessing_threats_current)
		throws SystemException {
		return updateassessing_threats_current(assessing_threats_current, true);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.iucn.whp.dbservice.model.assessing_threats_current",
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = assessing_threats_currentPersistence.getDataSource();
	...
	private assessing_threats_currentLocalServiceClpInvoker _clpInvoker = new assessing_threats_currentLocalServiceClpInvoker();
}