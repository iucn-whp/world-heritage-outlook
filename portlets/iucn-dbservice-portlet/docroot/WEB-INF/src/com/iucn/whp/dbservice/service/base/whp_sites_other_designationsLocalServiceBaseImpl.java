...
/**
 * The base implementation of the whp_sites_other_designations local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.iucn.whp.dbservice.service.impl.whp_sites_other_designationsLocalServiceImpl}.
 * </p>
 *
 * @author alok.sen
 ...
 * @generated
 */
public abstract class whp_sites_other_designationsLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements whp_sites_other_designationsLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.iucn.whp.dbservice.service.whp_sites_other_designationsLocalServiceUtil} to access the whp_sites_other_designations local service.
	 */
	...
	public whp_sites_other_designations addwhp_sites_other_designations(
		whp_sites_other_designations whp_sites_other_designations)
		throws SystemException {
		whp_sites_other_designations.setNew(true);

		return whp_sites_other_designationsPersistence.update(whp_sites_other_designations,
			false);
	}
	 ...
	 */
	public whp_sites_other_designations createwhp_sites_other_designations(
		long whp_sites_other_designations_id) {
		return whp_sites_other_designationsPersistence.create(whp_sites_other_designations_id);
	}
	...
	public whp_sites_other_designations deletewhp_sites_other_designations(
		long whp_sites_other_designations_id)
		throws PortalException, SystemException {
		return whp_sites_other_designationsPersistence.remove(whp_sites_other_designations_id);
	}
	...
	public whp_sites_other_designations deletewhp_sites_other_designations(
		whp_sites_other_designations whp_sites_other_designations)
		throws SystemException {
		return whp_sites_other_designationsPersistence.remove(whp_sites_other_designations);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(whp_sites_other_designations.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return whp_sites_other_designationsPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return whp_sites_other_designationsPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public whp_sites_other_designations fetchwhp_sites_other_designations(
		long whp_sites_other_designations_id) throws SystemException {
		return whp_sites_other_designationsPersistence.fetchByPrimaryKey(whp_sites_other_designations_id);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public whp_sites_other_designations getwhp_sites_other_designations(
		long whp_sites_other_designations_id)
		throws PortalException, SystemException {
		return whp_sites_other_designationsPersistence.findByPrimaryKey(whp_sites_other_designations_id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return whp_sites_other_designationsPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<whp_sites_other_designations> getwhp_sites_other_designationses(
		int start, int end) throws SystemException {
		return whp_sites_other_designationsPersistence.findAll(start, end);
	}
	...
	public int getwhp_sites_other_designationsesCount()
		throws SystemException {
		return whp_sites_other_designationsPersistence.countAll();
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public whp_sites_other_designations updatewhp_sites_other_designations(
		whp_sites_other_designations whp_sites_other_designations)
		throws SystemException {
		return updatewhp_sites_other_designations(whp_sites_other_designations,
			true);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.iucn.whp.dbservice.model.whp_sites_other_designations",
			whp_sites_other_designationsLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.iucn.whp.dbservice.model.whp_sites_other_designations");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = whp_sites_other_designationsPersistence.getDataSource();
	...
	private whp_sites_other_designationsLocalServiceClpInvoker _clpInvoker = new whp_sites_other_designationsLocalServiceClpInvoker();
}