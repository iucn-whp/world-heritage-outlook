...
/**
 * The base implementation of the iucn_pa_lkp_category local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.iucn.whp.dbservice.service.impl.iucn_pa_lkp_categoryLocalServiceImpl}.
 * </p>
 *
 * @author alok.sen
 ...
 * @generated
 */
public abstract class iucn_pa_lkp_categoryLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements iucn_pa_lkp_categoryLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.iucn.whp.dbservice.service.iucn_pa_lkp_categoryLocalServiceUtil} to access the iucn_pa_lkp_category local service.
	 */
	...
	public iucn_pa_lkp_category addiucn_pa_lkp_category(
		iucn_pa_lkp_category iucn_pa_lkp_category) throws SystemException {
		iucn_pa_lkp_category.setNew(true);

		return iucn_pa_lkp_categoryPersistence.update(iucn_pa_lkp_category,
			false);
	}
	 ...
	 */
	public iucn_pa_lkp_category createiucn_pa_lkp_category(
		int iucn_pa_category_id) {
		return iucn_pa_lkp_categoryPersistence.create(iucn_pa_category_id);
	}
	...
	public iucn_pa_lkp_category deleteiucn_pa_lkp_category(
		int iucn_pa_category_id) throws PortalException, SystemException {
		return iucn_pa_lkp_categoryPersistence.remove(iucn_pa_category_id);
	}
	...
	public iucn_pa_lkp_category deleteiucn_pa_lkp_category(
		iucn_pa_lkp_category iucn_pa_lkp_category) throws SystemException {
		return iucn_pa_lkp_categoryPersistence.remove(iucn_pa_lkp_category);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(iucn_pa_lkp_category.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return iucn_pa_lkp_categoryPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return iucn_pa_lkp_categoryPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public iucn_pa_lkp_category fetchiucn_pa_lkp_category(
		int iucn_pa_category_id) throws SystemException {
		return iucn_pa_lkp_categoryPersistence.fetchByPrimaryKey(iucn_pa_category_id);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public iucn_pa_lkp_category getiucn_pa_lkp_category(int iucn_pa_category_id)
		throws PortalException, SystemException {
		return iucn_pa_lkp_categoryPersistence.findByPrimaryKey(iucn_pa_category_id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return iucn_pa_lkp_categoryPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<iucn_pa_lkp_category> getiucn_pa_lkp_categories(int start,
		int end) throws SystemException {
		return iucn_pa_lkp_categoryPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getiucn_pa_lkp_categoriesCount() throws SystemException {
		return iucn_pa_lkp_categoryPersistence.countAll();
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public iucn_pa_lkp_category updateiucn_pa_lkp_category(
		iucn_pa_lkp_category iucn_pa_lkp_category) throws SystemException {
		return updateiucn_pa_lkp_category(iucn_pa_lkp_category, true);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.iucn.whp.dbservice.model.iucn_pa_lkp_category",
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = iucn_pa_lkp_categoryPersistence.getDataSource();
	...
	private iucn_pa_lkp_categoryLocalServiceClpInvoker _clpInvoker = new iucn_pa_lkp_categoryLocalServiceClpInvoker();
}