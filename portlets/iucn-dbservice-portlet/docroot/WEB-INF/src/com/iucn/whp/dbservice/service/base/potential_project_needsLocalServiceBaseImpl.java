...
/**
 * The base implementation of the potential_project_needs local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.iucn.whp.dbservice.service.impl.potential_project_needsLocalServiceImpl}.
 * </p>
 *
 * @author alok.sen
 ...
 * @generated
 */
public abstract class potential_project_needsLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements potential_project_needsLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.iucn.whp.dbservice.service.potential_project_needsLocalServiceUtil} to access the potential_project_needs local service.
	 */
	...
	public potential_project_needs addpotential_project_needs(
		potential_project_needs potential_project_needs)
		throws SystemException {
		potential_project_needs.setNew(true);

		return potential_project_needsPersistence.update(potential_project_needs,
			false);
	}
	 ...
	 */
	public potential_project_needs createpotential_project_needs(long ppn_id) {
		return potential_project_needsPersistence.create(ppn_id);
	}
	...
	public potential_project_needs deletepotential_project_needs(long ppn_id)
		throws PortalException, SystemException {
		return potential_project_needsPersistence.remove(ppn_id);
	}
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public potential_project_needs deletepotential_project_needs(
		potential_project_needs potential_project_needs)
		throws SystemException {
		return potential_project_needsPersistence.remove(potential_project_needs);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(potential_project_needs.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return potential_project_needsPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return potential_project_needsPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public potential_project_needs fetchpotential_project_needs(long ppn_id)
		throws SystemException {
		return potential_project_needsPersistence.fetchByPrimaryKey(ppn_id);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public potential_project_needs getpotential_project_needs(long ppn_id)
		throws PortalException, SystemException {
		return potential_project_needsPersistence.findByPrimaryKey(ppn_id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return potential_project_needsPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<potential_project_needs> getpotential_project_needses(
		int start, int end) throws SystemException {
		return potential_project_needsPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getpotential_project_needsesCount() throws SystemException {
		return potential_project_needsPersistence.countAll();
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public potential_project_needs updatepotential_project_needs(
		potential_project_needs potential_project_needs)
		throws SystemException {
		return updatepotential_project_needs(potential_project_needs, true);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.iucn.whp.dbservice.model.potential_project_needs",
			potential_project_needsLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.iucn.whp.dbservice.model.potential_project_needs");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = potential_project_needsPersistence.getDataSource();
	...
	private potential_project_needsLocalServiceClpInvoker _clpInvoker = new potential_project_needsLocalServiceClpInvoker();
}