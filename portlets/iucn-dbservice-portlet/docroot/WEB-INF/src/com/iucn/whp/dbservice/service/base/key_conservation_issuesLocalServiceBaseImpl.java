...
/**
 * The base implementation of the key_conservation_issues local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.iucn.whp.dbservice.service.impl.key_conservation_issuesLocalServiceImpl}.
 * </p>
 *
 * @author alok.sen
 ...
 * @generated
 */
public abstract class key_conservation_issuesLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements key_conservation_issuesLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.iucn.whp.dbservice.service.key_conservation_issuesLocalServiceUtil} to access the key_conservation_issues local service.
	 */
	...
	public key_conservation_issues addkey_conservation_issues(
		key_conservation_issues key_conservation_issues)
		throws SystemException {
		key_conservation_issues.setNew(true);

		return key_conservation_issuesPersistence.update(key_conservation_issues,
			false);
	}
	 ...
	 */
	public key_conservation_issues createkey_conservation_issues(
		long key_conservation_issues_id) {
		return key_conservation_issuesPersistence.create(key_conservation_issues_id);
	}
	...
	public key_conservation_issues deletekey_conservation_issues(
		long key_conservation_issues_id)
		throws PortalException, SystemException {
		return key_conservation_issuesPersistence.remove(key_conservation_issues_id);
	}
	...
	public key_conservation_issues deletekey_conservation_issues(
		key_conservation_issues key_conservation_issues)
		throws SystemException {
		return key_conservation_issuesPersistence.remove(key_conservation_issues);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(key_conservation_issues.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return key_conservation_issuesPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return key_conservation_issuesPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public key_conservation_issues fetchkey_conservation_issues(
		long key_conservation_issues_id) throws SystemException {
		return key_conservation_issuesPersistence.fetchByPrimaryKey(key_conservation_issues_id);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public key_conservation_issues getkey_conservation_issues(
		long key_conservation_issues_id)
		throws PortalException, SystemException {
		return key_conservation_issuesPersistence.findByPrimaryKey(key_conservation_issues_id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return key_conservation_issuesPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<key_conservation_issues> getkey_conservation_issueses(
		int start, int end) throws SystemException {
		return key_conservation_issuesPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getkey_conservation_issuesesCount() throws SystemException {
		return key_conservation_issuesPersistence.countAll();
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public key_conservation_issues updatekey_conservation_issues(
		key_conservation_issues key_conservation_issues)
		throws SystemException {
		return updatekey_conservation_issues(key_conservation_issues, true);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.iucn.whp.dbservice.model.key_conservation_issues",
			key_conservation_issuesLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.iucn.whp.dbservice.model.key_conservation_issues");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = key_conservation_issuesPersistence.getDataSource();
	...
	private key_conservation_issuesLocalServiceClpInvoker _clpInvoker = new key_conservation_issuesLocalServiceClpInvoker();
}