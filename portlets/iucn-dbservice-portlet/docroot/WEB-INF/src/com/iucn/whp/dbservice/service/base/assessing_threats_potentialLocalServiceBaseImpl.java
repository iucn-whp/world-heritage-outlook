...
/**
 * The base implementation of the assessing_threats_potential local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.iucn.whp.dbservice.service.impl.assessing_threats_potentialLocalServiceImpl}.
 * </p>
 *
 * @author alok.sen
 ...
 * @generated
 */
public abstract class assessing_threats_potentialLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements assessing_threats_potentialLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.iucn.whp.dbservice.service.assessing_threats_potentialLocalServiceUtil} to access the assessing_threats_potential local service.
	 */
	...
	public assessing_threats_potential addassessing_threats_potential(
		assessing_threats_potential assessing_threats_potential)
		throws SystemException {
		assessing_threats_potential.setNew(true);

		return assessing_threats_potentialPersistence.update(assessing_threats_potential,
			false);
	}
	 ...
	 */
	public assessing_threats_potential createassessing_threats_potential(
		long potential_threat_id) {
		return assessing_threats_potentialPersistence.create(potential_threat_id);
	}
	...
	public assessing_threats_potential deleteassessing_threats_potential(
		long potential_threat_id) throws PortalException, SystemException {
		return assessing_threats_potentialPersistence.remove(potential_threat_id);
	}
	...
	public assessing_threats_potential deleteassessing_threats_potential(
		assessing_threats_potential assessing_threats_potential)
		throws SystemException {
		return assessing_threats_potentialPersistence.remove(assessing_threats_potential);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(assessing_threats_potential.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return assessing_threats_potentialPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return assessing_threats_potentialPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public assessing_threats_potential fetchassessing_threats_potential(
		long potential_threat_id) throws SystemException {
		return assessing_threats_potentialPersistence.fetchByPrimaryKey(potential_threat_id);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public assessing_threats_potential getassessing_threats_potential(
		long potential_threat_id) throws PortalException, SystemException {
		return assessing_threats_potentialPersistence.findByPrimaryKey(potential_threat_id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return assessing_threats_potentialPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<assessing_threats_potential> getassessing_threats_potentials(
		int start, int end) throws SystemException {
		return assessing_threats_potentialPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getassessing_threats_potentialsCount() throws SystemException {
		return assessing_threats_potentialPersistence.countAll();
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public assessing_threats_potential updateassessing_threats_potential(
		assessing_threats_potential assessing_threats_potential)
		throws SystemException {
		return updateassessing_threats_potential(assessing_threats_potential,
			true);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.iucn.whp.dbservice.model.assessing_threats_potential",
			assessing_threats_potentialLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.iucn.whp.dbservice.model.assessing_threats_potential");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = assessing_threats_potentialPersistence.getDataSource();
	...
	private assessing_threats_potentialLocalServiceClpInvoker _clpInvoker = new assessing_threats_potentialLocalServiceClpInvoker();
}