...
/**
 * The base implementation of the references local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.iucn.whp.dbservice.service.impl.referencesLocalServiceImpl}.
 * </p>
 *
 * @author alok.sen
 ...
 * @generated
 */
public abstract class referencesLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements referencesLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.iucn.whp.dbservice.service.referencesLocalServiceUtil} to access the references local service.
	 */
	...
	public references addreferences(references references)
		throws SystemException {
		references.setNew(true);

		return referencesPersistence.update(references, false);
	}
	 ...
	 */
	public references createreferences(long reference_id) {
		return referencesPersistence.create(reference_id);
	}
	...
	public references deletereferences(long reference_id)
		throws PortalException, SystemException {
		return referencesPersistence.remove(reference_id);
	}
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public references deletereferences(references references)
		throws SystemException {
		return referencesPersistence.remove(references);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(references.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return referencesPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return referencesPersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return referencesPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public references fetchreferences(long reference_id)
		throws SystemException {
		return referencesPersistence.fetchByPrimaryKey(reference_id);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public references getreferences(long reference_id)
		throws PortalException, SystemException {
		return referencesPersistence.findByPrimaryKey(reference_id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return referencesPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<references> getreferenceses(int start, int end)
		throws SystemException {
		return referencesPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getreferencesesCount() throws SystemException {
		return referencesPersistence.countAll();
	}
	...
	public references updatereferences(references references)
		throws SystemException {
		return updatereferences(references, true);
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public references updatereferences(references references, boolean merge)
		throws SystemException {
		references.setNew(false);

		return referencesPersistence.update(references, merge);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.iucn.whp.dbservice.model.references",
			referencesLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.iucn.whp.dbservice.model.references");
	}
	...
	private referencesLocalServiceClpInvoker _clpInvoker = new referencesLocalServiceClpInvoker();
}