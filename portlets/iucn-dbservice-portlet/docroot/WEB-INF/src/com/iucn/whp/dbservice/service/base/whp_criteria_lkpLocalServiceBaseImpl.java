...
/**
 * The base implementation of the whp_criteria_lkp local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.iucn.whp.dbservice.service.impl.whp_criteria_lkpLocalServiceImpl}.
 * </p>
 *
 * @author alok.sen
 * @see com.iucn.whp.dbservice.service.impl.whp_criteria_lkpLocalServiceImpl
 * @see com.iucn.whp.dbservice.service.whp_criteria_lkpLocalServiceUtil
 * @generated
 */
public abstract class whp_criteria_lkpLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements whp_criteria_lkpLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.iucn.whp.dbservice.service.whp_criteria_lkpLocalServiceUtil} to access the whp_criteria_lkp local service.
	 */
	...
	public whp_criteria_lkp addwhp_criteria_lkp(
		whp_criteria_lkp whp_criteria_lkp) throws SystemException {
		whp_criteria_lkp.setNew(true);

		return whp_criteria_lkpPersistence.update(whp_criteria_lkp, false);
	}
	 ...
	 */
	public whp_criteria_lkp createwhp_criteria_lkp(long id) {
		return whp_criteria_lkpPersistence.create(id);
	}
	...
	public whp_criteria_lkp deletewhp_criteria_lkp(long id)
		throws PortalException, SystemException {
		return whp_criteria_lkpPersistence.remove(id);
	}
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public whp_criteria_lkp deletewhp_criteria_lkp(
		whp_criteria_lkp whp_criteria_lkp) throws SystemException {
		return whp_criteria_lkpPersistence.remove(whp_criteria_lkp);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(whp_criteria_lkp.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return whp_criteria_lkpPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return whp_criteria_lkpPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public whp_criteria_lkp fetchwhp_criteria_lkp(long id)
		throws SystemException {
		return whp_criteria_lkpPersistence.fetchByPrimaryKey(id);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public whp_criteria_lkp getwhp_criteria_lkp(long id)
		throws PortalException, SystemException {
		return whp_criteria_lkpPersistence.findByPrimaryKey(id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return whp_criteria_lkpPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<whp_criteria_lkp> getwhp_criteria_lkps(int start, int end)
		throws SystemException {
		return whp_criteria_lkpPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getwhp_criteria_lkpsCount() throws SystemException {
		return whp_criteria_lkpPersistence.countAll();
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public whp_criteria_lkp updatewhp_criteria_lkp(
		whp_criteria_lkp whp_criteria_lkp) throws SystemException {
		return updatewhp_criteria_lkp(whp_criteria_lkp, true);
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	public whp_criteria_lkp updatewhp_criteria_lkp(
		whp_criteria_lkp whp_criteria_lkp, boolean merge)
		throws SystemException {
		whp_criteria_lkp.setNew(false);

		return whp_criteria_lkpPersistence.update(whp_criteria_lkp, merge);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.iucn.whp.dbservice.model.whp_criteria_lkp",
			whp_criteria_lkpLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.iucn.whp.dbservice.model.whp_criteria_lkp");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = whp_criteria_lkpPersistence.getDataSource();
	...
	private whp_criteria_lkpLocalServiceClpInvoker _clpInvoker = new whp_criteria_lkpLocalServiceClpInvoker();
}