...
/**
 * The base implementation of the current_state_trend local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.iucn.whp.dbservice.service.impl.current_state_trendLocalServiceImpl}.
 * </p>
 *
 * @author alok.sen
 * @see com.iucn.whp.dbservice.service.impl.current_state_trendLocalServiceImpl
 * @see com.iucn.whp.dbservice.service.current_state_trendLocalServiceUtil
 * @generated
 */
public abstract class current_state_trendLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements current_state_trendLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.iucn.whp.dbservice.service.current_state_trendLocalServiceUtil} to access the current_state_trend local service.
	 */
	...
	public current_state_trend addcurrent_state_trend(
		current_state_trend current_state_trend) throws SystemException {
		current_state_trend.setNew(true);

		return current_state_trendPersistence.update(current_state_trend, false);
	}
	 ...
	 */
	public current_state_trend createcurrent_state_trend(long state_trend_id) {
		return current_state_trendPersistence.create(state_trend_id);
	}
	...
	public current_state_trend deletecurrent_state_trend(long state_trend_id)
		throws PortalException, SystemException {
		return current_state_trendPersistence.remove(state_trend_id);
	}
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public current_state_trend deletecurrent_state_trend(
		current_state_trend current_state_trend) throws SystemException {
		return current_state_trendPersistence.remove(current_state_trend);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(current_state_trend.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return current_state_trendPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return current_state_trendPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public current_state_trend fetchcurrent_state_trend(long state_trend_id)
		throws SystemException {
		return current_state_trendPersistence.fetchByPrimaryKey(state_trend_id);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public current_state_trend getcurrent_state_trend(long state_trend_id)
		throws PortalException, SystemException {
		return current_state_trendPersistence.findByPrimaryKey(state_trend_id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return current_state_trendPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<current_state_trend> getcurrent_state_trends(int start, int end)
		throws SystemException {
		return current_state_trendPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getcurrent_state_trendsCount() throws SystemException {
		return current_state_trendPersistence.countAll();
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public current_state_trend updatecurrent_state_trend(
		current_state_trend current_state_trend) throws SystemException {
		return updatecurrent_state_trend(current_state_trend, true);
	}
	...
	public current_state_trend updatecurrent_state_trend(
		...
		return current_state_trendPersistence.update(current_state_trend, merge);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.iucn.whp.dbservice.model.current_state_trend",
	...
	private current_state_trendLocalServiceClpInvoker _clpInvoker = new current_state_trendLocalServiceClpInvoker();
}