...
/**
 * The base implementation of the current_threat_values local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.iucn.whp.dbservice.service.impl.current_threat_valuesLocalServiceImpl}.
 * </p>
 *
 * @author alok.sen
 * @see com.iucn.whp.dbservice.service.impl.current_threat_valuesLocalServiceImpl
 * @see com.iucn.whp.dbservice.service.current_threat_valuesLocalServiceUtil
 * @generated
 */
public abstract class current_threat_valuesLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements current_threat_valuesLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.iucn.whp.dbservice.service.current_threat_valuesLocalServiceUtil} to access the current_threat_values local service.
	 */
	...
	public current_threat_values addcurrent_threat_values(
		current_threat_values current_threat_values) throws SystemException {
		current_threat_values.setNew(true);

		return current_threat_valuesPersistence.update(current_threat_values,
			false);
	}
	 ...
	 */
	public current_threat_values createcurrent_threat_values(
		long current_threat_values_id) {
		return current_threat_valuesPersistence.create(current_threat_values_id);
	}
	...
	public current_threat_values deletecurrent_threat_values(
		long current_threat_values_id) throws PortalException, SystemException {
		return current_threat_valuesPersistence.remove(current_threat_values_id);
	}
	...
	public current_threat_values deletecurrent_threat_values(
		current_threat_values current_threat_values) throws SystemException {
		return current_threat_valuesPersistence.remove(current_threat_values);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(current_threat_values.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return current_threat_valuesPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return current_threat_valuesPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public current_threat_values fetchcurrent_threat_values(
		long current_threat_values_id) throws SystemException {
		return current_threat_valuesPersistence.fetchByPrimaryKey(current_threat_values_id);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public current_threat_values getcurrent_threat_values(
		long current_threat_values_id) throws PortalException, SystemException {
		return current_threat_valuesPersistence.findByPrimaryKey(current_threat_values_id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return current_threat_valuesPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<current_threat_values> getcurrent_threat_valueses(int start,
		int end) throws SystemException {
		return current_threat_valuesPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getcurrent_threat_valuesesCount() throws SystemException {
		return current_threat_valuesPersistence.countAll();
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public current_threat_values updatecurrent_threat_values(
		current_threat_values current_threat_values) throws SystemException {
		return updatecurrent_threat_values(current_threat_values, true);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.iucn.whp.dbservice.model.current_threat_values",
			current_threat_valuesLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.iucn.whp.dbservice.model.current_threat_values");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = current_threat_valuesPersistence.getDataSource();
	...
	private current_threat_valuesLocalServiceClpInvoker _clpInvoker = new current_threat_valuesLocalServiceClpInvoker();
}