...
/**
 * The base implementation of the whp_site_danger_list local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.iucn.whp.dbservice.service.impl.whp_site_danger_listLocalServiceImpl}.
 * </p>
 *
 * @author alok.sen
 * @see com.iucn.whp.dbservice.service.impl.whp_site_danger_listLocalServiceImpl
 * @see com.iucn.whp.dbservice.service.whp_site_danger_listLocalServiceUtil
 * @generated
 */
public abstract class whp_site_danger_listLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements whp_site_danger_listLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.iucn.whp.dbservice.service.whp_site_danger_listLocalServiceUtil} to access the whp_site_danger_list local service.
	 */
	...
	public whp_site_danger_list addwhp_site_danger_list(
		whp_site_danger_list whp_site_danger_list) throws SystemException {
		whp_site_danger_list.setNew(true);

		return whp_site_danger_listPersistence.update(whp_site_danger_list,
			false);
	}
	 ...
	 */
	public whp_site_danger_list createwhp_site_danger_list(
		long whp_site_danger_list_id) {
		return whp_site_danger_listPersistence.create(whp_site_danger_list_id);
	}
	...
	public whp_site_danger_list deletewhp_site_danger_list(
		long whp_site_danger_list_id) throws PortalException, SystemException {
		return whp_site_danger_listPersistence.remove(whp_site_danger_list_id);
	}
	...
	public whp_site_danger_list deletewhp_site_danger_list(
		whp_site_danger_list whp_site_danger_list) throws SystemException {
		return whp_site_danger_listPersistence.remove(whp_site_danger_list);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(whp_site_danger_list.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return whp_site_danger_listPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return whp_site_danger_listPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public whp_site_danger_list fetchwhp_site_danger_list(
		long whp_site_danger_list_id) throws SystemException {
		return whp_site_danger_listPersistence.fetchByPrimaryKey(whp_site_danger_list_id);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public whp_site_danger_list getwhp_site_danger_list(
		long whp_site_danger_list_id) throws PortalException, SystemException {
		return whp_site_danger_listPersistence.findByPrimaryKey(whp_site_danger_list_id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return whp_site_danger_listPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<whp_site_danger_list> getwhp_site_danger_lists(int start,
		int end) throws SystemException {
		return whp_site_danger_listPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getwhp_site_danger_listsCount() throws SystemException {
		return whp_site_danger_listPersistence.countAll();
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public whp_site_danger_list updatewhp_site_danger_list(
		whp_site_danger_list whp_site_danger_list) throws SystemException {
		return updatewhp_site_danger_list(whp_site_danger_list, true);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.iucn.whp.dbservice.model.whp_site_danger_list",
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = whp_site_danger_listPersistence.getDataSource();
	...
	private whp_site_danger_listLocalServiceClpInvoker _clpInvoker = new whp_site_danger_listLocalServiceClpInvoker();
}