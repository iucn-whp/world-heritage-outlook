...
/**
 * The base implementation of the inscription_criteria_lkp local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.iucn.whp.dbservice.service.impl.inscription_criteria_lkpLocalServiceImpl}.
 * </p>
 *
 * @author alok.sen
 * @see com.iucn.whp.dbservice.service.impl.inscription_criteria_lkpLocalServiceImpl
 * @see com.iucn.whp.dbservice.service.inscription_criteria_lkpLocalServiceUtil
 * @generated
 */
public abstract class inscription_criteria_lkpLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements inscription_criteria_lkpLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.iucn.whp.dbservice.service.inscription_criteria_lkpLocalServiceUtil} to access the inscription_criteria_lkp local service.
	 */
	...
	public inscription_criteria_lkp addinscription_criteria_lkp(
		inscription_criteria_lkp inscription_criteria_lkp)
		throws SystemException {
		inscription_criteria_lkp.setNew(true);

		return inscription_criteria_lkpPersistence.update(inscription_criteria_lkp,
			false);
	}
	 ...
	 */
	public inscription_criteria_lkp createinscription_criteria_lkp(
		int criteria_id) {
		return inscription_criteria_lkpPersistence.create(criteria_id);
	}
	...
	public inscription_criteria_lkp deleteinscription_criteria_lkp(
		int criteria_id) throws PortalException, SystemException {
		return inscription_criteria_lkpPersistence.remove(criteria_id);
	}
	...
	public inscription_criteria_lkp deleteinscription_criteria_lkp(
		inscription_criteria_lkp inscription_criteria_lkp)
		throws SystemException {
		return inscription_criteria_lkpPersistence.remove(inscription_criteria_lkp);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(inscription_criteria_lkp.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return inscription_criteria_lkpPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return inscription_criteria_lkpPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public inscription_criteria_lkp fetchinscription_criteria_lkp(
		int criteria_id) throws SystemException {
		return inscription_criteria_lkpPersistence.fetchByPrimaryKey(criteria_id);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public inscription_criteria_lkp getinscription_criteria_lkp(int criteria_id)
		throws PortalException, SystemException {
		return inscription_criteria_lkpPersistence.findByPrimaryKey(criteria_id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return inscription_criteria_lkpPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<inscription_criteria_lkp> getinscription_criteria_lkps(
		int start, int end) throws SystemException {
		return inscription_criteria_lkpPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getinscription_criteria_lkpsCount() throws SystemException {
		return inscription_criteria_lkpPersistence.countAll();
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public inscription_criteria_lkp updateinscription_criteria_lkp(
		inscription_criteria_lkp inscription_criteria_lkp)
		throws SystemException {
		return updateinscription_criteria_lkp(inscription_criteria_lkp, true);
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	public inscription_criteria_lkp updateinscription_criteria_lkp(
		inscription_criteria_lkp inscription_criteria_lkp, boolean merge)
		throws SystemException {
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.iucn.whp.dbservice.model.inscription_criteria_lkp",
			inscription_criteria_lkpLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = inscription_criteria_lkpPersistence.getDataSource();
	...
	private inscription_criteria_lkpLocalServiceClpInvoker _clpInvoker = new inscription_criteria_lkpLocalServiceClpInvoker();
}