...
/**
 * The base implementation of the recommendation_type_lkp local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.iucn.whp.dbservice.service.impl.recommendation_type_lkpLocalServiceImpl}.
 * </p>
 *
 * @author alok.sen
 ...
 * @generated
 */
public abstract class recommendation_type_lkpLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements recommendation_type_lkpLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.iucn.whp.dbservice.service.recommendation_type_lkpLocalServiceUtil} to access the recommendation_type_lkp local service.
	 */
	...
	public recommendation_type_lkp addrecommendation_type_lkp(
		recommendation_type_lkp recommendation_type_lkp)
		throws SystemException {
		recommendation_type_lkp.setNew(true);

		return recommendation_type_lkpPersistence.update(recommendation_type_lkp,
			false);
	}
	 ...
	 */
	public recommendation_type_lkp createrecommendation_type_lkp(
		int rec_type_id) {
		return recommendation_type_lkpPersistence.create(rec_type_id);
	}
	...
	public recommendation_type_lkp deleterecommendation_type_lkp(
		int rec_type_id) throws PortalException, SystemException {
		return recommendation_type_lkpPersistence.remove(rec_type_id);
	}
	...
	public recommendation_type_lkp deleterecommendation_type_lkp(
		recommendation_type_lkp recommendation_type_lkp)
		throws SystemException {
		return recommendation_type_lkpPersistence.remove(recommendation_type_lkp);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(recommendation_type_lkp.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return recommendation_type_lkpPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return recommendation_type_lkpPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public recommendation_type_lkp fetchrecommendation_type_lkp(int rec_type_id)
		throws SystemException {
		return recommendation_type_lkpPersistence.fetchByPrimaryKey(rec_type_id);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public recommendation_type_lkp getrecommendation_type_lkp(int rec_type_id)
		throws PortalException, SystemException {
		return recommendation_type_lkpPersistence.findByPrimaryKey(rec_type_id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return recommendation_type_lkpPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<recommendation_type_lkp> getrecommendation_type_lkps(
		int start, int end) throws SystemException {
		return recommendation_type_lkpPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getrecommendation_type_lkpsCount() throws SystemException {
		return recommendation_type_lkpPersistence.countAll();
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public recommendation_type_lkp updaterecommendation_type_lkp(
		recommendation_type_lkp recommendation_type_lkp)
		throws SystemException {
		return updaterecommendation_type_lkp(recommendation_type_lkp, true);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.iucn.whp.dbservice.model.recommendation_type_lkp",
			recommendation_type_lkpLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.iucn.whp.dbservice.model.recommendation_type_lkp");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = recommendation_type_lkpPersistence.getDataSource();
	...
	private recommendation_type_lkpLocalServiceClpInvoker _clpInvoker = new recommendation_type_lkpLocalServiceClpInvoker();
}