...
/**
 * The base implementation of the whp_sites_iucn_pa_category local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.iucn.whp.dbservice.service.impl.whp_sites_iucn_pa_categoryLocalServiceImpl}.
 * </p>
 *
 * @author alok.sen
 * @see com.iucn.whp.dbservice.service.impl.whp_sites_iucn_pa_categoryLocalServiceImpl
 * @see com.iucn.whp.dbservice.service.whp_sites_iucn_pa_categoryLocalServiceUtil
 * @generated
 */
public abstract class whp_sites_iucn_pa_categoryLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements whp_sites_iucn_pa_categoryLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.iucn.whp.dbservice.service.whp_sites_iucn_pa_categoryLocalServiceUtil} to access the whp_sites_iucn_pa_category local service.
	 */
	...
	public whp_sites_iucn_pa_category addwhp_sites_iucn_pa_category(
		whp_sites_iucn_pa_category whp_sites_iucn_pa_category)
		throws SystemException {
		whp_sites_iucn_pa_category.setNew(true);

		return whp_sites_iucn_pa_categoryPersistence.update(whp_sites_iucn_pa_category,
			false);
	}
	 ...
	 */
	public whp_sites_iucn_pa_category createwhp_sites_iucn_pa_category(
		long whp_sites_iucn_pa_category_id) {
		return whp_sites_iucn_pa_categoryPersistence.create(whp_sites_iucn_pa_category_id);
	}
	...
	public whp_sites_iucn_pa_category deletewhp_sites_iucn_pa_category(
		long whp_sites_iucn_pa_category_id)
		throws PortalException, SystemException {
		return whp_sites_iucn_pa_categoryPersistence.remove(whp_sites_iucn_pa_category_id);
	}
	...
	public whp_sites_iucn_pa_category deletewhp_sites_iucn_pa_category(
		whp_sites_iucn_pa_category whp_sites_iucn_pa_category)
		throws SystemException {
		return whp_sites_iucn_pa_categoryPersistence.remove(whp_sites_iucn_pa_category);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(whp_sites_iucn_pa_category.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return whp_sites_iucn_pa_categoryPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return whp_sites_iucn_pa_categoryPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public whp_sites_iucn_pa_category fetchwhp_sites_iucn_pa_category(
		long whp_sites_iucn_pa_category_id) throws SystemException {
		return whp_sites_iucn_pa_categoryPersistence.fetchByPrimaryKey(whp_sites_iucn_pa_category_id);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public whp_sites_iucn_pa_category getwhp_sites_iucn_pa_category(
		long whp_sites_iucn_pa_category_id)
		throws PortalException, SystemException {
		return whp_sites_iucn_pa_categoryPersistence.findByPrimaryKey(whp_sites_iucn_pa_category_id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return whp_sites_iucn_pa_categoryPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<whp_sites_iucn_pa_category> getwhp_sites_iucn_pa_categories(
		int start, int end) throws SystemException {
		return whp_sites_iucn_pa_categoryPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getwhp_sites_iucn_pa_categoriesCount() throws SystemException {
		return whp_sites_iucn_pa_categoryPersistence.countAll();
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public whp_sites_iucn_pa_category updatewhp_sites_iucn_pa_category(
		whp_sites_iucn_pa_category whp_sites_iucn_pa_category)
		throws SystemException {
		return updatewhp_sites_iucn_pa_category(whp_sites_iucn_pa_category, true);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.iucn.whp.dbservice.model.whp_sites_iucn_pa_category",
			whp_sites_iucn_pa_categoryLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.iucn.whp.dbservice.model.whp_sites_iucn_pa_category");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = whp_sites_iucn_pa_categoryPersistence.getDataSource();
	...
	private whp_sites_iucn_pa_categoryLocalServiceClpInvoker _clpInvoker = new whp_sites_iucn_pa_categoryLocalServiceClpInvoker();
}