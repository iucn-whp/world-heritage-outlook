...
/**
 * The base implementation of the whp_sites_country local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.iucn.whp.dbservice.service.impl.whp_sites_countryLocalServiceImpl}.
 * </p>
 *
 * @author alok.sen
 ...
 * @generated
 */
public abstract class whp_sites_countryLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements whp_sites_countryLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.iucn.whp.dbservice.service.whp_sites_countryLocalServiceUtil} to access the whp_sites_country local service.
	 */
	...
	public whp_sites_country addwhp_sites_country(
		whp_sites_country whp_sites_country) throws SystemException {
		whp_sites_country.setNew(true);

		return whp_sites_countryPersistence.update(whp_sites_country, false);
	}
	 ...
	 */
	public whp_sites_country createwhp_sites_country(long whp_sites_country_id) {
		return whp_sites_countryPersistence.create(whp_sites_country_id);
	}
	...
	public whp_sites_country deletewhp_sites_country(long whp_sites_country_id)
		throws PortalException, SystemException {
		return whp_sites_countryPersistence.remove(whp_sites_country_id);
	}
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public whp_sites_country deletewhp_sites_country(
		whp_sites_country whp_sites_country) throws SystemException {
		return whp_sites_countryPersistence.remove(whp_sites_country);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(whp_sites_country.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return whp_sites_countryPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return whp_sites_countryPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public whp_sites_country fetchwhp_sites_country(long whp_sites_country_id)
		throws SystemException {
		return whp_sites_countryPersistence.fetchByPrimaryKey(whp_sites_country_id);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public whp_sites_country getwhp_sites_country(long whp_sites_country_id)
		throws PortalException, SystemException {
		return whp_sites_countryPersistence.findByPrimaryKey(whp_sites_country_id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return whp_sites_countryPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<whp_sites_country> getwhp_sites_countries(int start, int end)
		throws SystemException {
		return whp_sites_countryPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getwhp_sites_countriesCount() throws SystemException {
		return whp_sites_countryPersistence.countAll();
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public whp_sites_country updatewhp_sites_country(
		whp_sites_country whp_sites_country) throws SystemException {
		return updatewhp_sites_country(whp_sites_country, true);
	}
	...
	public whp_sites_country updatewhp_sites_country(
		...
		return whp_sites_countryPersistence.update(whp_sites_country, merge);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.iucn.whp.dbservice.model.whp_sites_country",
			whp_sites_countryLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.iucn.whp.dbservice.model.whp_sites_country");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = whp_sites_countryPersistence.getDataSource();
	...
	private whp_sites_countryLocalServiceClpInvoker _clpInvoker = new whp_sites_countryLocalServiceClpInvoker();
}