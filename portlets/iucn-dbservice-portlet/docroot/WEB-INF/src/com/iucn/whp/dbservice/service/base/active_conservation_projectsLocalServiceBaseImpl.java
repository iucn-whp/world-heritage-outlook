...
/**
 * The base implementation of the active_conservation_projects local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.iucn.whp.dbservice.service.impl.active_conservation_projectsLocalServiceImpl}.
 * </p>
 *
 * @author alok.sen
 ...
 * @generated
 */
public abstract class active_conservation_projectsLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements active_conservation_projectsLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.iucn.whp.dbservice.service.active_conservation_projectsLocalServiceUtil} to access the active_conservation_projects local service.
	 */
	...
	public active_conservation_projects addactive_conservation_projects(
		active_conservation_projects active_conservation_projects)
		throws SystemException {
		active_conservation_projects.setNew(true);

		return active_conservation_projectsPersistence.update(active_conservation_projects,
			false);
	}
	 ...
	 */
	public active_conservation_projects createactive_conservation_projects(
		long acpid) {
		return active_conservation_projectsPersistence.create(acpid);
	}
	...
	public active_conservation_projects deleteactive_conservation_projects(
		long acpid) throws PortalException, SystemException {
		return active_conservation_projectsPersistence.remove(acpid);
	}
	...
	public active_conservation_projects deleteactive_conservation_projects(
		active_conservation_projects active_conservation_projects)
		throws SystemException {
		return active_conservation_projectsPersistence.remove(active_conservation_projects);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(active_conservation_projects.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return active_conservation_projectsPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return active_conservation_projectsPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public active_conservation_projects fetchactive_conservation_projects(
		long acpid) throws SystemException {
		return active_conservation_projectsPersistence.fetchByPrimaryKey(acpid);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public active_conservation_projects getactive_conservation_projects(
		long acpid) throws PortalException, SystemException {
		return active_conservation_projectsPersistence.findByPrimaryKey(acpid);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return active_conservation_projectsPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<active_conservation_projects> getactive_conservation_projectses(
		int start, int end) throws SystemException {
		return active_conservation_projectsPersistence.findAll(start, end);
	}
	...
	public int getactive_conservation_projectsesCount()
		throws SystemException {
		return active_conservation_projectsPersistence.countAll();
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public active_conservation_projects updateactive_conservation_projects(
		active_conservation_projects active_conservation_projects)
		throws SystemException {
		return updateactive_conservation_projects(active_conservation_projects,
			true);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.iucn.whp.dbservice.model.active_conservation_projects",
			active_conservation_projectsLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.iucn.whp.dbservice.model.active_conservation_projects");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = active_conservation_projectsPersistence.getDataSource();
	...
	private active_conservation_projectsLocalServiceClpInvoker _clpInvoker = new active_conservation_projectsLocalServiceClpInvoker();
}