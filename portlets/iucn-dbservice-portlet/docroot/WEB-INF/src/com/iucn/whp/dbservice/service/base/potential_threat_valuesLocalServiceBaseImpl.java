...
/**
 * The base implementation of the potential_threat_values local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.iucn.whp.dbservice.service.impl.potential_threat_valuesLocalServiceImpl}.
 * </p>
 *
 * @author alok.sen
 * @see com.iucn.whp.dbservice.service.impl.potential_threat_valuesLocalServiceImpl
 * @see com.iucn.whp.dbservice.service.potential_threat_valuesLocalServiceUtil
 * @generated
 */
public abstract class potential_threat_valuesLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements potential_threat_valuesLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.iucn.whp.dbservice.service.potential_threat_valuesLocalServiceUtil} to access the potential_threat_values local service.
	 */
	...
	public potential_threat_values addpotential_threat_values(
		potential_threat_values potential_threat_values)
		throws SystemException {
		potential_threat_values.setNew(true);

		return potential_threat_valuesPersistence.update(potential_threat_values,
			false);
	}
	 ...
	 */
	public potential_threat_values createpotential_threat_values(
		long potential_threat_values_id) {
		return potential_threat_valuesPersistence.create(potential_threat_values_id);
	}
	...
	public potential_threat_values deletepotential_threat_values(
		long potential_threat_values_id)
		throws PortalException, SystemException {
		return potential_threat_valuesPersistence.remove(potential_threat_values_id);
	}
	...
	public potential_threat_values deletepotential_threat_values(
		potential_threat_values potential_threat_values)
		throws SystemException {
		return potential_threat_valuesPersistence.remove(potential_threat_values);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(potential_threat_values.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return potential_threat_valuesPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return potential_threat_valuesPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public potential_threat_values fetchpotential_threat_values(
		long potential_threat_values_id) throws SystemException {
		return potential_threat_valuesPersistence.fetchByPrimaryKey(potential_threat_values_id);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public potential_threat_values getpotential_threat_values(
		long potential_threat_values_id)
		throws PortalException, SystemException {
		return potential_threat_valuesPersistence.findByPrimaryKey(potential_threat_values_id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return potential_threat_valuesPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<potential_threat_values> getpotential_threat_valueses(
		int start, int end) throws SystemException {
		return potential_threat_valuesPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getpotential_threat_valuesesCount() throws SystemException {
		return potential_threat_valuesPersistence.countAll();
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public potential_threat_values updatepotential_threat_values(
		potential_threat_values potential_threat_values)
		throws SystemException {
		return updatepotential_threat_values(potential_threat_values, true);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.iucn.whp.dbservice.model.potential_threat_values",
			potential_threat_valuesLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.iucn.whp.dbservice.model.potential_threat_values");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = potential_threat_valuesPersistence.getDataSource();
	...
	private potential_threat_valuesLocalServiceClpInvoker _clpInvoker = new potential_threat_valuesLocalServiceClpInvoker();
}