...
/**
 * The base implementation of the potential_threat_assessment_cat local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.iucn.whp.dbservice.service.impl.potential_threat_assessment_catLocalServiceImpl}.
 * </p>
 *
 * @author alok.sen
 ...
 * @generated
 */
public abstract class potential_threat_assessment_catLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements potential_threat_assessment_catLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.iucn.whp.dbservice.service.potential_threat_assessment_catLocalServiceUtil} to access the potential_threat_assessment_cat local service.
	 */
	...
	public potential_threat_assessment_cat addpotential_threat_assessment_cat(
		potential_threat_assessment_cat potential_threat_assessment_cat)
		throws SystemException {
		potential_threat_assessment_cat.setNew(true);

		return potential_threat_assessment_catPersistence.update(potential_threat_assessment_cat,
			false);
	}
	 ...
	 */
	public potential_threat_assessment_cat createpotential_threat_assessment_cat(
		long pot_threat_cat_id) {
		return potential_threat_assessment_catPersistence.create(pot_threat_cat_id);
	}
	...
	public potential_threat_assessment_cat deletepotential_threat_assessment_cat(
		long pot_threat_cat_id) throws PortalException, SystemException {
		return potential_threat_assessment_catPersistence.remove(pot_threat_cat_id);
	}
	...
	public potential_threat_assessment_cat deletepotential_threat_assessment_cat(
		potential_threat_assessment_cat potential_threat_assessment_cat)
		throws SystemException {
		return potential_threat_assessment_catPersistence.remove(potential_threat_assessment_cat);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(potential_threat_assessment_cat.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return potential_threat_assessment_catPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return potential_threat_assessment_catPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public potential_threat_assessment_cat fetchpotential_threat_assessment_cat(
		long pot_threat_cat_id) throws SystemException {
		return potential_threat_assessment_catPersistence.fetchByPrimaryKey(pot_threat_cat_id);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public potential_threat_assessment_cat getpotential_threat_assessment_cat(
		long pot_threat_cat_id) throws PortalException, SystemException {
		return potential_threat_assessment_catPersistence.findByPrimaryKey(pot_threat_cat_id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return potential_threat_assessment_catPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<potential_threat_assessment_cat> getpotential_threat_assessment_cats(
		int start, int end) throws SystemException {
		return potential_threat_assessment_catPersistence.findAll(start, end);
	}
	...
	public int getpotential_threat_assessment_catsCount()
		throws SystemException {
		return potential_threat_assessment_catPersistence.countAll();
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public potential_threat_assessment_cat updatepotential_threat_assessment_cat(
		potential_threat_assessment_cat potential_threat_assessment_cat)
		throws SystemException {
		return updatepotential_threat_assessment_cat(potential_threat_assessment_cat,
			true);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.iucn.whp.dbservice.model.potential_threat_assessment_cat",
			potential_threat_assessment_catLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = potential_threat_assessment_catPersistence.getDataSource();
	...
	private potential_threat_assessment_catLocalServiceClpInvoker _clpInvoker = new potential_threat_assessment_catLocalServiceClpInvoker();
}