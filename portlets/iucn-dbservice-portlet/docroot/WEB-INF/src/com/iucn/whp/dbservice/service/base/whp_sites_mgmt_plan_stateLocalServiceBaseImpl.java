...
/**
 * The base implementation of the whp_sites_mgmt_plan_state local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.iucn.whp.dbservice.service.impl.whp_sites_mgmt_plan_stateLocalServiceImpl}.
 * </p>
 *
 * @author alok.sen
 ...
 * @generated
 */
public abstract class whp_sites_mgmt_plan_stateLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements whp_sites_mgmt_plan_stateLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.iucn.whp.dbservice.service.whp_sites_mgmt_plan_stateLocalServiceUtil} to access the whp_sites_mgmt_plan_state local service.
	 */
	...
	public whp_sites_mgmt_plan_state addwhp_sites_mgmt_plan_state(
		whp_sites_mgmt_plan_state whp_sites_mgmt_plan_state)
		throws SystemException {
		whp_sites_mgmt_plan_state.setNew(true);

		return whp_sites_mgmt_plan_statePersistence.update(whp_sites_mgmt_plan_state,
			false);
	}
	 ...
	 */
	public whp_sites_mgmt_plan_state createwhp_sites_mgmt_plan_state(
		long whp_sites_mgmt_plan_state_id) {
		return whp_sites_mgmt_plan_statePersistence.create(whp_sites_mgmt_plan_state_id);
	}
	...
	public whp_sites_mgmt_plan_state deletewhp_sites_mgmt_plan_state(
		long whp_sites_mgmt_plan_state_id)
		throws PortalException, SystemException {
		return whp_sites_mgmt_plan_statePersistence.remove(whp_sites_mgmt_plan_state_id);
	}
	...
	public whp_sites_mgmt_plan_state deletewhp_sites_mgmt_plan_state(
		whp_sites_mgmt_plan_state whp_sites_mgmt_plan_state)
		throws SystemException {
		return whp_sites_mgmt_plan_statePersistence.remove(whp_sites_mgmt_plan_state);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(whp_sites_mgmt_plan_state.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return whp_sites_mgmt_plan_statePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return whp_sites_mgmt_plan_statePersistence.countWithDynamicQuery(dynamicQuery);
	}

	public whp_sites_mgmt_plan_state fetchwhp_sites_mgmt_plan_state(
		long whp_sites_mgmt_plan_state_id) throws SystemException {
		return whp_sites_mgmt_plan_statePersistence.fetchByPrimaryKey(whp_sites_mgmt_plan_state_id);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public whp_sites_mgmt_plan_state getwhp_sites_mgmt_plan_state(
		long whp_sites_mgmt_plan_state_id)
		throws PortalException, SystemException {
		return whp_sites_mgmt_plan_statePersistence.findByPrimaryKey(whp_sites_mgmt_plan_state_id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return whp_sites_mgmt_plan_statePersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<whp_sites_mgmt_plan_state> getwhp_sites_mgmt_plan_states(
		int start, int end) throws SystemException {
		return whp_sites_mgmt_plan_statePersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getwhp_sites_mgmt_plan_statesCount() throws SystemException {
		return whp_sites_mgmt_plan_statePersistence.countAll();
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public whp_sites_mgmt_plan_state updatewhp_sites_mgmt_plan_state(
		whp_sites_mgmt_plan_state whp_sites_mgmt_plan_state)
		throws SystemException {
		return updatewhp_sites_mgmt_plan_state(whp_sites_mgmt_plan_state, true);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.iucn.whp.dbservice.model.whp_sites_mgmt_plan_state",
			whp_sites_mgmt_plan_stateLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.iucn.whp.dbservice.model.whp_sites_mgmt_plan_state");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = whp_sites_mgmt_plan_statePersistence.getDataSource();
	...
	private whp_sites_mgmt_plan_stateLocalServiceClpInvoker _clpInvoker = new whp_sites_mgmt_plan_stateLocalServiceClpInvoker();
}