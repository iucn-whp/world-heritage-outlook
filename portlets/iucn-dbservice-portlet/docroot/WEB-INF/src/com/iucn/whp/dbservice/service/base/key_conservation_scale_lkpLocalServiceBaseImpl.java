...
/**
 * The base implementation of the key_conservation_scale_lkp local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.iucn.whp.dbservice.service.impl.key_conservation_scale_lkpLocalServiceImpl}.
 * </p>
 *
 * @author alok.sen
 * @see com.iucn.whp.dbservice.service.impl.key_conservation_scale_lkpLocalServiceImpl
 * @see com.iucn.whp.dbservice.service.key_conservation_scale_lkpLocalServiceUtil
 * @generated
 */
public abstract class key_conservation_scale_lkpLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements key_conservation_scale_lkpLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.iucn.whp.dbservice.service.key_conservation_scale_lkpLocalServiceUtil} to access the key_conservation_scale_lkp local service.
	 */
	...
	public key_conservation_scale_lkp addkey_conservation_scale_lkp(
		key_conservation_scale_lkp key_conservation_scale_lkp)
		throws SystemException {
		key_conservation_scale_lkp.setNew(true);

		return key_conservation_scale_lkpPersistence.update(key_conservation_scale_lkp,
			false);
	}
	 ...
	 */
	public key_conservation_scale_lkp createkey_conservation_scale_lkp(
		long scale_id) {
		return key_conservation_scale_lkpPersistence.create(scale_id);
	}
	...
	public key_conservation_scale_lkp deletekey_conservation_scale_lkp(
		long scale_id) throws PortalException, SystemException {
		return key_conservation_scale_lkpPersistence.remove(scale_id);
	}
	...
	public key_conservation_scale_lkp deletekey_conservation_scale_lkp(
		key_conservation_scale_lkp key_conservation_scale_lkp)
		throws SystemException {
		return key_conservation_scale_lkpPersistence.remove(key_conservation_scale_lkp);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(key_conservation_scale_lkp.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return key_conservation_scale_lkpPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return key_conservation_scale_lkpPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public key_conservation_scale_lkp fetchkey_conservation_scale_lkp(
		long scale_id) throws SystemException {
		return key_conservation_scale_lkpPersistence.fetchByPrimaryKey(scale_id);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public key_conservation_scale_lkp getkey_conservation_scale_lkp(
		long scale_id) throws PortalException, SystemException {
		return key_conservation_scale_lkpPersistence.findByPrimaryKey(scale_id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return key_conservation_scale_lkpPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<key_conservation_scale_lkp> getkey_conservation_scale_lkps(
		int start, int end) throws SystemException {
		return key_conservation_scale_lkpPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getkey_conservation_scale_lkpsCount() throws SystemException {
		return key_conservation_scale_lkpPersistence.countAll();
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public key_conservation_scale_lkp updatekey_conservation_scale_lkp(
		key_conservation_scale_lkp key_conservation_scale_lkp)
		throws SystemException {
		return updatekey_conservation_scale_lkp(key_conservation_scale_lkp, true);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.iucn.whp.dbservice.model.key_conservation_scale_lkp",
			key_conservation_scale_lkpLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.iucn.whp.dbservice.model.key_conservation_scale_lkp");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = key_conservation_scale_lkpPersistence.getDataSource();
	...
	private key_conservation_scale_lkpLocalServiceClpInvoker _clpInvoker = new key_conservation_scale_lkpLocalServiceClpInvoker();
}