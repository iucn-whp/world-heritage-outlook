...
/**
 * The base implementation of the country_lkp local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.iucn.whp.dbservice.service.impl.country_lkpLocalServiceImpl}.
 * </p>
 *
 * @author alok.sen
 ...
 * @generated
 */
public abstract class country_lkpLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements country_lkpLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.iucn.whp.dbservice.service.country_lkpLocalServiceUtil} to access the country_lkp local service.
	 */
	...
	public country_lkp addcountry_lkp(country_lkp country_lkp)
		throws SystemException {
		country_lkp.setNew(true);

		return country_lkpPersistence.update(country_lkp, false);
	}
	 ...
	 */
	public country_lkp createcountry_lkp(int countryid) {
		return country_lkpPersistence.create(countryid);
	}
	...
	public country_lkp deletecountry_lkp(int countryid)
		throws PortalException, SystemException {
		return country_lkpPersistence.remove(countryid);
	}
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public country_lkp deletecountry_lkp(country_lkp country_lkp)
		throws SystemException {
		return country_lkpPersistence.remove(country_lkp);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(country_lkp.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return country_lkpPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return country_lkpPersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return country_lkpPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public country_lkp fetchcountry_lkp(int countryid)
		throws SystemException {
		return country_lkpPersistence.fetchByPrimaryKey(countryid);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public country_lkp getcountry_lkp(int countryid)
		throws PortalException, SystemException {
		return country_lkpPersistence.findByPrimaryKey(countryid);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return country_lkpPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<country_lkp> getcountry_lkps(int start, int end)
		throws SystemException {
		return country_lkpPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getcountry_lkpsCount() throws SystemException {
		return country_lkpPersistence.countAll();
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public country_lkp updatecountry_lkp(country_lkp country_lkp)
		throws SystemException {
		return updatecountry_lkp(country_lkp, true);
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public country_lkp updatecountry_lkp(country_lkp country_lkp, boolean merge)
		throws SystemException {
		country_lkp.setNew(false);

		return country_lkpPersistence.update(country_lkp, merge);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.iucn.whp.dbservice.model.country_lkp",
			country_lkpLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.iucn.whp.dbservice.model.country_lkp");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = country_lkpPersistence.getDataSource();
	...
	private country_lkpLocalServiceClpInvoker _clpInvoker = new country_lkpLocalServiceClpInvoker();
}