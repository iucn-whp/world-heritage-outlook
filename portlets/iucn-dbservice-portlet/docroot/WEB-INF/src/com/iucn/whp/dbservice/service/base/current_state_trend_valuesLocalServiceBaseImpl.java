...
/**
 * The base implementation of the current_state_trend_values local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.iucn.whp.dbservice.service.impl.current_state_trend_valuesLocalServiceImpl}.
 * </p>
 *
 * @author alok.sen
 * @see com.iucn.whp.dbservice.service.impl.current_state_trend_valuesLocalServiceImpl
 * @see com.iucn.whp.dbservice.service.current_state_trend_valuesLocalServiceUtil
 * @generated
 */
public abstract class current_state_trend_valuesLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements current_state_trend_valuesLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.iucn.whp.dbservice.service.current_state_trend_valuesLocalServiceUtil} to access the current_state_trend_values local service.
	 */

	/**
	 * Adds the current_state_trend_values to the database. Also notifies the appropriate model listeners.
	 *
	 * @param current_state_trend_values the current_state_trend_values
	 * @return the current_state_trend_values that was added
	 * @throws SystemException if a system exception occurred
	 */
	@Indexable(type = IndexableType.REINDEX)
	public current_state_trend_values addcurrent_state_trend_values(
		current_state_trend_values current_state_trend_values)
		throws SystemException {
		current_state_trend_values.setNew(true);

		return current_state_trend_valuesPersistence.update(current_state_trend_values,
			false);
	}
	 ...
	 */
	public current_state_trend_values createcurrent_state_trend_values(long id) {
		return current_state_trend_valuesPersistence.create(id);
	}

	/**
	 * Deletes the current_state_trend_values with the primary key from the database. Also notifies the appropriate model listeners.
	 *
	 * @param id the primary key of the current_state_trend_values
	 * @return the current_state_trend_values that was removed
	 * @throws PortalException if a current_state_trend_values with the primary key could not be found
	 * @throws SystemException if a system exception occurred
	 */
	@Indexable(type = IndexableType.DELETE)
	public current_state_trend_values deletecurrent_state_trend_values(long id)
		throws PortalException, SystemException {
		return current_state_trend_valuesPersistence.remove(id);
	}

	/**
	 * Deletes the current_state_trend_values from the database. Also notifies the appropriate model listeners.
	 *
	 * @param current_state_trend_values the current_state_trend_values
	 * @return the current_state_trend_values that was removed
	 * @throws SystemException if a system exception occurred
	 */
	@Indexable(type = IndexableType.DELETE)
	public current_state_trend_values deletecurrent_state_trend_values(
		current_state_trend_values current_state_trend_values)
		throws SystemException {
		return current_state_trend_valuesPersistence.remove(current_state_trend_values);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(current_state_trend_values.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return current_state_trend_valuesPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return current_state_trend_valuesPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public current_state_trend_values fetchcurrent_state_trend_values(long id)
		throws SystemException {
		return current_state_trend_valuesPersistence.fetchByPrimaryKey(id);
	}

	/**
	 * Returns the current_state_trend_values with the primary key.
	 *
	 * @param id the primary key of the current_state_trend_values
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public current_state_trend_values getcurrent_state_trend_values(long id)
		throws PortalException, SystemException {
		return current_state_trend_valuesPersistence.findByPrimaryKey(id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return current_state_trend_valuesPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<current_state_trend_values> getcurrent_state_trend_valueses(
		int start, int end) throws SystemException {
		return current_state_trend_valuesPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getcurrent_state_trend_valuesesCount() throws SystemException {
		return current_state_trend_valuesPersistence.countAll();
	}

	/**
	 * Updates the current_state_trend_values in the database or adds it if it does not yet exist. Also notifies the appropriate model listeners.
	 *
	 * @param current_state_trend_values the current_state_trend_values
	 * @return the current_state_trend_values that was updated
	 * @throws SystemException if a system exception occurred
	 */
	@Indexable(type = IndexableType.REINDEX)
	public current_state_trend_values updatecurrent_state_trend_values(
		current_state_trend_values current_state_trend_values)
		throws SystemException {
		return updatecurrent_state_trend_values(current_state_trend_values, true);
	}
	 ...
	 *
	 * @param current_state_trend_values the current_state_trend_values
	 * @param merge whether to merge the current_state_trend_values with the current session. See {@link com.liferay.portal.service.persistence.BatchSession#update(com.liferay.portal.kernel.dao.orm.Session, com.liferay.portal.model.BaseModel, boolean)} for an explanation.
	 * @return the current_state_trend_values that was updated
	 * @throws SystemException if a system exception occurred
	 */
	@Indexable(type = IndexableType.REINDEX)
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.iucn.whp.dbservice.model.current_state_trend_values",
			current_state_trend_valuesLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.iucn.whp.dbservice.model.current_state_trend_values");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = current_state_trend_valuesPersistence.getDataSource();
	...
	private current_state_trend_valuesLocalServiceClpInvoker _clpInvoker = new current_state_trend_valuesLocalServiceClpInvoker();
}