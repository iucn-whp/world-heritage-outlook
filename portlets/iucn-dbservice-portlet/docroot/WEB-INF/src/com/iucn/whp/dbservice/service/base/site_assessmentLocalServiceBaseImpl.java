...
/**
 * The base implementation of the site_assessment local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.iucn.whp.dbservice.service.impl.site_assessmentLocalServiceImpl}.
 * </p>
 *
 * @author alok.sen
 ...
 * @generated
 */
public abstract class site_assessmentLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements site_assessmentLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.iucn.whp.dbservice.service.site_assessmentLocalServiceUtil} to access the site_assessment local service.
	 */
	...
	public site_assessment addsite_assessment(site_assessment site_assessment)
		throws SystemException {
		site_assessment.setNew(true);

		return site_assessmentPersistence.update(site_assessment, false);
	}
	 ...
	 */
	public site_assessment createsite_assessment(long assessment_id) {
		return site_assessmentPersistence.create(assessment_id);
	}
	...
	public site_assessment deletesite_assessment(long assessment_id)
		throws PortalException, SystemException {
		return site_assessmentPersistence.remove(assessment_id);
	}
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public site_assessment deletesite_assessment(
		site_assessment site_assessment) throws SystemException {
		return site_assessmentPersistence.remove(site_assessment);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(site_assessment.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return site_assessmentPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return site_assessmentPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public site_assessment fetchsite_assessment(long assessment_id)
		throws SystemException {
		return site_assessmentPersistence.fetchByPrimaryKey(assessment_id);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public site_assessment getsite_assessment(long assessment_id)
		throws PortalException, SystemException {
		return site_assessmentPersistence.findByPrimaryKey(assessment_id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return site_assessmentPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<site_assessment> getsite_assessments(int start, int end)
		throws SystemException {
		return site_assessmentPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getsite_assessmentsCount() throws SystemException {
		return site_assessmentPersistence.countAll();
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public site_assessment updatesite_assessment(
		site_assessment site_assessment) throws SystemException {
		return updatesite_assessment(site_assessment, true);
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	public site_assessment updatesite_assessment(
		site_assessment site_assessment, boolean merge)
		throws SystemException {
		site_assessment.setNew(false);

		return site_assessmentPersistence.update(site_assessment, merge);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.iucn.whp.dbservice.model.site_assessment",
			site_assessmentLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = site_assessmentPersistence.getDataSource();
	...
	private site_assessmentLocalServiceClpInvoker _clpInvoker = new site_assessmentLocalServiceClpInvoker();
}