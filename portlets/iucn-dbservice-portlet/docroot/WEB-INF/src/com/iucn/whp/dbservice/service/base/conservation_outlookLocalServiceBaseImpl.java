...
/**
 * The base implementation of the conservation_outlook local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.iucn.whp.dbservice.service.impl.conservation_outlookLocalServiceImpl}.
 * </p>
 *
 * @author alok.sen
 ...
 * @generated
 */
public abstract class conservation_outlookLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements conservation_outlookLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.iucn.whp.dbservice.service.conservation_outlookLocalServiceUtil} to access the conservation_outlook local service.
	 */
	...
	public conservation_outlook addconservation_outlook(
		conservation_outlook conservation_outlook) throws SystemException {
		conservation_outlook.setNew(true);

		return conservation_outlookPersistence.update(conservation_outlook,
			false);
	}
	 ...
	 */
	public conservation_outlook createconservation_outlook(
		long conservation_outlook_id) {
		return conservation_outlookPersistence.create(conservation_outlook_id);
	}
	...
	public conservation_outlook deleteconservation_outlook(
		long conservation_outlook_id) throws PortalException, SystemException {
		return conservation_outlookPersistence.remove(conservation_outlook_id);
	}
	...
	public conservation_outlook deleteconservation_outlook(
		conservation_outlook conservation_outlook) throws SystemException {
		return conservation_outlookPersistence.remove(conservation_outlook);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(conservation_outlook.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return conservation_outlookPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return conservation_outlookPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public conservation_outlook fetchconservation_outlook(
		long conservation_outlook_id) throws SystemException {
		return conservation_outlookPersistence.fetchByPrimaryKey(conservation_outlook_id);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public conservation_outlook getconservation_outlook(
		long conservation_outlook_id) throws PortalException, SystemException {
		return conservation_outlookPersistence.findByPrimaryKey(conservation_outlook_id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return conservation_outlookPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<conservation_outlook> getconservation_outlooks(int start,
		int end) throws SystemException {
		return conservation_outlookPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getconservation_outlooksCount() throws SystemException {
		return conservation_outlookPersistence.countAll();
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public conservation_outlook updateconservation_outlook(
		conservation_outlook conservation_outlook) throws SystemException {
		return updateconservation_outlook(conservation_outlook, true);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.iucn.whp.dbservice.model.conservation_outlook",
			conservation_outlookLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = conservation_outlookPersistence.getDataSource();
	...
	private conservation_outlookLocalServiceClpInvoker _clpInvoker = new conservation_outlookLocalServiceClpInvoker();
}