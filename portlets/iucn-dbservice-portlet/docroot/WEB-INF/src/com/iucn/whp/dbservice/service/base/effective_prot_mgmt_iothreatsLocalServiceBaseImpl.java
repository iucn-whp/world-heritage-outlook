...
/**
 * The base implementation of the effective_prot_mgmt_iothreats local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.iucn.whp.dbservice.service.impl.effective_prot_mgmt_iothreatsLocalServiceImpl}.
 * </p>
 *
 * @author alok.sen
 ...
 * @generated
 */
public abstract class effective_prot_mgmt_iothreatsLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements effective_prot_mgmt_iothreatsLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.iucn.whp.dbservice.service.effective_prot_mgmt_iothreatsLocalServiceUtil} to access the effective_prot_mgmt_iothreats local service.
	 */
	...
	public effective_prot_mgmt_iothreats addeffective_prot_mgmt_iothreats(
		effective_prot_mgmt_iothreats effective_prot_mgmt_iothreats)
		throws SystemException {
		effective_prot_mgmt_iothreats.setNew(true);

		return effective_prot_mgmt_iothreatsPersistence.update(effective_prot_mgmt_iothreats,
			false);
	}
	 ...
	 */
	public effective_prot_mgmt_iothreats createeffective_prot_mgmt_iothreats(
		long id) {
		return effective_prot_mgmt_iothreatsPersistence.create(id);
	}
	...
	public effective_prot_mgmt_iothreats deleteeffective_prot_mgmt_iothreats(
		long id) throws PortalException, SystemException {
		return effective_prot_mgmt_iothreatsPersistence.remove(id);
	}
	...
	public effective_prot_mgmt_iothreats deleteeffective_prot_mgmt_iothreats(
		effective_prot_mgmt_iothreats effective_prot_mgmt_iothreats)
		throws SystemException {
		return effective_prot_mgmt_iothreatsPersistence.remove(effective_prot_mgmt_iothreats);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(effective_prot_mgmt_iothreats.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return effective_prot_mgmt_iothreatsPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return effective_prot_mgmt_iothreatsPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public effective_prot_mgmt_iothreats fetcheffective_prot_mgmt_iothreats(
		long id) throws SystemException {
		return effective_prot_mgmt_iothreatsPersistence.fetchByPrimaryKey(id);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public effective_prot_mgmt_iothreats geteffective_prot_mgmt_iothreats(
		long id) throws PortalException, SystemException {
		return effective_prot_mgmt_iothreatsPersistence.findByPrimaryKey(id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return effective_prot_mgmt_iothreatsPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<effective_prot_mgmt_iothreats> geteffective_prot_mgmt_iothreatses(
		int start, int end) throws SystemException {
		return effective_prot_mgmt_iothreatsPersistence.findAll(start, end);
	}
	...
	public int geteffective_prot_mgmt_iothreatsesCount()
		throws SystemException {
		return effective_prot_mgmt_iothreatsPersistence.countAll();
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public effective_prot_mgmt_iothreats updateeffective_prot_mgmt_iothreats(
		effective_prot_mgmt_iothreats effective_prot_mgmt_iothreats)
		throws SystemException {
		return updateeffective_prot_mgmt_iothreats(effective_prot_mgmt_iothreats,
			true);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.iucn.whp.dbservice.model.effective_prot_mgmt_iothreats",
			effective_prot_mgmt_iothreatsLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = effective_prot_mgmt_iothreatsPersistence.getDataSource();
	...
	private effective_prot_mgmt_iothreatsLocalServiceClpInvoker _clpInvoker = new effective_prot_mgmt_iothreatsLocalServiceClpInvoker();
}