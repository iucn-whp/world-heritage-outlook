...
/**
 * The base implementation of the boundary_modification_type_lkp local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.iucn.whp.dbservice.service.impl.boundary_modification_type_lkpLocalServiceImpl}.
 * </p>
 *
 * @author alok.sen
 * @see com.iucn.whp.dbservice.service.impl.boundary_modification_type_lkpLocalServiceImpl
 * @see com.iucn.whp.dbservice.service.boundary_modification_type_lkpLocalServiceUtil
 * @generated
 */
public abstract class boundary_modification_type_lkpLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements boundary_modification_type_lkpLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.iucn.whp.dbservice.service.boundary_modification_type_lkpLocalServiceUtil} to access the boundary_modification_type_lkp local service.
	 */
	...
	public boundary_modification_type_lkp addboundary_modification_type_lkp(
		boundary_modification_type_lkp boundary_modification_type_lkp)
		throws SystemException {
		boundary_modification_type_lkp.setNew(true);

		return boundary_modification_type_lkpPersistence.update(boundary_modification_type_lkp,
			false);
	}
	 ...
	 */
	public boundary_modification_type_lkp createboundary_modification_type_lkp(
		int bm_id) {
		return boundary_modification_type_lkpPersistence.create(bm_id);
	}
	...
	public boundary_modification_type_lkp deleteboundary_modification_type_lkp(
		int bm_id) throws PortalException, SystemException {
		return boundary_modification_type_lkpPersistence.remove(bm_id);
	}
	...
	public boundary_modification_type_lkp deleteboundary_modification_type_lkp(
		boundary_modification_type_lkp boundary_modification_type_lkp)
		throws SystemException {
		return boundary_modification_type_lkpPersistence.remove(boundary_modification_type_lkp);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(boundary_modification_type_lkp.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return boundary_modification_type_lkpPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return boundary_modification_type_lkpPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public boundary_modification_type_lkp fetchboundary_modification_type_lkp(
		int bm_id) throws SystemException {
		return boundary_modification_type_lkpPersistence.fetchByPrimaryKey(bm_id);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public boundary_modification_type_lkp getboundary_modification_type_lkp(
		int bm_id) throws PortalException, SystemException {
		return boundary_modification_type_lkpPersistence.findByPrimaryKey(bm_id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return boundary_modification_type_lkpPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<boundary_modification_type_lkp> getboundary_modification_type_lkps(
		int start, int end) throws SystemException {
		return boundary_modification_type_lkpPersistence.findAll(start, end);
	}
	...
	public int getboundary_modification_type_lkpsCount()
		throws SystemException {
		return boundary_modification_type_lkpPersistence.countAll();
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public boundary_modification_type_lkp updateboundary_modification_type_lkp(
		boundary_modification_type_lkp boundary_modification_type_lkp)
		throws SystemException {
		return updateboundary_modification_type_lkp(boundary_modification_type_lkp,
			true);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.iucn.whp.dbservice.model.boundary_modification_type_lkp",
			boundary_modification_type_lkpLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.iucn.whp.dbservice.model.boundary_modification_type_lkp");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = boundary_modification_type_lkpPersistence.getDataSource();
	...
	private boundary_modification_type_lkpLocalServiceClpInvoker _clpInvoker = new boundary_modification_type_lkpLocalServiceClpInvoker();
}