...
/**
 * The base implementation of the whp_sites_inscription_criteria local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.iucn.whp.dbservice.service.impl.whp_sites_inscription_criteriaLocalServiceImpl}.
 * </p>
 *
 * @author alok.sen
 * @see com.iucn.whp.dbservice.service.impl.whp_sites_inscription_criteriaLocalServiceImpl
 * @see com.iucn.whp.dbservice.service.whp_sites_inscription_criteriaLocalServiceUtil
 * @generated
 */
public abstract class whp_sites_inscription_criteriaLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements whp_sites_inscription_criteriaLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.iucn.whp.dbservice.service.whp_sites_inscription_criteriaLocalServiceUtil} to access the whp_sites_inscription_criteria local service.
	 */
	...
	public whp_sites_inscription_criteria addwhp_sites_inscription_criteria(
		whp_sites_inscription_criteria whp_sites_inscription_criteria)
		throws SystemException {
		whp_sites_inscription_criteria.setNew(true);

		return whp_sites_inscription_criteriaPersistence.update(whp_sites_inscription_criteria,
			false);
	}
	 ...
	 */
	public whp_sites_inscription_criteria createwhp_sites_inscription_criteria(
		long whp_sites_inscription_criteria_id) {
		return whp_sites_inscription_criteriaPersistence.create(whp_sites_inscription_criteria_id);
	}
	...
	public whp_sites_inscription_criteria deletewhp_sites_inscription_criteria(
		long whp_sites_inscription_criteria_id)
		throws PortalException, SystemException {
		return whp_sites_inscription_criteriaPersistence.remove(whp_sites_inscription_criteria_id);
	}
	...
	public whp_sites_inscription_criteria deletewhp_sites_inscription_criteria(
		whp_sites_inscription_criteria whp_sites_inscription_criteria)
		throws SystemException {
		return whp_sites_inscription_criteriaPersistence.remove(whp_sites_inscription_criteria);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(whp_sites_inscription_criteria.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return whp_sites_inscription_criteriaPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return whp_sites_inscription_criteriaPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public whp_sites_inscription_criteria fetchwhp_sites_inscription_criteria(
		long whp_sites_inscription_criteria_id) throws SystemException {
		return whp_sites_inscription_criteriaPersistence.fetchByPrimaryKey(whp_sites_inscription_criteria_id);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public whp_sites_inscription_criteria getwhp_sites_inscription_criteria(
		long whp_sites_inscription_criteria_id)
		throws PortalException, SystemException {
		return whp_sites_inscription_criteriaPersistence.findByPrimaryKey(whp_sites_inscription_criteria_id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return whp_sites_inscription_criteriaPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<whp_sites_inscription_criteria> getwhp_sites_inscription_criterias(
		int start, int end) throws SystemException {
		return whp_sites_inscription_criteriaPersistence.findAll(start, end);
	}
	...
	public int getwhp_sites_inscription_criteriasCount()
		throws SystemException {
		return whp_sites_inscription_criteriaPersistence.countAll();
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public whp_sites_inscription_criteria updatewhp_sites_inscription_criteria(
		whp_sites_inscription_criteria whp_sites_inscription_criteria)
		throws SystemException {
		return updatewhp_sites_inscription_criteria(whp_sites_inscription_criteria,
			true);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.iucn.whp.dbservice.model.whp_sites_inscription_criteria",
			whp_sites_inscription_criteriaLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.iucn.whp.dbservice.model.whp_sites_inscription_criteria");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = whp_sites_inscription_criteriaPersistence.getDataSource();
	...
	private whp_sites_inscription_criteriaLocalServiceClpInvoker _clpInvoker = new whp_sites_inscription_criteriaLocalServiceClpInvoker();
}