...
/**
 * The base implementation of the whp_sites_mission local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.iucn.whp.dbservice.service.impl.whp_sites_missionLocalServiceImpl}.
 * </p>
 *
 * @author alok.sen
 ...
 * @generated
 */
public abstract class whp_sites_missionLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements whp_sites_missionLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.iucn.whp.dbservice.service.whp_sites_missionLocalServiceUtil} to access the whp_sites_mission local service.
	 */
	...
	public whp_sites_mission addwhp_sites_mission(
		whp_sites_mission whp_sites_mission) throws SystemException {
		whp_sites_mission.setNew(true);

		return whp_sites_missionPersistence.update(whp_sites_mission, false);
	}
	 ...
	 */
	public whp_sites_mission createwhp_sites_mission(long whp_sites_mission_id) {
		return whp_sites_missionPersistence.create(whp_sites_mission_id);
	}
	...
	public whp_sites_mission deletewhp_sites_mission(long whp_sites_mission_id)
		throws PortalException, SystemException {
		return whp_sites_missionPersistence.remove(whp_sites_mission_id);
	}
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public whp_sites_mission deletewhp_sites_mission(
		whp_sites_mission whp_sites_mission) throws SystemException {
		return whp_sites_missionPersistence.remove(whp_sites_mission);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(whp_sites_mission.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return whp_sites_missionPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return whp_sites_missionPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public whp_sites_mission fetchwhp_sites_mission(long whp_sites_mission_id)
		throws SystemException {
		return whp_sites_missionPersistence.fetchByPrimaryKey(whp_sites_mission_id);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public whp_sites_mission getwhp_sites_mission(long whp_sites_mission_id)
		throws PortalException, SystemException {
		return whp_sites_missionPersistence.findByPrimaryKey(whp_sites_mission_id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return whp_sites_missionPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<whp_sites_mission> getwhp_sites_missions(int start, int end)
		throws SystemException {
		return whp_sites_missionPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getwhp_sites_missionsCount() throws SystemException {
		return whp_sites_missionPersistence.countAll();
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public whp_sites_mission updatewhp_sites_mission(
		whp_sites_mission whp_sites_mission) throws SystemException {
		return updatewhp_sites_mission(whp_sites_mission, true);
	}
	...
	public whp_sites_mission updatewhp_sites_mission(
		...
		return whp_sites_missionPersistence.update(whp_sites_mission, merge);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.iucn.whp.dbservice.model.whp_sites_mission",
			whp_sites_missionLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = whp_sites_missionPersistence.getDataSource();
	...
	private whp_sites_missionLocalServiceClpInvoker _clpInvoker = new whp_sites_missionLocalServiceClpInvoker();
}