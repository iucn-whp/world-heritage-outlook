...
/**
 * The base implementation of the whp_sites_inscription_date local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.iucn.whp.dbservice.service.impl.whp_sites_inscription_dateLocalServiceImpl}.
 * </p>
 *
 * @author alok.sen
 * @see com.iucn.whp.dbservice.service.impl.whp_sites_inscription_dateLocalServiceImpl
 * @see com.iucn.whp.dbservice.service.whp_sites_inscription_dateLocalServiceUtil
 * @generated
 */
public abstract class whp_sites_inscription_dateLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements whp_sites_inscription_dateLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.iucn.whp.dbservice.service.whp_sites_inscription_dateLocalServiceUtil} to access the whp_sites_inscription_date local service.
	 */
	...
	public whp_sites_inscription_date addwhp_sites_inscription_date(
		whp_sites_inscription_date whp_sites_inscription_date)
		throws SystemException {
		whp_sites_inscription_date.setNew(true);

		return whp_sites_inscription_datePersistence.update(whp_sites_inscription_date,
			false);
	}
	 ...
	 */
	public whp_sites_inscription_date createwhp_sites_inscription_date(
		long whp_sites_inscription_date_id) {
		return whp_sites_inscription_datePersistence.create(whp_sites_inscription_date_id);
	}
	...
	public whp_sites_inscription_date deletewhp_sites_inscription_date(
		long whp_sites_inscription_date_id)
		throws PortalException, SystemException {
		return whp_sites_inscription_datePersistence.remove(whp_sites_inscription_date_id);
	}
	...
	public whp_sites_inscription_date deletewhp_sites_inscription_date(
		whp_sites_inscription_date whp_sites_inscription_date)
		throws SystemException {
		return whp_sites_inscription_datePersistence.remove(whp_sites_inscription_date);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(whp_sites_inscription_date.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return whp_sites_inscription_datePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return whp_sites_inscription_datePersistence.countWithDynamicQuery(dynamicQuery);
	}

	public whp_sites_inscription_date fetchwhp_sites_inscription_date(
		long whp_sites_inscription_date_id) throws SystemException {
		return whp_sites_inscription_datePersistence.fetchByPrimaryKey(whp_sites_inscription_date_id);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public whp_sites_inscription_date getwhp_sites_inscription_date(
		long whp_sites_inscription_date_id)
		throws PortalException, SystemException {
		return whp_sites_inscription_datePersistence.findByPrimaryKey(whp_sites_inscription_date_id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return whp_sites_inscription_datePersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<whp_sites_inscription_date> getwhp_sites_inscription_dates(
		int start, int end) throws SystemException {
		return whp_sites_inscription_datePersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getwhp_sites_inscription_datesCount() throws SystemException {
		return whp_sites_inscription_datePersistence.countAll();
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public whp_sites_inscription_date updatewhp_sites_inscription_date(
		whp_sites_inscription_date whp_sites_inscription_date)
		throws SystemException {
		return updatewhp_sites_inscription_date(whp_sites_inscription_date, true);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.iucn.whp.dbservice.model.whp_sites_inscription_date",
			whp_sites_inscription_dateLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.iucn.whp.dbservice.model.whp_sites_inscription_date");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = whp_sites_inscription_datePersistence.getDataSource();
	...
	private whp_sites_inscription_dateLocalServiceClpInvoker _clpInvoker = new whp_sites_inscription_dateLocalServiceClpInvoker();
}