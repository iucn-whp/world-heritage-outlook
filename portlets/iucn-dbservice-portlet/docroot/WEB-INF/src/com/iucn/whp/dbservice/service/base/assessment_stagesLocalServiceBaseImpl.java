...
/**
 * The base implementation of the assessment_stages local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.iucn.whp.dbservice.service.impl.assessment_stagesLocalServiceImpl}.
 * </p>
 *
 * @author alok.sen
 * @see com.iucn.whp.dbservice.service.impl.assessment_stagesLocalServiceImpl
 * @see com.iucn.whp.dbservice.service.assessment_stagesLocalServiceUtil
 * @generated
 */
public abstract class assessment_stagesLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements assessment_stagesLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.iucn.whp.dbservice.service.assessment_stagesLocalServiceUtil} to access the assessment_stages local service.
	 */
	...
	public assessment_stages addassessment_stages(
		assessment_stages assessment_stages) throws SystemException {
		assessment_stages.setNew(true);

		return assessment_stagesPersistence.update(assessment_stages, false);
	}
	 ...
	 */
	public assessment_stages createassessment_stages(long stageid) {
		return assessment_stagesPersistence.create(stageid);
	}
	...
	public assessment_stages deleteassessment_stages(long stageid)
		throws PortalException, SystemException {
		return assessment_stagesPersistence.remove(stageid);
	}
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public assessment_stages deleteassessment_stages(
		assessment_stages assessment_stages) throws SystemException {
		return assessment_stagesPersistence.remove(assessment_stages);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(assessment_stages.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return assessment_stagesPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return assessment_stagesPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public assessment_stages fetchassessment_stages(long stageid)
		throws SystemException {
		return assessment_stagesPersistence.fetchByPrimaryKey(stageid);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public assessment_stages getassessment_stages(long stageid)
		throws PortalException, SystemException {
		return assessment_stagesPersistence.findByPrimaryKey(stageid);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return assessment_stagesPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<assessment_stages> getassessment_stageses(int start, int end)
		throws SystemException {
		return assessment_stagesPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getassessment_stagesesCount() throws SystemException {
		return assessment_stagesPersistence.countAll();
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public assessment_stages updateassessment_stages(
		assessment_stages assessment_stages) throws SystemException {
		return updateassessment_stages(assessment_stages, true);
	}
	...
	public assessment_stages updateassessment_stages(
		...
		return assessment_stagesPersistence.update(assessment_stages, merge);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.iucn.whp.dbservice.model.assessment_stages",
			assessment_stagesLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = assessment_stagesPersistence.getDataSource();
	...
	private assessment_stagesLocalServiceClpInvoker _clpInvoker = new assessment_stagesLocalServiceClpInvoker();
}