...
/**
 * The base implementation of the other_designation_lkp local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.iucn.whp.dbservice.service.impl.other_designation_lkpLocalServiceImpl}.
 * </p>
 *
 * @author alok.sen
 ...
 * @generated
 */
public abstract class other_designation_lkpLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements other_designation_lkpLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.iucn.whp.dbservice.service.other_designation_lkpLocalServiceUtil} to access the other_designation_lkp local service.
	 */
	...
	public other_designation_lkp addother_designation_lkp(
		other_designation_lkp other_designation_lkp) throws SystemException {
		other_designation_lkp.setNew(true);

		return other_designation_lkpPersistence.update(other_designation_lkp,
			false);
	}
	 ...
	 */
	public other_designation_lkp createother_designation_lkp(
		int other_designations_id) {
		return other_designation_lkpPersistence.create(other_designations_id);
	}
	...
	public other_designation_lkp deleteother_designation_lkp(
		int other_designations_id) throws PortalException, SystemException {
		return other_designation_lkpPersistence.remove(other_designations_id);
	}
	...
	public other_designation_lkp deleteother_designation_lkp(
		other_designation_lkp other_designation_lkp) throws SystemException {
		return other_designation_lkpPersistence.remove(other_designation_lkp);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(other_designation_lkp.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return other_designation_lkpPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return other_designation_lkpPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public other_designation_lkp fetchother_designation_lkp(
		int other_designations_id) throws SystemException {
		return other_designation_lkpPersistence.fetchByPrimaryKey(other_designations_id);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public other_designation_lkp getother_designation_lkp(
		int other_designations_id) throws PortalException, SystemException {
		return other_designation_lkpPersistence.findByPrimaryKey(other_designations_id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return other_designation_lkpPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<other_designation_lkp> getother_designation_lkps(int start,
		int end) throws SystemException {
		return other_designation_lkpPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getother_designation_lkpsCount() throws SystemException {
		return other_designation_lkpPersistence.countAll();
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public other_designation_lkp updateother_designation_lkp(
		other_designation_lkp other_designation_lkp) throws SystemException {
		return updateother_designation_lkp(other_designation_lkp, true);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.iucn.whp.dbservice.model.other_designation_lkp",
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = other_designation_lkpPersistence.getDataSource();
	...
	private other_designation_lkpLocalServiceClpInvoker _clpInvoker = new other_designation_lkpLocalServiceClpInvoker();
}