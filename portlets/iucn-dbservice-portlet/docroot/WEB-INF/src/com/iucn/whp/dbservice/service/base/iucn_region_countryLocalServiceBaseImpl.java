...
/**
 * The base implementation of the iucn_region_country local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.iucn.whp.dbservice.service.impl.iucn_region_countryLocalServiceImpl}.
 * </p>
 *
 * @author alok.sen
 ...
 * @generated
 */
public abstract class iucn_region_countryLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements iucn_region_countryLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.iucn.whp.dbservice.service.iucn_region_countryLocalServiceUtil} to access the iucn_region_country local service.
	 */
	...
	public iucn_region_country addiucn_region_country(
		iucn_region_country iucn_region_country) throws SystemException {
		iucn_region_country.setNew(true);

		return iucn_region_countryPersistence.update(iucn_region_country, false);
	}
	 ...
	 */
	public iucn_region_country createiucn_region_country(
		int whp_iucn_region_country_id) {
		return iucn_region_countryPersistence.create(whp_iucn_region_country_id);
	}
	...
	public iucn_region_country deleteiucn_region_country(
		int whp_iucn_region_country_id) throws PortalException, SystemException {
		return iucn_region_countryPersistence.remove(whp_iucn_region_country_id);
	}
	...
	public iucn_region_country deleteiucn_region_country(
		iucn_region_country iucn_region_country) throws SystemException {
		return iucn_region_countryPersistence.remove(iucn_region_country);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(iucn_region_country.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return iucn_region_countryPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return iucn_region_countryPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public iucn_region_country fetchiucn_region_country(
		int whp_iucn_region_country_id) throws SystemException {
		return iucn_region_countryPersistence.fetchByPrimaryKey(whp_iucn_region_country_id);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public iucn_region_country getiucn_region_country(
		int whp_iucn_region_country_id) throws PortalException, SystemException {
		return iucn_region_countryPersistence.findByPrimaryKey(whp_iucn_region_country_id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return iucn_region_countryPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<iucn_region_country> getiucn_region_countries(int start, int end)
		throws SystemException {
		return iucn_region_countryPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getiucn_region_countriesCount() throws SystemException {
		return iucn_region_countryPersistence.countAll();
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public iucn_region_country updateiucn_region_country(
		iucn_region_country iucn_region_country) throws SystemException {
		return updateiucn_region_country(iucn_region_country, true);
	}
	...
	public iucn_region_country updateiucn_region_country(
		...
		return iucn_region_countryPersistence.update(iucn_region_country, merge);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.iucn.whp.dbservice.model.iucn_region_country",
			iucn_region_countryLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.iucn.whp.dbservice.model.iucn_region_country");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = iucn_region_countryPersistence.getDataSource();
	...
	private iucn_region_countryLocalServiceClpInvoker _clpInvoker = new iucn_region_countryLocalServiceClpInvoker();
}