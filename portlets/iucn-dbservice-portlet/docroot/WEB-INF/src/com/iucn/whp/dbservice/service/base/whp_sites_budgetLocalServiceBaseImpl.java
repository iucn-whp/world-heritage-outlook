...
/**
 * The base implementation of the whp_sites_budget local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.iucn.whp.dbservice.service.impl.whp_sites_budgetLocalServiceImpl}.
 * </p>
 *
 * @author alok.sen
 * @see com.iucn.whp.dbservice.service.impl.whp_sites_budgetLocalServiceImpl
 * @see com.iucn.whp.dbservice.service.whp_sites_budgetLocalServiceUtil
 * @generated
 */
public abstract class whp_sites_budgetLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements whp_sites_budgetLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.iucn.whp.dbservice.service.whp_sites_budgetLocalServiceUtil} to access the whp_sites_budget local service.
	 */
	...
	public whp_sites_budget addwhp_sites_budget(
		whp_sites_budget whp_sites_budget) throws SystemException {
		whp_sites_budget.setNew(true);

		return whp_sites_budgetPersistence.update(whp_sites_budget, false);
	}
	 ...
	 */
	public whp_sites_budget createwhp_sites_budget(long whp_sites_budget_id) {
		return whp_sites_budgetPersistence.create(whp_sites_budget_id);
	}
	...
	public whp_sites_budget deletewhp_sites_budget(long whp_sites_budget_id)
		throws PortalException, SystemException {
		return whp_sites_budgetPersistence.remove(whp_sites_budget_id);
	}
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public whp_sites_budget deletewhp_sites_budget(
		whp_sites_budget whp_sites_budget) throws SystemException {
		return whp_sites_budgetPersistence.remove(whp_sites_budget);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(whp_sites_budget.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return whp_sites_budgetPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return whp_sites_budgetPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public whp_sites_budget fetchwhp_sites_budget(long whp_sites_budget_id)
		throws SystemException {
		return whp_sites_budgetPersistence.fetchByPrimaryKey(whp_sites_budget_id);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public whp_sites_budget getwhp_sites_budget(long whp_sites_budget_id)
		throws PortalException, SystemException {
		return whp_sites_budgetPersistence.findByPrimaryKey(whp_sites_budget_id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return whp_sites_budgetPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<whp_sites_budget> getwhp_sites_budgets(int start, int end)
		throws SystemException {
		return whp_sites_budgetPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getwhp_sites_budgetsCount() throws SystemException {
		return whp_sites_budgetPersistence.countAll();
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public whp_sites_budget updatewhp_sites_budget(
		whp_sites_budget whp_sites_budget) throws SystemException {
		return updatewhp_sites_budget(whp_sites_budget, true);
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	public whp_sites_budget updatewhp_sites_budget(
		whp_sites_budget whp_sites_budget, boolean merge)
		throws SystemException {
		whp_sites_budget.setNew(false);

		return whp_sites_budgetPersistence.update(whp_sites_budget, merge);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.iucn.whp.dbservice.model.whp_sites_budget",
			whp_sites_budgetLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.iucn.whp.dbservice.model.whp_sites_budget");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = whp_sites_budgetPersistence.getDataSource();
	...
	private whp_sites_budgetLocalServiceClpInvoker _clpInvoker = new whp_sites_budgetLocalServiceClpInvoker();
}