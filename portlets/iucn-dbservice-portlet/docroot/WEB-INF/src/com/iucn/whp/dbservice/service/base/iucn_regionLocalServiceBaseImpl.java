...
/**
 * The base implementation of the iucn_region local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.iucn.whp.dbservice.service.impl.iucn_regionLocalServiceImpl}.
 * </p>
 *
 * @author alok.sen
 ...
 * @generated
 */
public abstract class iucn_regionLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements iucn_regionLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.iucn.whp.dbservice.service.iucn_regionLocalServiceUtil} to access the iucn_region local service.
	 */
	...
	public iucn_region addiucn_region(iucn_region iucn_region)
		throws SystemException {
		iucn_region.setNew(true);

		return iucn_regionPersistence.update(iucn_region, false);
	}
	 ...
	 */
	public iucn_region createiucn_region(int iucn_region_id) {
		return iucn_regionPersistence.create(iucn_region_id);
	}
	...
	public iucn_region deleteiucn_region(int iucn_region_id)
		throws PortalException, SystemException {
		return iucn_regionPersistence.remove(iucn_region_id);
	}
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public iucn_region deleteiucn_region(iucn_region iucn_region)
		throws SystemException {
		return iucn_regionPersistence.remove(iucn_region);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(iucn_region.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return iucn_regionPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return iucn_regionPersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return iucn_regionPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public iucn_region fetchiucn_region(int iucn_region_id)
		throws SystemException {
		return iucn_regionPersistence.fetchByPrimaryKey(iucn_region_id);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public iucn_region getiucn_region(int iucn_region_id)
		throws PortalException, SystemException {
		return iucn_regionPersistence.findByPrimaryKey(iucn_region_id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return iucn_regionPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<iucn_region> getiucn_regions(int start, int end)
		throws SystemException {
		return iucn_regionPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getiucn_regionsCount() throws SystemException {
		return iucn_regionPersistence.countAll();
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public iucn_region updateiucn_region(iucn_region iucn_region)
		throws SystemException {
		return updateiucn_region(iucn_region, true);
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public iucn_region updateiucn_region(iucn_region iucn_region, boolean merge)
		throws SystemException {
		iucn_region.setNew(false);

		return iucn_regionPersistence.update(iucn_region, merge);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.iucn.whp.dbservice.model.iucn_region",
			iucn_regionLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = iucn_regionPersistence.getDataSource();
	...
	private iucn_regionLocalServiceClpInvoker _clpInvoker = new iucn_regionLocalServiceClpInvoker();
}