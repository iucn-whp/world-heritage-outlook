...
/**
 * The base implementation of the state_trend_whvalues local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.iucn.whp.dbservice.service.impl.state_trend_whvaluesLocalServiceImpl}.
 * </p>
 *
 * @author alok.sen
 * @see com.iucn.whp.dbservice.service.impl.state_trend_whvaluesLocalServiceImpl
 * @see com.iucn.whp.dbservice.service.state_trend_whvaluesLocalServiceUtil
 * @generated
 */
public abstract class state_trend_whvaluesLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements state_trend_whvaluesLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.iucn.whp.dbservice.service.state_trend_whvaluesLocalServiceUtil} to access the state_trend_whvalues local service.
	 */
	...
	public state_trend_whvalues addstate_trend_whvalues(
		state_trend_whvalues state_trend_whvalues) throws SystemException {
		state_trend_whvalues.setNew(true);

		return state_trend_whvaluesPersistence.update(state_trend_whvalues,
			false);
	}
	 ...
	 */
	public state_trend_whvalues createstate_trend_whvalues(
		long state_trend_whval_id) {
		return state_trend_whvaluesPersistence.create(state_trend_whval_id);
	}
	...
	public state_trend_whvalues deletestate_trend_whvalues(
		long state_trend_whval_id) throws PortalException, SystemException {
		return state_trend_whvaluesPersistence.remove(state_trend_whval_id);
	}
	...
	public state_trend_whvalues deletestate_trend_whvalues(
		state_trend_whvalues state_trend_whvalues) throws SystemException {
		return state_trend_whvaluesPersistence.remove(state_trend_whvalues);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(state_trend_whvalues.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return state_trend_whvaluesPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return state_trend_whvaluesPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public state_trend_whvalues fetchstate_trend_whvalues(
		long state_trend_whval_id) throws SystemException {
		return state_trend_whvaluesPersistence.fetchByPrimaryKey(state_trend_whval_id);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public state_trend_whvalues getstate_trend_whvalues(
		long state_trend_whval_id) throws PortalException, SystemException {
		return state_trend_whvaluesPersistence.findByPrimaryKey(state_trend_whval_id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return state_trend_whvaluesPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<state_trend_whvalues> getstate_trend_whvalueses(int start,
		int end) throws SystemException {
		return state_trend_whvaluesPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getstate_trend_whvaluesesCount() throws SystemException {
		return state_trend_whvaluesPersistence.countAll();
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public state_trend_whvalues updatestate_trend_whvalues(
		state_trend_whvalues state_trend_whvalues) throws SystemException {
		return updatestate_trend_whvalues(state_trend_whvalues, true);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.iucn.whp.dbservice.model.state_trend_whvalues",
			state_trend_whvaluesLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.iucn.whp.dbservice.model.state_trend_whvalues");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = state_trend_whvaluesPersistence.getDataSource();
	...
	private state_trend_whvaluesLocalServiceClpInvoker _clpInvoker = new state_trend_whvaluesLocalServiceClpInvoker();
}