...
/**
 * The base implementation of the whp_sites_visitors local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.iucn.whp.dbservice.service.impl.whp_sites_visitorsLocalServiceImpl}.
 * </p>
 *
 * @author alok.sen
 * @see com.iucn.whp.dbservice.service.impl.whp_sites_visitorsLocalServiceImpl
 * @see com.iucn.whp.dbservice.service.whp_sites_visitorsLocalServiceUtil
 * @generated
 */
public abstract class whp_sites_visitorsLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements whp_sites_visitorsLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.iucn.whp.dbservice.service.whp_sites_visitorsLocalServiceUtil} to access the whp_sites_visitors local service.
	 */
	...
	public whp_sites_visitors addwhp_sites_visitors(
		whp_sites_visitors whp_sites_visitors) throws SystemException {
		whp_sites_visitors.setNew(true);

		return whp_sites_visitorsPersistence.update(whp_sites_visitors, false);
	}
	 ...
	 */
	public whp_sites_visitors createwhp_sites_visitors(
		long whp_sites_visitors_id) {
		return whp_sites_visitorsPersistence.create(whp_sites_visitors_id);
	}
	...
	public whp_sites_visitors deletewhp_sites_visitors(
		long whp_sites_visitors_id) throws PortalException, SystemException {
		return whp_sites_visitorsPersistence.remove(whp_sites_visitors_id);
	}
	...
	public whp_sites_visitors deletewhp_sites_visitors(
		whp_sites_visitors whp_sites_visitors) throws SystemException {
		return whp_sites_visitorsPersistence.remove(whp_sites_visitors);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(whp_sites_visitors.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return whp_sites_visitorsPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return whp_sites_visitorsPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public whp_sites_visitors fetchwhp_sites_visitors(
		long whp_sites_visitors_id) throws SystemException {
		return whp_sites_visitorsPersistence.fetchByPrimaryKey(whp_sites_visitors_id);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public whp_sites_visitors getwhp_sites_visitors(long whp_sites_visitors_id)
		throws PortalException, SystemException {
		return whp_sites_visitorsPersistence.findByPrimaryKey(whp_sites_visitors_id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return whp_sites_visitorsPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<whp_sites_visitors> getwhp_sites_visitorses(int start, int end)
		throws SystemException {
		return whp_sites_visitorsPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getwhp_sites_visitorsesCount() throws SystemException {
		return whp_sites_visitorsPersistence.countAll();
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public whp_sites_visitors updatewhp_sites_visitors(
		whp_sites_visitors whp_sites_visitors) throws SystemException {
		return updatewhp_sites_visitors(whp_sites_visitors, true);
	}
	...
	public whp_sites_visitors updatewhp_sites_visitors(
		...
		return whp_sites_visitorsPersistence.update(whp_sites_visitors, merge);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.iucn.whp.dbservice.model.whp_sites_visitors",
			whp_sites_visitorsLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.iucn.whp.dbservice.model.whp_sites_visitors");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = whp_sites_visitorsPersistence.getDataSource();
	...
	private whp_sites_visitorsLocalServiceClpInvoker _clpInvoker = new whp_sites_visitorsLocalServiceClpInvoker();
}