...
/**
 * The base implementation of the benefits_type_ref local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.iucn.whp.dbservice.service.impl.benefits_type_refLocalServiceImpl}.
 * </p>
 *
 * @author alok.sen
 ...
 * @generated
 */
public abstract class benefits_type_refLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements benefits_type_refLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.iucn.whp.dbservice.service.benefits_type_refLocalServiceUtil} to access the benefits_type_ref local service.
	 */
	...
	public benefits_type_ref addbenefits_type_ref(
		benefits_type_ref benefits_type_ref) throws SystemException {
		benefits_type_ref.setNew(true);

		return benefits_type_refPersistence.update(benefits_type_ref, false);
	}
	 ...
	 */
	public benefits_type_ref createbenefits_type_ref(long benefits_type_ref_id) {
		return benefits_type_refPersistence.create(benefits_type_ref_id);
	}
	...
	public benefits_type_ref deletebenefits_type_ref(long benefits_type_ref_id)
		throws PortalException, SystemException {
		return benefits_type_refPersistence.remove(benefits_type_ref_id);
	}
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public benefits_type_ref deletebenefits_type_ref(
		benefits_type_ref benefits_type_ref) throws SystemException {
		return benefits_type_refPersistence.remove(benefits_type_ref);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(benefits_type_ref.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return benefits_type_refPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return benefits_type_refPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public benefits_type_ref fetchbenefits_type_ref(long benefits_type_ref_id)
		throws SystemException {
		return benefits_type_refPersistence.fetchByPrimaryKey(benefits_type_ref_id);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public benefits_type_ref getbenefits_type_ref(long benefits_type_ref_id)
		throws PortalException, SystemException {
		return benefits_type_refPersistence.findByPrimaryKey(benefits_type_ref_id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return benefits_type_refPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<benefits_type_ref> getbenefits_type_refs(int start, int end)
		throws SystemException {
		return benefits_type_refPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getbenefits_type_refsCount() throws SystemException {
		return benefits_type_refPersistence.countAll();
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public benefits_type_ref updatebenefits_type_ref(
		benefits_type_ref benefits_type_ref) throws SystemException {
		return updatebenefits_type_ref(benefits_type_ref, true);
	}
	...
	public benefits_type_ref updatebenefits_type_ref(
		...
		return benefits_type_refPersistence.update(benefits_type_ref, merge);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.iucn.whp.dbservice.model.benefits_type_ref",
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = benefits_type_refPersistence.getDataSource();
	...
	private benefits_type_refLocalServiceClpInvoker _clpInvoker = new benefits_type_refLocalServiceClpInvoker();
}