...
/**
 * The base implementation of the negative_factors_level_impact local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.iucn.whp.dbservice.service.impl.negative_factors_level_impactLocalServiceImpl}.
 * </p>
 *
 * @author alok.sen
 * @see com.iucn.whp.dbservice.service.impl.negative_factors_level_impactLocalServiceImpl
 * @see com.iucn.whp.dbservice.service.negative_factors_level_impactLocalServiceUtil
 * @generated
 */
public abstract class negative_factors_level_impactLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements negative_factors_level_impactLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.iucn.whp.dbservice.service.negative_factors_level_impactLocalServiceUtil} to access the negative_factors_level_impact local service.
	 */
	...
	public negative_factors_level_impact addnegative_factors_level_impact(
		negative_factors_level_impact negative_factors_level_impact)
		throws SystemException {
		negative_factors_level_impact.setNew(true);

		return negative_factors_level_impactPersistence.update(negative_factors_level_impact,
			false);
	}
	 ...
	 */
	public negative_factors_level_impact createnegative_factors_level_impact(
		long level_id) {
		return negative_factors_level_impactPersistence.create(level_id);
	}
	...
	public negative_factors_level_impact deletenegative_factors_level_impact(
		long level_id) throws PortalException, SystemException {
		return negative_factors_level_impactPersistence.remove(level_id);
	}
	...
	public negative_factors_level_impact deletenegative_factors_level_impact(
		negative_factors_level_impact negative_factors_level_impact)
		throws SystemException {
		return negative_factors_level_impactPersistence.remove(negative_factors_level_impact);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(negative_factors_level_impact.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return negative_factors_level_impactPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return negative_factors_level_impactPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public negative_factors_level_impact fetchnegative_factors_level_impact(
		long level_id) throws SystemException {
		return negative_factors_level_impactPersistence.fetchByPrimaryKey(level_id);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public negative_factors_level_impact getnegative_factors_level_impact(
		long level_id) throws PortalException, SystemException {
		return negative_factors_level_impactPersistence.findByPrimaryKey(level_id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return negative_factors_level_impactPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<negative_factors_level_impact> getnegative_factors_level_impacts(
		int start, int end) throws SystemException {
		return negative_factors_level_impactPersistence.findAll(start, end);
	}
	...
	public int getnegative_factors_level_impactsCount()
		throws SystemException {
		return negative_factors_level_impactPersistence.countAll();
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public negative_factors_level_impact updatenegative_factors_level_impact(
		negative_factors_level_impact negative_factors_level_impact)
		throws SystemException {
		return updatenegative_factors_level_impact(negative_factors_level_impact,
			true);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.iucn.whp.dbservice.model.negative_factors_level_impact",
			negative_factors_level_impactLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = negative_factors_level_impactPersistence.getDataSource();
	...
	private negative_factors_level_impactLocalServiceClpInvoker _clpInvoker = new negative_factors_level_impactLocalServiceClpInvoker();
}