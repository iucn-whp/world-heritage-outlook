...
/**
 * The base implementation of the whp_sites_soouv local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.iucn.whp.dbservice.service.impl.whp_sites_soouvLocalServiceImpl}.
 * </p>
 *
 * @author alok.sen
 * @see com.iucn.whp.dbservice.service.impl.whp_sites_soouvLocalServiceImpl
 * @see com.iucn.whp.dbservice.service.whp_sites_soouvLocalServiceUtil
 * @generated
 */
public abstract class whp_sites_soouvLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements whp_sites_soouvLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.iucn.whp.dbservice.service.whp_sites_soouvLocalServiceUtil} to access the whp_sites_soouv local service.
	 */
	...
	public whp_sites_soouv addwhp_sites_soouv(whp_sites_soouv whp_sites_soouv)
		throws SystemException {
		whp_sites_soouv.setNew(true);

		return whp_sites_soouvPersistence.update(whp_sites_soouv, false);
	}
	 ...
	 */
	public whp_sites_soouv createwhp_sites_soouv(long whp_sites_soouv_id) {
		return whp_sites_soouvPersistence.create(whp_sites_soouv_id);
	}
	...
	public whp_sites_soouv deletewhp_sites_soouv(long whp_sites_soouv_id)
		throws PortalException, SystemException {
		return whp_sites_soouvPersistence.remove(whp_sites_soouv_id);
	}
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public whp_sites_soouv deletewhp_sites_soouv(
		whp_sites_soouv whp_sites_soouv) throws SystemException {
		return whp_sites_soouvPersistence.remove(whp_sites_soouv);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(whp_sites_soouv.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return whp_sites_soouvPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return whp_sites_soouvPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public whp_sites_soouv fetchwhp_sites_soouv(long whp_sites_soouv_id)
		throws SystemException {
		return whp_sites_soouvPersistence.fetchByPrimaryKey(whp_sites_soouv_id);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public whp_sites_soouv getwhp_sites_soouv(long whp_sites_soouv_id)
		throws PortalException, SystemException {
		return whp_sites_soouvPersistence.findByPrimaryKey(whp_sites_soouv_id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return whp_sites_soouvPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<whp_sites_soouv> getwhp_sites_soouvs(int start, int end)
		throws SystemException {
		return whp_sites_soouvPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getwhp_sites_soouvsCount() throws SystemException {
		return whp_sites_soouvPersistence.countAll();
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public whp_sites_soouv updatewhp_sites_soouv(
		whp_sites_soouv whp_sites_soouv) throws SystemException {
		return updatewhp_sites_soouv(whp_sites_soouv, true);
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	public whp_sites_soouv updatewhp_sites_soouv(
		whp_sites_soouv whp_sites_soouv, boolean merge)
		throws SystemException {
		whp_sites_soouv.setNew(false);

		return whp_sites_soouvPersistence.update(whp_sites_soouv, merge);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.iucn.whp.dbservice.model.whp_sites_soouv",
			whp_sites_soouvLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.iucn.whp.dbservice.model.whp_sites_soouv");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = whp_sites_soouvPersistence.getDataSource();
	...
	private whp_sites_soouvLocalServiceClpInvoker _clpInvoker = new whp_sites_soouvLocalServiceClpInvoker();
}