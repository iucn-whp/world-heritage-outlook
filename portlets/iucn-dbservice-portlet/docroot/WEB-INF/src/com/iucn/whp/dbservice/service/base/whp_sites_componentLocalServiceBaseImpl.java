...
/**
 * The base implementation of the whp_sites_component local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.iucn.whp.dbservice.service.impl.whp_sites_componentLocalServiceImpl}.
 * </p>
 *
 * @author alok.sen
 ...
 * @generated
 */
public abstract class whp_sites_componentLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements whp_sites_componentLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.iucn.whp.dbservice.service.whp_sites_componentLocalServiceUtil} to access the whp_sites_component local service.
	 */
	...
	public whp_sites_component addwhp_sites_component(
		whp_sites_component whp_sites_component) throws SystemException {
		whp_sites_component.setNew(true);

		return whp_sites_componentPersistence.update(whp_sites_component, false);
	}
	 ...
	 */
	public whp_sites_component createwhp_sites_component(
		long whp_sites_component_id) {
		return whp_sites_componentPersistence.create(whp_sites_component_id);
	}
	...
	public whp_sites_component deletewhp_sites_component(
		long whp_sites_component_id) throws PortalException, SystemException {
		return whp_sites_componentPersistence.remove(whp_sites_component_id);
	}
	...
	public whp_sites_component deletewhp_sites_component(
		whp_sites_component whp_sites_component) throws SystemException {
		return whp_sites_componentPersistence.remove(whp_sites_component);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(whp_sites_component.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return whp_sites_componentPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return whp_sites_componentPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public whp_sites_component fetchwhp_sites_component(
		long whp_sites_component_id) throws SystemException {
		return whp_sites_componentPersistence.fetchByPrimaryKey(whp_sites_component_id);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public whp_sites_component getwhp_sites_component(
		long whp_sites_component_id) throws PortalException, SystemException {
		return whp_sites_componentPersistence.findByPrimaryKey(whp_sites_component_id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return whp_sites_componentPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<whp_sites_component> getwhp_sites_components(int start, int end)
		throws SystemException {
		return whp_sites_componentPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getwhp_sites_componentsCount() throws SystemException {
		return whp_sites_componentPersistence.countAll();
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public whp_sites_component updatewhp_sites_component(
		whp_sites_component whp_sites_component) throws SystemException {
		return updatewhp_sites_component(whp_sites_component, true);
	}
	...
	public whp_sites_component updatewhp_sites_component(
		...
		return whp_sites_componentPersistence.update(whp_sites_component, merge);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.iucn.whp.dbservice.model.whp_sites_component",
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = whp_sites_componentPersistence.getDataSource();
	...
	private whp_sites_componentLocalServiceClpInvoker _clpInvoker = new whp_sites_componentLocalServiceClpInvoker();
}