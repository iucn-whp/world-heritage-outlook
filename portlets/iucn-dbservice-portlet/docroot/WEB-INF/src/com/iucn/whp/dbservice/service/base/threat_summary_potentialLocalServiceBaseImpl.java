...
/**
 * The base implementation of the threat_summary_potential local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.iucn.whp.dbservice.service.impl.threat_summary_potentialLocalServiceImpl}.
 * </p>
 *
 * @author alok.sen
 ...
 * @generated
 */
public abstract class threat_summary_potentialLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements threat_summary_potentialLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.iucn.whp.dbservice.service.threat_summary_potentialLocalServiceUtil} to access the threat_summary_potential local service.
	 */
	...
	public threat_summary_potential addthreat_summary_potential(
		threat_summary_potential threat_summary_potential)
		throws SystemException {
		threat_summary_potential.setNew(true);

		return threat_summary_potentialPersistence.update(threat_summary_potential,
			false);
	}
	 ...
	 */
	public threat_summary_potential createthreat_summary_potential(
		long threat_sum_potential_id) {
		return threat_summary_potentialPersistence.create(threat_sum_potential_id);
	}
	...
	public threat_summary_potential deletethreat_summary_potential(
		long threat_sum_potential_id) throws PortalException, SystemException {
		return threat_summary_potentialPersistence.remove(threat_sum_potential_id);
	}
	...
	public threat_summary_potential deletethreat_summary_potential(
		threat_summary_potential threat_summary_potential)
		throws SystemException {
		return threat_summary_potentialPersistence.remove(threat_summary_potential);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(threat_summary_potential.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return threat_summary_potentialPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return threat_summary_potentialPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public threat_summary_potential fetchthreat_summary_potential(
		long threat_sum_potential_id) throws SystemException {
		return threat_summary_potentialPersistence.fetchByPrimaryKey(threat_sum_potential_id);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public threat_summary_potential getthreat_summary_potential(
		long threat_sum_potential_id) throws PortalException, SystemException {
		return threat_summary_potentialPersistence.findByPrimaryKey(threat_sum_potential_id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return threat_summary_potentialPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<threat_summary_potential> getthreat_summary_potentials(
		int start, int end) throws SystemException {
		return threat_summary_potentialPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getthreat_summary_potentialsCount() throws SystemException {
		return threat_summary_potentialPersistence.countAll();
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public threat_summary_potential updatethreat_summary_potential(
		threat_summary_potential threat_summary_potential)
		throws SystemException {
		return updatethreat_summary_potential(threat_summary_potential, true);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.iucn.whp.dbservice.model.threat_summary_potential",
			threat_summary_potentialLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.iucn.whp.dbservice.model.threat_summary_potential");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = threat_summary_potentialPersistence.getDataSource();
	...
	private threat_summary_potentialLocalServiceClpInvoker _clpInvoker = new threat_summary_potentialLocalServiceClpInvoker();
}