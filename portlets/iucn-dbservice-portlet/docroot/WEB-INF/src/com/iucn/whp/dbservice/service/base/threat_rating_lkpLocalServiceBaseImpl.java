...
/**
 * The base implementation of the threat_rating_lkp local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.iucn.whp.dbservice.service.impl.threat_rating_lkpLocalServiceImpl}.
 * </p>
 *
 * @author alok.sen
 * @see com.iucn.whp.dbservice.service.impl.threat_rating_lkpLocalServiceImpl
 * @see com.iucn.whp.dbservice.service.threat_rating_lkpLocalServiceUtil
 * @generated
 */
public abstract class threat_rating_lkpLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements threat_rating_lkpLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.iucn.whp.dbservice.service.threat_rating_lkpLocalServiceUtil} to access the threat_rating_lkp local service.
	 */
	...
	public threat_rating_lkp addthreat_rating_lkp(
		threat_rating_lkp threat_rating_lkp) throws SystemException {
		threat_rating_lkp.setNew(true);

		return threat_rating_lkpPersistence.update(threat_rating_lkp, false);
	}
	 ...
	 */
	public threat_rating_lkp createthreat_rating_lkp(long id) {
		return threat_rating_lkpPersistence.create(id);
	}
	...
	public threat_rating_lkp deletethreat_rating_lkp(long id)
		throws PortalException, SystemException {
		return threat_rating_lkpPersistence.remove(id);
	}
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public threat_rating_lkp deletethreat_rating_lkp(
		threat_rating_lkp threat_rating_lkp) throws SystemException {
		return threat_rating_lkpPersistence.remove(threat_rating_lkp);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(threat_rating_lkp.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return threat_rating_lkpPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return threat_rating_lkpPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public threat_rating_lkp fetchthreat_rating_lkp(long id)
		throws SystemException {
		return threat_rating_lkpPersistence.fetchByPrimaryKey(id);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public threat_rating_lkp getthreat_rating_lkp(long id)
		throws PortalException, SystemException {
		return threat_rating_lkpPersistence.findByPrimaryKey(id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return threat_rating_lkpPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<threat_rating_lkp> getthreat_rating_lkps(int start, int end)
		throws SystemException {
		return threat_rating_lkpPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getthreat_rating_lkpsCount() throws SystemException {
		return threat_rating_lkpPersistence.countAll();
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public threat_rating_lkp updatethreat_rating_lkp(
		threat_rating_lkp threat_rating_lkp) throws SystemException {
		return updatethreat_rating_lkp(threat_rating_lkp, true);
	}
	...
	public threat_rating_lkp updatethreat_rating_lkp(
		...
		return threat_rating_lkpPersistence.update(threat_rating_lkp, merge);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.iucn.whp.dbservice.model.threat_rating_lkp",
			threat_rating_lkpLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.iucn.whp.dbservice.model.threat_rating_lkp");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = threat_rating_lkpPersistence.getDataSource();
	...
	private threat_rating_lkpLocalServiceClpInvoker _clpInvoker = new threat_rating_lkpLocalServiceClpInvoker();
}