...
/**
 * The base implementation of the whp_sites_soc_reports local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.iucn.whp.dbservice.service.impl.whp_sites_soc_reportsLocalServiceImpl}.
 * </p>
 *
 * @author alok.sen
 ...
 * @generated
 */
public abstract class whp_sites_soc_reportsLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements whp_sites_soc_reportsLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.iucn.whp.dbservice.service.whp_sites_soc_reportsLocalServiceUtil} to access the whp_sites_soc_reports local service.
	 */
	...
	public whp_sites_soc_reports addwhp_sites_soc_reports(
		whp_sites_soc_reports whp_sites_soc_reports) throws SystemException {
		whp_sites_soc_reports.setNew(true);

		return whp_sites_soc_reportsPersistence.update(whp_sites_soc_reports,
			false);
	}
	 ...
	 */
	public whp_sites_soc_reports createwhp_sites_soc_reports(
		long whp_sites_soc_reports_id) {
		return whp_sites_soc_reportsPersistence.create(whp_sites_soc_reports_id);
	}
	...
	public whp_sites_soc_reports deletewhp_sites_soc_reports(
		long whp_sites_soc_reports_id) throws PortalException, SystemException {
		return whp_sites_soc_reportsPersistence.remove(whp_sites_soc_reports_id);
	}
	...
	public whp_sites_soc_reports deletewhp_sites_soc_reports(
		whp_sites_soc_reports whp_sites_soc_reports) throws SystemException {
		return whp_sites_soc_reportsPersistence.remove(whp_sites_soc_reports);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(whp_sites_soc_reports.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return whp_sites_soc_reportsPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return whp_sites_soc_reportsPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public whp_sites_soc_reports fetchwhp_sites_soc_reports(
		long whp_sites_soc_reports_id) throws SystemException {
		return whp_sites_soc_reportsPersistence.fetchByPrimaryKey(whp_sites_soc_reports_id);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public whp_sites_soc_reports getwhp_sites_soc_reports(
		long whp_sites_soc_reports_id) throws PortalException, SystemException {
		return whp_sites_soc_reportsPersistence.findByPrimaryKey(whp_sites_soc_reports_id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return whp_sites_soc_reportsPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<whp_sites_soc_reports> getwhp_sites_soc_reportses(int start,
		int end) throws SystemException {
		return whp_sites_soc_reportsPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getwhp_sites_soc_reportsesCount() throws SystemException {
		return whp_sites_soc_reportsPersistence.countAll();
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public whp_sites_soc_reports updatewhp_sites_soc_reports(
		whp_sites_soc_reports whp_sites_soc_reports) throws SystemException {
		return updatewhp_sites_soc_reports(whp_sites_soc_reports, true);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.iucn.whp.dbservice.model.whp_sites_soc_reports",
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = whp_sites_soc_reportsPersistence.getDataSource();
	...
	private whp_sites_soc_reportsLocalServiceClpInvoker _clpInvoker = new whp_sites_soc_reportsLocalServiceClpInvoker();
}