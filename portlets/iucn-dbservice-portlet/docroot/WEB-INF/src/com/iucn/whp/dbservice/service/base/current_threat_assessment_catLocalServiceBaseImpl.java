...
/**
 * The base implementation of the current_threat_assessment_cat local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.iucn.whp.dbservice.service.impl.current_threat_assessment_catLocalServiceImpl}.
 * </p>
 *
 * @author alok.sen
 ...
 * @generated
 */
public abstract class current_threat_assessment_catLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements current_threat_assessment_catLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.iucn.whp.dbservice.service.current_threat_assessment_catLocalServiceUtil} to access the current_threat_assessment_cat local service.
	 */
	...
	public current_threat_assessment_cat addcurrent_threat_assessment_cat(
		current_threat_assessment_cat current_threat_assessment_cat)
		throws SystemException {
		current_threat_assessment_cat.setNew(true);

		return current_threat_assessment_catPersistence.update(current_threat_assessment_cat,
			false);
	}
	 ...
	 */
	public current_threat_assessment_cat createcurrent_threat_assessment_cat(
		long cur_threat_cat_id) {
		return current_threat_assessment_catPersistence.create(cur_threat_cat_id);
	}
	...
	public current_threat_assessment_cat deletecurrent_threat_assessment_cat(
		long cur_threat_cat_id) throws PortalException, SystemException {
		return current_threat_assessment_catPersistence.remove(cur_threat_cat_id);
	}
	...
	public current_threat_assessment_cat deletecurrent_threat_assessment_cat(
		current_threat_assessment_cat current_threat_assessment_cat)
		throws SystemException {
		return current_threat_assessment_catPersistence.remove(current_threat_assessment_cat);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(current_threat_assessment_cat.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return current_threat_assessment_catPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return current_threat_assessment_catPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public current_threat_assessment_cat fetchcurrent_threat_assessment_cat(
		long cur_threat_cat_id) throws SystemException {
		return current_threat_assessment_catPersistence.fetchByPrimaryKey(cur_threat_cat_id);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public current_threat_assessment_cat getcurrent_threat_assessment_cat(
		long cur_threat_cat_id) throws PortalException, SystemException {
		return current_threat_assessment_catPersistence.findByPrimaryKey(cur_threat_cat_id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return current_threat_assessment_catPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<current_threat_assessment_cat> getcurrent_threat_assessment_cats(
		int start, int end) throws SystemException {
		return current_threat_assessment_catPersistence.findAll(start, end);
	}
	...
	public int getcurrent_threat_assessment_catsCount()
		throws SystemException {
		return current_threat_assessment_catPersistence.countAll();
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public current_threat_assessment_cat updatecurrent_threat_assessment_cat(
		current_threat_assessment_cat current_threat_assessment_cat)
		throws SystemException {
		return updatecurrent_threat_assessment_cat(current_threat_assessment_cat,
			true);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.iucn.whp.dbservice.model.current_threat_assessment_cat",
			current_threat_assessment_catLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.iucn.whp.dbservice.model.current_threat_assessment_cat");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = current_threat_assessment_catPersistence.getDataSource();
	...
	private current_threat_assessment_catLocalServiceClpInvoker _clpInvoker = new current_threat_assessment_catLocalServiceClpInvoker();
}