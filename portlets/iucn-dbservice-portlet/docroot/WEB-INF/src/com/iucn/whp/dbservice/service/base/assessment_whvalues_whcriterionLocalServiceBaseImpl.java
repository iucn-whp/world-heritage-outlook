...
/**
 * The base implementation of the assessment_whvalues_whcriterion local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.iucn.whp.dbservice.service.impl.assessment_whvalues_whcriterionLocalServiceImpl}.
 * </p>
 *
 * @author alok.sen
 ...
 * @generated
 */
public abstract class assessment_whvalues_whcriterionLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements assessment_whvalues_whcriterionLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.iucn.whp.dbservice.service.assessment_whvalues_whcriterionLocalServiceUtil} to access the assessment_whvalues_whcriterion local service.
	 */
	...
	public assessment_whvalues_whcriterion addassessment_whvalues_whcriterion(
		assessment_whvalues_whcriterion assessment_whvalues_whcriterion)
		throws SystemException {
		assessment_whvalues_whcriterion.setNew(true);

		return assessment_whvalues_whcriterionPersistence.update(assessment_whvalues_whcriterion,
			false);
	}
	 ...
	 */
	public assessment_whvalues_whcriterion createassessment_whvalues_whcriterion(
		long wh_criteria_id) {
		return assessment_whvalues_whcriterionPersistence.create(wh_criteria_id);
	}
	...
	public assessment_whvalues_whcriterion deleteassessment_whvalues_whcriterion(
		long wh_criteria_id) throws PortalException, SystemException {
		return assessment_whvalues_whcriterionPersistence.remove(wh_criteria_id);
	}
	...
	public assessment_whvalues_whcriterion deleteassessment_whvalues_whcriterion(
		assessment_whvalues_whcriterion assessment_whvalues_whcriterion)
		throws SystemException {
		return assessment_whvalues_whcriterionPersistence.remove(assessment_whvalues_whcriterion);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(assessment_whvalues_whcriterion.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return assessment_whvalues_whcriterionPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return assessment_whvalues_whcriterionPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public assessment_whvalues_whcriterion fetchassessment_whvalues_whcriterion(
		long wh_criteria_id) throws SystemException {
		return assessment_whvalues_whcriterionPersistence.fetchByPrimaryKey(wh_criteria_id);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public assessment_whvalues_whcriterion getassessment_whvalues_whcriterion(
		long wh_criteria_id) throws PortalException, SystemException {
		return assessment_whvalues_whcriterionPersistence.findByPrimaryKey(wh_criteria_id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return assessment_whvalues_whcriterionPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<assessment_whvalues_whcriterion> getassessment_whvalues_whcriterions(
		int start, int end) throws SystemException {
		return assessment_whvalues_whcriterionPersistence.findAll(start, end);
	}
	...
	public int getassessment_whvalues_whcriterionsCount()
		throws SystemException {
		return assessment_whvalues_whcriterionPersistence.countAll();
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public assessment_whvalues_whcriterion updateassessment_whvalues_whcriterion(
		assessment_whvalues_whcriterion assessment_whvalues_whcriterion)
		throws SystemException {
		return updateassessment_whvalues_whcriterion(assessment_whvalues_whcriterion,
			true);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.iucn.whp.dbservice.model.assessment_whvalues_whcriterion",
			assessment_whvalues_whcriterionLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = assessment_whvalues_whcriterionPersistence.getDataSource();
	...
	private assessment_whvalues_whcriterionLocalServiceClpInvoker _clpInvoker = new assessment_whvalues_whcriterionLocalServiceClpInvoker();
}