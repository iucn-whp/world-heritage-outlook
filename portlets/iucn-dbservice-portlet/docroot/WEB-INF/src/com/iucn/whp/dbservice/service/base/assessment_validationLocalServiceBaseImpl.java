...
/**
 * The base implementation of the assessment_validation local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.iucn.whp.dbservice.service.impl.assessment_validationLocalServiceImpl}.
 * </p>
 *
 * @author alok.sen
 * @see com.iucn.whp.dbservice.service.impl.assessment_validationLocalServiceImpl
 * @see com.iucn.whp.dbservice.service.assessment_validationLocalServiceUtil
 * @generated
 */
public abstract class assessment_validationLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements assessment_validationLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.iucn.whp.dbservice.service.assessment_validationLocalServiceUtil} to access the assessment_validation local service.
	 */
	...
	public assessment_validation addassessment_validation(
		assessment_validation assessment_validation) throws SystemException {
		assessment_validation.setNew(true);

		return assessment_validationPersistence.update(assessment_validation,
			false);
	}
	 ...
	 */
	public assessment_validation createassessment_validation(
		long assessment_ver_val_id) {
		return assessment_validationPersistence.create(assessment_ver_val_id);
	}
	...
	public assessment_validation deleteassessment_validation(
		long assessment_ver_val_id) throws PortalException, SystemException {
		return assessment_validationPersistence.remove(assessment_ver_val_id);
	}
	...
	public assessment_validation deleteassessment_validation(
		assessment_validation assessment_validation) throws SystemException {
		return assessment_validationPersistence.remove(assessment_validation);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(assessment_validation.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return assessment_validationPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return assessment_validationPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public assessment_validation fetchassessment_validation(
		long assessment_ver_val_id) throws SystemException {
		return assessment_validationPersistence.fetchByPrimaryKey(assessment_ver_val_id);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public assessment_validation getassessment_validation(
		long assessment_ver_val_id) throws PortalException, SystemException {
		return assessment_validationPersistence.findByPrimaryKey(assessment_ver_val_id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return assessment_validationPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<assessment_validation> getassessment_validations(int start,
		int end) throws SystemException {
		return assessment_validationPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getassessment_validationsCount() throws SystemException {
		return assessment_validationPersistence.countAll();
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public assessment_validation updateassessment_validation(
		assessment_validation assessment_validation) throws SystemException {
		return updateassessment_validation(assessment_validation, true);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.iucn.whp.dbservice.model.assessment_validation",
			assessment_validationLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.iucn.whp.dbservice.model.assessment_validation");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = assessment_validationPersistence.getDataSource();
	...
	private assessment_validationLocalServiceClpInvoker _clpInvoker = new assessment_validationLocalServiceClpInvoker();
}