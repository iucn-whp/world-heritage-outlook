...
/**
 * The base implementation of the reinforced_monitoring local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.iucn.whp.dbservice.service.impl.reinforced_monitoringLocalServiceImpl}.
 * </p>
 *
 * @author alok.sen
 * @see com.iucn.whp.dbservice.service.impl.reinforced_monitoringLocalServiceImpl
 * @see com.iucn.whp.dbservice.service.reinforced_monitoringLocalServiceUtil
 * @generated
 */
public abstract class reinforced_monitoringLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements reinforced_monitoringLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.iucn.whp.dbservice.service.reinforced_monitoringLocalServiceUtil} to access the reinforced_monitoring local service.
	 */
	...
	public reinforced_monitoring addreinforced_monitoring(
		reinforced_monitoring reinforced_monitoring) throws SystemException {
		reinforced_monitoring.setNew(true);

		return reinforced_monitoringPersistence.update(reinforced_monitoring,
			false);
	}
	 ...
	 */
	public reinforced_monitoring createreinforced_monitoring(
		long whp_sites_reinforced_monitoring_id) {
		return reinforced_monitoringPersistence.create(whp_sites_reinforced_monitoring_id);
	}
	...
	public reinforced_monitoring deletereinforced_monitoring(
		long whp_sites_reinforced_monitoring_id)
		throws PortalException, SystemException {
		return reinforced_monitoringPersistence.remove(whp_sites_reinforced_monitoring_id);
	}
	...
	public reinforced_monitoring deletereinforced_monitoring(
		reinforced_monitoring reinforced_monitoring) throws SystemException {
		return reinforced_monitoringPersistence.remove(reinforced_monitoring);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(reinforced_monitoring.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return reinforced_monitoringPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return reinforced_monitoringPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public reinforced_monitoring fetchreinforced_monitoring(
		long whp_sites_reinforced_monitoring_id) throws SystemException {
		return reinforced_monitoringPersistence.fetchByPrimaryKey(whp_sites_reinforced_monitoring_id);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public reinforced_monitoring getreinforced_monitoring(
		long whp_sites_reinforced_monitoring_id)
		throws PortalException, SystemException {
		return reinforced_monitoringPersistence.findByPrimaryKey(whp_sites_reinforced_monitoring_id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return reinforced_monitoringPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<reinforced_monitoring> getreinforced_monitorings(int start,
		int end) throws SystemException {
		return reinforced_monitoringPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getreinforced_monitoringsCount() throws SystemException {
		return reinforced_monitoringPersistence.countAll();
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public reinforced_monitoring updatereinforced_monitoring(
		reinforced_monitoring reinforced_monitoring) throws SystemException {
		return updatereinforced_monitoring(reinforced_monitoring, true);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.iucn.whp.dbservice.model.reinforced_monitoring",
			reinforced_monitoringLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.iucn.whp.dbservice.model.reinforced_monitoring");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = reinforced_monitoringPersistence.getDataSource();
	...
	private reinforced_monitoringLocalServiceClpInvoker _clpInvoker = new reinforced_monitoringLocalServiceClpInvoker();
}