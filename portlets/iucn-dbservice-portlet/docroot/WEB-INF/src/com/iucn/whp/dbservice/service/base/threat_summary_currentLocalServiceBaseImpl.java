...
/**
 * The base implementation of the threat_summary_current local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.iucn.whp.dbservice.service.impl.threat_summary_currentLocalServiceImpl}.
 * </p>
 *
 * @author alok.sen
 ...
 * @generated
 */
public abstract class threat_summary_currentLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements threat_summary_currentLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.iucn.whp.dbservice.service.threat_summary_currentLocalServiceUtil} to access the threat_summary_current local service.
	 */
	...
	public threat_summary_current addthreat_summary_current(
		threat_summary_current threat_summary_current)
		throws SystemException {
		threat_summary_current.setNew(true);

		return threat_summary_currentPersistence.update(threat_summary_current,
			false);
	}
	 ...
	 */
	public threat_summary_current createthreat_summary_current(
		long threat_sum_cur_id) {
		return threat_summary_currentPersistence.create(threat_sum_cur_id);
	}
	...
	public threat_summary_current deletethreat_summary_current(
		long threat_sum_cur_id) throws PortalException, SystemException {
		return threat_summary_currentPersistence.remove(threat_sum_cur_id);
	}
	...
	public threat_summary_current deletethreat_summary_current(
		threat_summary_current threat_summary_current)
		throws SystemException {
		return threat_summary_currentPersistence.remove(threat_summary_current);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(threat_summary_current.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return threat_summary_currentPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return threat_summary_currentPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public threat_summary_current fetchthreat_summary_current(
		long threat_sum_cur_id) throws SystemException {
		return threat_summary_currentPersistence.fetchByPrimaryKey(threat_sum_cur_id);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public threat_summary_current getthreat_summary_current(
		long threat_sum_cur_id) throws PortalException, SystemException {
		return threat_summary_currentPersistence.findByPrimaryKey(threat_sum_cur_id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return threat_summary_currentPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<threat_summary_current> getthreat_summary_currents(int start,
		int end) throws SystemException {
		return threat_summary_currentPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getthreat_summary_currentsCount() throws SystemException {
		return threat_summary_currentPersistence.countAll();
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public threat_summary_current updatethreat_summary_current(
		threat_summary_current threat_summary_current)
		throws SystemException {
		return updatethreat_summary_current(threat_summary_current, true);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.iucn.whp.dbservice.model.threat_summary_current",
			threat_summary_currentLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.iucn.whp.dbservice.model.threat_summary_current");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = threat_summary_currentPersistence.getDataSource();
	...
	private threat_summary_currentLocalServiceClpInvoker _clpInvoker = new threat_summary_currentLocalServiceClpInvoker();
}