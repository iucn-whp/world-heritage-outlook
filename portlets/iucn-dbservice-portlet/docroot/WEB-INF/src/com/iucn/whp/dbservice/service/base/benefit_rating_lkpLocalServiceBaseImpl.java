...
/**
 * The base implementation of the benefit_rating_lkp local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.iucn.whp.dbservice.service.impl.benefit_rating_lkpLocalServiceImpl}.
 * </p>
 *
 * @author alok.sen
 * @see com.iucn.whp.dbservice.service.impl.benefit_rating_lkpLocalServiceImpl
 * @see com.iucn.whp.dbservice.service.benefit_rating_lkpLocalServiceUtil
 * @generated
 */
public abstract class benefit_rating_lkpLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements benefit_rating_lkpLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.iucn.whp.dbservice.service.benefit_rating_lkpLocalServiceUtil} to access the benefit_rating_lkp local service.
	 */
	...
	public benefit_rating_lkp addbenefit_rating_lkp(
		benefit_rating_lkp benefit_rating_lkp) throws SystemException {
		benefit_rating_lkp.setNew(true);

		return benefit_rating_lkpPersistence.update(benefit_rating_lkp, false);
	}
	 ...
	 */
	public benefit_rating_lkp createbenefit_rating_lkp(long id) {
		return benefit_rating_lkpPersistence.create(id);
	}
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public benefit_rating_lkp deletebenefit_rating_lkp(
		benefit_rating_lkp benefit_rating_lkp) throws SystemException {
		return benefit_rating_lkpPersistence.remove(benefit_rating_lkp);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(benefit_rating_lkp.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return benefit_rating_lkpPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return benefit_rating_lkpPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public benefit_rating_lkp fetchbenefit_rating_lkp(long id)
		throws SystemException {
		return benefit_rating_lkpPersistence.fetchByPrimaryKey(id);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public benefit_rating_lkp getbenefit_rating_lkp(long id)
		throws PortalException, SystemException {
		return benefit_rating_lkpPersistence.findByPrimaryKey(id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return benefit_rating_lkpPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<benefit_rating_lkp> getbenefit_rating_lkps(int start, int end)
		throws SystemException {
		return benefit_rating_lkpPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getbenefit_rating_lkpsCount() throws SystemException {
		return benefit_rating_lkpPersistence.countAll();
	}
	...
	public benefit_rating_lkp updatebenefit_rating_lkp(
		...
		return benefit_rating_lkpPersistence.update(benefit_rating_lkp, merge);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.iucn.whp.dbservice.model.benefit_rating_lkp",
			benefit_rating_lkpLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.iucn.whp.dbservice.model.benefit_rating_lkp");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = benefit_rating_lkpPersistence.getDataSource();
	...
	private benefit_rating_lkpLocalServiceClpInvoker _clpInvoker = new benefit_rating_lkpLocalServiceClpInvoker();
}