...
/**
 * The base implementation of the unesco_region local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.iucn.whp.dbservice.service.impl.unesco_regionLocalServiceImpl}.
 * </p>
 *
 * @author alok.sen
 ...
 * @generated
 */
public abstract class unesco_regionLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements unesco_regionLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.iucn.whp.dbservice.service.unesco_regionLocalServiceUtil} to access the unesco_region local service.
	 */
	...
	public unesco_region addunesco_region(unesco_region unesco_region)
		throws SystemException {
		unesco_region.setNew(true);

		return unesco_regionPersistence.update(unesco_region, false);
	}
	 ...
	 */
	public unesco_region createunesco_region(int unesco_region_id) {
		return unesco_regionPersistence.create(unesco_region_id);
	}
	...
	public unesco_region deleteunesco_region(int unesco_region_id)
		throws PortalException, SystemException {
		return unesco_regionPersistence.remove(unesco_region_id);
	}
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public unesco_region deleteunesco_region(unesco_region unesco_region)
		throws SystemException {
		return unesco_regionPersistence.remove(unesco_region);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(unesco_region.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return unesco_regionPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return unesco_regionPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public unesco_region fetchunesco_region(int unesco_region_id)
		throws SystemException {
		return unesco_regionPersistence.fetchByPrimaryKey(unesco_region_id);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public unesco_region getunesco_region(int unesco_region_id)
		throws PortalException, SystemException {
		return unesco_regionPersistence.findByPrimaryKey(unesco_region_id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return unesco_regionPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<unesco_region> getunesco_regions(int start, int end)
		throws SystemException {
		return unesco_regionPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getunesco_regionsCount() throws SystemException {
		return unesco_regionPersistence.countAll();
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public unesco_region updateunesco_region(unesco_region unesco_region)
		throws SystemException {
		return updateunesco_region(unesco_region, true);
	}
	...
	public unesco_region updateunesco_region(unesco_region unesco_region,
		...
		return unesco_regionPersistence.update(unesco_region, merge);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.iucn.whp.dbservice.model.unesco_region",
			unesco_regionLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.iucn.whp.dbservice.model.unesco_region");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = unesco_regionPersistence.getDataSource();
	...
	private unesco_regionLocalServiceClpInvoker _clpInvoker = new unesco_regionLocalServiceClpInvoker();
}