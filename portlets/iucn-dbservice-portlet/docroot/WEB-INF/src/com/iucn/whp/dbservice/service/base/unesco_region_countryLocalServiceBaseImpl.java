...
/**
 * The base implementation of the unesco_region_country local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.iucn.whp.dbservice.service.impl.unesco_region_countryLocalServiceImpl}.
 * </p>
 *
 * @author alok.sen
 * @see com.iucn.whp.dbservice.service.impl.unesco_region_countryLocalServiceImpl
 * @see com.iucn.whp.dbservice.service.unesco_region_countryLocalServiceUtil
 * @generated
 */
public abstract class unesco_region_countryLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements unesco_region_countryLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.iucn.whp.dbservice.service.unesco_region_countryLocalServiceUtil} to access the unesco_region_country local service.
	 */
	...
	public unesco_region_country addunesco_region_country(
		unesco_region_country unesco_region_country) throws SystemException {
		unesco_region_country.setNew(true);

		return unesco_region_countryPersistence.update(unesco_region_country,
			false);
	}
	 ...
	 */
	public unesco_region_country createunesco_region_country(
		int whp_unesco_region_country_id) {
		return unesco_region_countryPersistence.create(whp_unesco_region_country_id);
	}
	...
	public unesco_region_country deleteunesco_region_country(
		int whp_unesco_region_country_id)
		throws PortalException, SystemException {
		return unesco_region_countryPersistence.remove(whp_unesco_region_country_id);
	}
	...
	public unesco_region_country deleteunesco_region_country(
		unesco_region_country unesco_region_country) throws SystemException {
		return unesco_region_countryPersistence.remove(unesco_region_country);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(unesco_region_country.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return unesco_region_countryPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return unesco_region_countryPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public unesco_region_country fetchunesco_region_country(
		int whp_unesco_region_country_id) throws SystemException {
		return unesco_region_countryPersistence.fetchByPrimaryKey(whp_unesco_region_country_id);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public unesco_region_country getunesco_region_country(
		int whp_unesco_region_country_id)
		throws PortalException, SystemException {
		return unesco_region_countryPersistence.findByPrimaryKey(whp_unesco_region_country_id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return unesco_region_countryPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<unesco_region_country> getunesco_region_countries(int start,
		int end) throws SystemException {
		return unesco_region_countryPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getunesco_region_countriesCount() throws SystemException {
		return unesco_region_countryPersistence.countAll();
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public unesco_region_country updateunesco_region_country(
		unesco_region_country unesco_region_country) throws SystemException {
		return updateunesco_region_country(unesco_region_country, true);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.iucn.whp.dbservice.model.unesco_region_country",
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = unesco_region_countryPersistence.getDataSource();
	...
	private unesco_region_countryLocalServiceClpInvoker _clpInvoker = new unesco_region_countryLocalServiceClpInvoker();
}