...
/**
 * The base implementation of the negative_factors_trend local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.iucn.whp.dbservice.service.impl.negative_factors_trendLocalServiceImpl}.
 * </p>
 *
 * @author alok.sen
 * @see com.iucn.whp.dbservice.service.impl.negative_factors_trendLocalServiceImpl
 * @see com.iucn.whp.dbservice.service.negative_factors_trendLocalServiceUtil
 * @generated
 */
public abstract class negative_factors_trendLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements negative_factors_trendLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.iucn.whp.dbservice.service.negative_factors_trendLocalServiceUtil} to access the negative_factors_trend local service.
	 */

	/**
	 * Adds the negative_factors_trend to the database. Also notifies the appropriate model listeners.
	 *
	 * @param negative_factors_trend the negative_factors_trend
	 * @return the negative_factors_trend that was added
	 * @throws SystemException if a system exception occurred
	 */
	@Indexable(type = IndexableType.REINDEX)
	public negative_factors_trend addnegative_factors_trend(
		negative_factors_trend negative_factors_trend)
		throws SystemException {
		negative_factors_trend.setNew(true);

		return negative_factors_trendPersistence.update(negative_factors_trend,
			false);
	}
	 ...
	 */
	public negative_factors_trend createnegative_factors_trend(long trend_id) {
		return negative_factors_trendPersistence.create(trend_id);
	}

	/**
	 * Deletes the negative_factors_trend with the primary key from the database. Also notifies the appropriate model listeners.
	 *
	 * @param trend_id the primary key of the negative_factors_trend
	 * @return the negative_factors_trend that was removed
	 * @throws PortalException if a negative_factors_trend with the primary key could not be found
	 * @throws SystemException if a system exception occurred
	 */
	@Indexable(type = IndexableType.DELETE)
	public negative_factors_trend deletenegative_factors_trend(long trend_id)
		throws PortalException, SystemException {
		return negative_factors_trendPersistence.remove(trend_id);
	}

	/**
	 * Deletes the negative_factors_trend from the database. Also notifies the appropriate model listeners.
	 *
	 * @param negative_factors_trend the negative_factors_trend
	 * @return the negative_factors_trend that was removed
	 * @throws SystemException if a system exception occurred
	 */
	@Indexable(type = IndexableType.DELETE)
	public negative_factors_trend deletenegative_factors_trend(
		negative_factors_trend negative_factors_trend)
		throws SystemException {
		return negative_factors_trendPersistence.remove(negative_factors_trend);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(negative_factors_trend.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return negative_factors_trendPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return negative_factors_trendPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public negative_factors_trend fetchnegative_factors_trend(long trend_id)
		throws SystemException {
		return negative_factors_trendPersistence.fetchByPrimaryKey(trend_id);
	}

	/**
	 * Returns the negative_factors_trend with the primary key.
	 *
	 * @param trend_id the primary key of the negative_factors_trend
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public negative_factors_trend getnegative_factors_trend(long trend_id)
		throws PortalException, SystemException {
		return negative_factors_trendPersistence.findByPrimaryKey(trend_id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return negative_factors_trendPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<negative_factors_trend> getnegative_factors_trends(int start,
		int end) throws SystemException {
		return negative_factors_trendPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getnegative_factors_trendsCount() throws SystemException {
		return negative_factors_trendPersistence.countAll();
	}
	 ...
	 *
	 * @param negative_factors_trend the negative_factors_trend
	 * @return the negative_factors_trend that was updated
	 * @throws SystemException if a system exception occurred
	 */
	@Indexable(type = IndexableType.REINDEX)
	public negative_factors_trend updatenegative_factors_trend(
		negative_factors_trend negative_factors_trend)
		throws SystemException {
		return updatenegative_factors_trend(negative_factors_trend, true);
	}
	 ...
	 *
	 * @param negative_factors_trend the negative_factors_trend
	 * @param merge whether to merge the negative_factors_trend with the current session. See {@link com.liferay.portal.service.persistence.BatchSession#update(com.liferay.portal.kernel.dao.orm.Session, com.liferay.portal.model.BaseModel, boolean)} for an explanation.
	 * @return the negative_factors_trend that was updated
	 * @throws SystemException if a system exception occurred
	 */
	@Indexable(type = IndexableType.REINDEX)
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.iucn.whp.dbservice.model.negative_factors_trend",
			negative_factors_trendLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.iucn.whp.dbservice.model.negative_factors_trend");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = negative_factors_trendPersistence.getDataSource();
	...
	private negative_factors_trendLocalServiceClpInvoker _clpInvoker = new negative_factors_trendLocalServiceClpInvoker();
}