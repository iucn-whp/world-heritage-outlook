...
/**
 * The base implementation of the benefit_checksubtype_lkp local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.iucn.whp.dbservice.service.impl.benefit_checksubtype_lkpLocalServiceImpl}.
 * </p>
 *
 * @author alok.sen
 ...
 * @generated
 */
public abstract class benefit_checksubtype_lkpLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements benefit_checksubtype_lkpLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.iucn.whp.dbservice.service.benefit_checksubtype_lkpLocalServiceUtil} to access the benefit_checksubtype_lkp local service.
	 */
	...
	public benefit_checksubtype_lkp addbenefit_checksubtype_lkp(
		benefit_checksubtype_lkp benefit_checksubtype_lkp)
		throws SystemException {
		benefit_checksubtype_lkp.setNew(true);

		return benefit_checksubtype_lkpPersistence.update(benefit_checksubtype_lkp,
			false);
	}
	 ...
	 */
	public benefit_checksubtype_lkp createbenefit_checksubtype_lkp(
		long subbenefit_id) {
		return benefit_checksubtype_lkpPersistence.create(subbenefit_id);
	}
	...
	public benefit_checksubtype_lkp deletebenefit_checksubtype_lkp(
		long subbenefit_id) throws PortalException, SystemException {
		return benefit_checksubtype_lkpPersistence.remove(subbenefit_id);
	}
	...
	public benefit_checksubtype_lkp deletebenefit_checksubtype_lkp(
		benefit_checksubtype_lkp benefit_checksubtype_lkp)
		throws SystemException {
		return benefit_checksubtype_lkpPersistence.remove(benefit_checksubtype_lkp);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(benefit_checksubtype_lkp.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return benefit_checksubtype_lkpPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return benefit_checksubtype_lkpPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public benefit_checksubtype_lkp fetchbenefit_checksubtype_lkp(
		long subbenefit_id) throws SystemException {
		return benefit_checksubtype_lkpPersistence.fetchByPrimaryKey(subbenefit_id);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public benefit_checksubtype_lkp getbenefit_checksubtype_lkp(
		long subbenefit_id) throws PortalException, SystemException {
		return benefit_checksubtype_lkpPersistence.findByPrimaryKey(subbenefit_id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return benefit_checksubtype_lkpPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<benefit_checksubtype_lkp> getbenefit_checksubtype_lkps(
		int start, int end) throws SystemException {
		return benefit_checksubtype_lkpPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getbenefit_checksubtype_lkpsCount() throws SystemException {
		return benefit_checksubtype_lkpPersistence.countAll();
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public benefit_checksubtype_lkp updatebenefit_checksubtype_lkp(
		benefit_checksubtype_lkp benefit_checksubtype_lkp)
		throws SystemException {
		return updatebenefit_checksubtype_lkp(benefit_checksubtype_lkp, true);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.iucn.whp.dbservice.model.benefit_checksubtype_lkp",
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = benefit_checksubtype_lkpPersistence.getDataSource();
	...
	private benefit_checksubtype_lkpLocalServiceClpInvoker _clpInvoker = new benefit_checksubtype_lkpLocalServiceClpInvoker();
}