...
/**
 * The base implementation of the whp_sites_external_documents local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.iucn.whp.dbservice.service.impl.whp_sites_external_documentsLocalServiceImpl}.
 * </p>
 *
 * @author alok.sen
 ...
 * @generated
 */
public abstract class whp_sites_external_documentsLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements whp_sites_external_documentsLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.iucn.whp.dbservice.service.whp_sites_external_documentsLocalServiceUtil} to access the whp_sites_external_documents local service.
	 */
	...
	public whp_sites_external_documents addwhp_sites_external_documents(
		whp_sites_external_documents whp_sites_external_documents)
		throws SystemException {
		whp_sites_external_documents.setNew(true);

		return whp_sites_external_documentsPersistence.update(whp_sites_external_documents,
			false);
	}
	 ...
	 */
	public whp_sites_external_documents createwhp_sites_external_documents(
		long whp_sites_external_documents_id) {
		return whp_sites_external_documentsPersistence.create(whp_sites_external_documents_id);
	}
	...
	public whp_sites_external_documents deletewhp_sites_external_documents(
		long whp_sites_external_documents_id)
		throws PortalException, SystemException {
		return whp_sites_external_documentsPersistence.remove(whp_sites_external_documents_id);
	}
	...
	public whp_sites_external_documents deletewhp_sites_external_documents(
		whp_sites_external_documents whp_sites_external_documents)
		throws SystemException {
		return whp_sites_external_documentsPersistence.remove(whp_sites_external_documents);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(whp_sites_external_documents.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return whp_sites_external_documentsPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return whp_sites_external_documentsPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public whp_sites_external_documents fetchwhp_sites_external_documents(
		long whp_sites_external_documents_id) throws SystemException {
		return whp_sites_external_documentsPersistence.fetchByPrimaryKey(whp_sites_external_documents_id);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public whp_sites_external_documents getwhp_sites_external_documents(
		long whp_sites_external_documents_id)
		throws PortalException, SystemException {
		return whp_sites_external_documentsPersistence.findByPrimaryKey(whp_sites_external_documents_id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return whp_sites_external_documentsPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<whp_sites_external_documents> getwhp_sites_external_documentses(
		int start, int end) throws SystemException {
		return whp_sites_external_documentsPersistence.findAll(start, end);
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public whp_sites_external_documents updatewhp_sites_external_documents(
		whp_sites_external_documents whp_sites_external_documents)
		throws SystemException {
		return updatewhp_sites_external_documents(whp_sites_external_documents,
			true);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.iucn.whp.dbservice.model.whp_sites_external_documents",
			whp_sites_external_documentsLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = whp_sites_external_documentsPersistence.getDataSource();
	...
	private whp_sites_external_documentsLocalServiceClpInvoker _clpInvoker = new whp_sites_external_documentsLocalServiceClpInvoker();
}