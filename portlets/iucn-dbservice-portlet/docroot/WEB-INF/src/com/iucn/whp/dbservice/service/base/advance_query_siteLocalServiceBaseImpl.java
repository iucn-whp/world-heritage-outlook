...
/**
 * The base implementation of the advance_query_site local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.iucn.whp.dbservice.service.impl.advance_query_siteLocalServiceImpl}.
 * </p>
 *
 * @author alok.sen
 ...
 * @generated
 */
public abstract class advance_query_siteLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements advance_query_siteLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.iucn.whp.dbservice.service.advance_query_siteLocalServiceUtil} to access the advance_query_site local service.
	 */
	...
	public advance_query_site addadvance_query_site(
		advance_query_site advance_query_site) throws SystemException {
		advance_query_site.setNew(true);

		return advance_query_sitePersistence.update(advance_query_site, false);
	}
	 ...
	 */
	public advance_query_site createadvance_query_site(long id) {
		return advance_query_sitePersistence.create(id);
	}
	...
	public advance_query_site deleteadvance_query_site(long id)
		throws PortalException, SystemException {
		return advance_query_sitePersistence.remove(id);
	}
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public advance_query_site deleteadvance_query_site(
		advance_query_site advance_query_site) throws SystemException {
		return advance_query_sitePersistence.remove(advance_query_site);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(advance_query_site.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return advance_query_sitePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return advance_query_sitePersistence.countWithDynamicQuery(dynamicQuery);
	}

	public advance_query_site fetchadvance_query_site(long id)
		throws SystemException {
		return advance_query_sitePersistence.fetchByPrimaryKey(id);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public advance_query_site getadvance_query_site(long id)
		throws PortalException, SystemException {
		return advance_query_sitePersistence.findByPrimaryKey(id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return advance_query_sitePersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<advance_query_site> getadvance_query_sites(int start, int end)
		throws SystemException {
		return advance_query_sitePersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getadvance_query_sitesCount() throws SystemException {
		return advance_query_sitePersistence.countAll();
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public advance_query_site updateadvance_query_site(
		advance_query_site advance_query_site) throws SystemException {
		return updateadvance_query_site(advance_query_site, true);
	}
	...
	public advance_query_site updateadvance_query_site(
		...
		return advance_query_sitePersistence.update(advance_query_site, merge);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.iucn.whp.dbservice.model.advance_query_site",
			advance_query_siteLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = advance_query_sitePersistence.getDataSource();
	...
	private advance_query_siteLocalServiceClpInvoker _clpInvoker = new advance_query_siteLocalServiceClpInvoker();
}