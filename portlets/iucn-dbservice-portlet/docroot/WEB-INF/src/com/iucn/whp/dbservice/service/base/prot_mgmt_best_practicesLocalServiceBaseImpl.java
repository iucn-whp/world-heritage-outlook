...
/**
 * The base implementation of the prot_mgmt_best_practices local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.iucn.whp.dbservice.service.impl.prot_mgmt_best_practicesLocalServiceImpl}.
 * </p>
 *
 * @author alok.sen
 ...
 * @generated
 */
public abstract class prot_mgmt_best_practicesLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements prot_mgmt_best_practicesLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.iucn.whp.dbservice.service.prot_mgmt_best_practicesLocalServiceUtil} to access the prot_mgmt_best_practices local service.
	 */
	...
	public prot_mgmt_best_practices addprot_mgmt_best_practices(
		prot_mgmt_best_practices prot_mgmt_best_practices)
		throws SystemException {
		prot_mgmt_best_practices.setNew(true);

		return prot_mgmt_best_practicesPersistence.update(prot_mgmt_best_practices,
			false);
	}
	 ...
	 */
	public prot_mgmt_best_practices createprot_mgmt_best_practices(
		long best_practice_id) {
		return prot_mgmt_best_practicesPersistence.create(best_practice_id);
	}
	...
	public prot_mgmt_best_practices deleteprot_mgmt_best_practices(
		long best_practice_id) throws PortalException, SystemException {
		return prot_mgmt_best_practicesPersistence.remove(best_practice_id);
	}
	...
	public prot_mgmt_best_practices deleteprot_mgmt_best_practices(
		prot_mgmt_best_practices prot_mgmt_best_practices)
		throws SystemException {
		return prot_mgmt_best_practicesPersistence.remove(prot_mgmt_best_practices);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(prot_mgmt_best_practices.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return prot_mgmt_best_practicesPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return prot_mgmt_best_practicesPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public prot_mgmt_best_practices fetchprot_mgmt_best_practices(
		long best_practice_id) throws SystemException {
		return prot_mgmt_best_practicesPersistence.fetchByPrimaryKey(best_practice_id);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public prot_mgmt_best_practices getprot_mgmt_best_practices(
		long best_practice_id) throws PortalException, SystemException {
		return prot_mgmt_best_practicesPersistence.findByPrimaryKey(best_practice_id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return prot_mgmt_best_practicesPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<prot_mgmt_best_practices> getprot_mgmt_best_practiceses(
		int start, int end) throws SystemException {
		return prot_mgmt_best_practicesPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getprot_mgmt_best_practicesesCount() throws SystemException {
		return prot_mgmt_best_practicesPersistence.countAll();
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public prot_mgmt_best_practices updateprot_mgmt_best_practices(
		prot_mgmt_best_practices prot_mgmt_best_practices)
		throws SystemException {
		return updateprot_mgmt_best_practices(prot_mgmt_best_practices, true);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.iucn.whp.dbservice.model.prot_mgmt_best_practices",
			prot_mgmt_best_practicesLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.iucn.whp.dbservice.model.prot_mgmt_best_practices");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = prot_mgmt_best_practicesPersistence.getDataSource();
	...
	private prot_mgmt_best_practicesLocalServiceClpInvoker _clpInvoker = new prot_mgmt_best_practicesLocalServiceClpInvoker();
}