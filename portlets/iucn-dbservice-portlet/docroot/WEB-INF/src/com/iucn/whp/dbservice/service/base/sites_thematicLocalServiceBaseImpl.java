...
/**
 * The base implementation of the sites_thematic local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.iucn.whp.dbservice.service.impl.sites_thematicLocalServiceImpl}.
 * </p>
 *
 * @author alok.sen
 ...
 * @generated
 */
public abstract class sites_thematicLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements sites_thematicLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.iucn.whp.dbservice.service.sites_thematicLocalServiceUtil} to access the sites_thematic local service.
	 */
	...
	public sites_thematic addsites_thematic(sites_thematic sites_thematic)
		throws SystemException {
		sites_thematic.setNew(true);

		return sites_thematicPersistence.update(sites_thematic, false);
	}
	 ...
	 */
	public sites_thematic createsites_thematic(long sitethematicid) {
		return sites_thematicPersistence.create(sitethematicid);
	}
	...
	public sites_thematic deletesites_thematic(long sitethematicid)
		throws PortalException, SystemException {
		return sites_thematicPersistence.remove(sitethematicid);
	}
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public sites_thematic deletesites_thematic(sites_thematic sites_thematic)
		throws SystemException {
		return sites_thematicPersistence.remove(sites_thematic);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(sites_thematic.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return sites_thematicPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return sites_thematicPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public sites_thematic fetchsites_thematic(long sitethematicid)
		throws SystemException {
		return sites_thematicPersistence.fetchByPrimaryKey(sitethematicid);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public sites_thematic getsites_thematic(long sitethematicid)
		throws PortalException, SystemException {
		return sites_thematicPersistence.findByPrimaryKey(sitethematicid);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return sites_thematicPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<sites_thematic> getsites_thematics(int start, int end)
		throws SystemException {
		return sites_thematicPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getsites_thematicsCount() throws SystemException {
		return sites_thematicPersistence.countAll();
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public sites_thematic updatesites_thematic(sites_thematic sites_thematic)
		throws SystemException {
		return updatesites_thematic(sites_thematic, true);
	}
	...
	public sites_thematic updatesites_thematic(sites_thematic sites_thematic,
		...
		return sites_thematicPersistence.update(sites_thematic, merge);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.iucn.whp.dbservice.model.sites_thematic",
			sites_thematicLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = sites_thematicPersistence.getDataSource();
	...
	private sites_thematicLocalServiceClpInvoker _clpInvoker = new sites_thematicLocalServiceClpInvoker();
}