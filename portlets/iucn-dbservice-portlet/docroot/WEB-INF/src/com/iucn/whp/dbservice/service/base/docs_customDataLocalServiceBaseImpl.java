...
/**
 * The base implementation of the docs_custom data local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.iucn.whp.dbservice.service.impl.docs_customDataLocalServiceImpl}.
 * </p>
 *
 * @author alok.sen
 ...
 * @generated
 */
public abstract class docs_customDataLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements docs_customDataLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.iucn.whp.dbservice.service.docs_customDataLocalServiceUtil} to access the docs_custom data local service.
	 */
	...
	public docs_customData adddocs_customData(docs_customData docs_customData)
		throws SystemException {
		docs_customData.setNew(true);

		return docs_customDataPersistence.update(docs_customData, false);
	}
	 ...
	 */
	public docs_customData createdocs_customData(int docs_customDataId) {
		return docs_customDataPersistence.create(docs_customDataId);
	}
	...
	public docs_customData deletedocs_customData(int docs_customDataId)
		throws PortalException, SystemException {
		return docs_customDataPersistence.remove(docs_customDataId);
	}
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public docs_customData deletedocs_customData(
		docs_customData docs_customData) throws SystemException {
		return docs_customDataPersistence.remove(docs_customData);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(docs_customData.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return docs_customDataPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return docs_customDataPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public docs_customData fetchdocs_customData(int docs_customDataId)
		throws SystemException {
		return docs_customDataPersistence.fetchByPrimaryKey(docs_customDataId);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public docs_customData getdocs_customData(int docs_customDataId)
		throws PortalException, SystemException {
		return docs_customDataPersistence.findByPrimaryKey(docs_customDataId);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return docs_customDataPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<docs_customData> getdocs_customDatas(int start, int end)
		throws SystemException {
		return docs_customDataPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getdocs_customDatasCount() throws SystemException {
		return docs_customDataPersistence.countAll();
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public docs_customData updatedocs_customData(
		docs_customData docs_customData) throws SystemException {
		return updatedocs_customData(docs_customData, true);
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	public docs_customData updatedocs_customData(
		docs_customData docs_customData, boolean merge)
		throws SystemException {
		docs_customData.setNew(false);

		return docs_customDataPersistence.update(docs_customData, merge);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.iucn.whp.dbservice.model.docs_customData",
			docs_customDataLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = docs_customDataPersistence.getDataSource();
	...
	private docs_customDataLocalServiceClpInvoker _clpInvoker = new docs_customDataLocalServiceClpInvoker();
}