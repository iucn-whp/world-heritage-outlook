...
/**
 * The base implementation of the threat_summary_overall local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.iucn.whp.dbservice.service.impl.threat_summary_overallLocalServiceImpl}.
 * </p>
 *
 * @author alok.sen
 ...
 * @generated
 */
public abstract class threat_summary_overallLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements threat_summary_overallLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.iucn.whp.dbservice.service.threat_summary_overallLocalServiceUtil} to access the threat_summary_overall local service.
	 */
	...
	public threat_summary_overall addthreat_summary_overall(
		threat_summary_overall threat_summary_overall)
		throws SystemException {
		threat_summary_overall.setNew(true);

		return threat_summary_overallPersistence.update(threat_summary_overall,
			false);
	}
	 ...
	 */
	public threat_summary_overall createthreat_summary_overall(
		long threat_sum_overall_id) {
		return threat_summary_overallPersistence.create(threat_sum_overall_id);
	}
	...
	public threat_summary_overall deletethreat_summary_overall(
		long threat_sum_overall_id) throws PortalException, SystemException {
		return threat_summary_overallPersistence.remove(threat_sum_overall_id);
	}
	...
	public threat_summary_overall deletethreat_summary_overall(
		threat_summary_overall threat_summary_overall)
		throws SystemException {
		return threat_summary_overallPersistence.remove(threat_summary_overall);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(threat_summary_overall.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return threat_summary_overallPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return threat_summary_overallPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public threat_summary_overall fetchthreat_summary_overall(
		long threat_sum_overall_id) throws SystemException {
		return threat_summary_overallPersistence.fetchByPrimaryKey(threat_sum_overall_id);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public threat_summary_overall getthreat_summary_overall(
		long threat_sum_overall_id) throws PortalException, SystemException {
		return threat_summary_overallPersistence.findByPrimaryKey(threat_sum_overall_id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return threat_summary_overallPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<threat_summary_overall> getthreat_summary_overalls(int start,
		int end) throws SystemException {
		return threat_summary_overallPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getthreat_summary_overallsCount() throws SystemException {
		return threat_summary_overallPersistence.countAll();
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public threat_summary_overall updatethreat_summary_overall(
		threat_summary_overall threat_summary_overall)
		throws SystemException {
		return updatethreat_summary_overall(threat_summary_overall, true);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.iucn.whp.dbservice.model.threat_summary_overall",
			threat_summary_overallLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.iucn.whp.dbservice.model.threat_summary_overall");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = threat_summary_overallPersistence.getDataSource();
	...
	private threat_summary_overallLocalServiceClpInvoker _clpInvoker = new threat_summary_overallLocalServiceClpInvoker();
}