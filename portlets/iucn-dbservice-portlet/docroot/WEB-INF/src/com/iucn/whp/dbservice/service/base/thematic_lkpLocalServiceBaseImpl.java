...
/**
 * The base implementation of the thematic_lkp local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.iucn.whp.dbservice.service.impl.thematic_lkpLocalServiceImpl}.
 * </p>
 *
 * @author alok.sen
 ...
 * @generated
 */
public abstract class thematic_lkpLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements thematic_lkpLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.iucn.whp.dbservice.service.thematic_lkpLocalServiceUtil} to access the thematic_lkp local service.
	 */
	...
	public thematic_lkp addthematic_lkp(thematic_lkp thematic_lkp)
		throws SystemException {
		thematic_lkp.setNew(true);

		return thematic_lkpPersistence.update(thematic_lkp, false);
	}
	 ...
	 */
	public thematic_lkp createthematic_lkp(long thematicid) {
		return thematic_lkpPersistence.create(thematicid);
	}
	...
	public thematic_lkp deletethematic_lkp(long thematicid)
		throws PortalException, SystemException {
		return thematic_lkpPersistence.remove(thematicid);
	}
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public thematic_lkp deletethematic_lkp(thematic_lkp thematic_lkp)
		throws SystemException {
		return thematic_lkpPersistence.remove(thematic_lkp);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(thematic_lkp.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return thematic_lkpPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return thematic_lkpPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public thematic_lkp fetchthematic_lkp(long thematicid)
		throws SystemException {
		return thematic_lkpPersistence.fetchByPrimaryKey(thematicid);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public thematic_lkp getthematic_lkp(long thematicid)
		throws PortalException, SystemException {
		return thematic_lkpPersistence.findByPrimaryKey(thematicid);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return thematic_lkpPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<thematic_lkp> getthematic_lkps(int start, int end)
		throws SystemException {
		return thematic_lkpPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getthematic_lkpsCount() throws SystemException {
		return thematic_lkpPersistence.countAll();
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public thematic_lkp updatethematic_lkp(thematic_lkp thematic_lkp)
		throws SystemException {
		return updatethematic_lkp(thematic_lkp, true);
	}
	...
	public thematic_lkp updatethematic_lkp(thematic_lkp thematic_lkp,
		...
		return thematic_lkpPersistence.update(thematic_lkp, merge);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.iucn.whp.dbservice.model.thematic_lkp",
			thematic_lkpLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.iucn.whp.dbservice.model.thematic_lkp");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = thematic_lkpPersistence.getDataSource();
	...
	private thematic_lkpLocalServiceClpInvoker _clpInvoker = new thematic_lkpLocalServiceClpInvoker();
}