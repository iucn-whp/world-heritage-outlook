...
/**
 * The base implementation of the whp_sites_mee local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.iucn.whp.dbservice.service.impl.whp_sites_meeLocalServiceImpl}.
 * </p>
 *
 * @author alok.sen
 ...
 * @generated
 */
public abstract class whp_sites_meeLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements whp_sites_meeLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.iucn.whp.dbservice.service.whp_sites_meeLocalServiceUtil} to access the whp_sites_mee local service.
	 */
	...
	public whp_sites_mee addwhp_sites_mee(whp_sites_mee whp_sites_mee)
		throws SystemException {
		whp_sites_mee.setNew(true);

		return whp_sites_meePersistence.update(whp_sites_mee, false);
	}
	 ...
	 */
	public whp_sites_mee createwhp_sites_mee(long whp_sites_mee_id) {
		return whp_sites_meePersistence.create(whp_sites_mee_id);
	}
	...
	public whp_sites_mee deletewhp_sites_mee(long whp_sites_mee_id)
		throws PortalException, SystemException {
		return whp_sites_meePersistence.remove(whp_sites_mee_id);
	}
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public whp_sites_mee deletewhp_sites_mee(whp_sites_mee whp_sites_mee)
		throws SystemException {
		return whp_sites_meePersistence.remove(whp_sites_mee);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(whp_sites_mee.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return whp_sites_meePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return whp_sites_meePersistence.countWithDynamicQuery(dynamicQuery);
	}

	public whp_sites_mee fetchwhp_sites_mee(long whp_sites_mee_id)
		throws SystemException {
		return whp_sites_meePersistence.fetchByPrimaryKey(whp_sites_mee_id);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public whp_sites_mee getwhp_sites_mee(long whp_sites_mee_id)
		throws PortalException, SystemException {
		return whp_sites_meePersistence.findByPrimaryKey(whp_sites_mee_id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return whp_sites_meePersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<whp_sites_mee> getwhp_sites_mees(int start, int end)
		throws SystemException {
		return whp_sites_meePersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getwhp_sites_meesCount() throws SystemException {
		return whp_sites_meePersistence.countAll();
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public whp_sites_mee updatewhp_sites_mee(whp_sites_mee whp_sites_mee)
		throws SystemException {
		return updatewhp_sites_mee(whp_sites_mee, true);
	}
	...
	public whp_sites_mee updatewhp_sites_mee(whp_sites_mee whp_sites_mee,
		...
		return whp_sites_meePersistence.update(whp_sites_mee, merge);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.iucn.whp.dbservice.model.whp_sites_mee",
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = whp_sites_meePersistence.getDataSource();
	...
	private whp_sites_meeLocalServiceClpInvoker _clpInvoker = new whp_sites_meeLocalServiceClpInvoker();
}