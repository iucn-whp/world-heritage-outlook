...
/**
 * The base implementation of the docs_sitedata local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.iucn.whp.dbservice.service.impl.docs_sitedataLocalServiceImpl}.
 * </p>
 *
 * @author alok.sen
 * @see com.iucn.whp.dbservice.service.impl.docs_sitedataLocalServiceImpl
 * @see com.iucn.whp.dbservice.service.docs_sitedataLocalServiceUtil
 * @generated
 */
public abstract class docs_sitedataLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements docs_sitedataLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.iucn.whp.dbservice.service.docs_sitedataLocalServiceUtil} to access the docs_sitedata local service.
	 */
	...
	public docs_sitedata adddocs_sitedata(docs_sitedata docs_sitedata)
		throws SystemException {
		docs_sitedata.setNew(true);

		return docs_sitedataPersistence.update(docs_sitedata, false);
	}
	 ...
	 */
	public docs_sitedata createdocs_sitedata(long docs_sitedataId) {
		return docs_sitedataPersistence.create(docs_sitedataId);
	}
	...
	public docs_sitedata deletedocs_sitedata(long docs_sitedataId)
		throws PortalException, SystemException {
		return docs_sitedataPersistence.remove(docs_sitedataId);
	}
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public docs_sitedata deletedocs_sitedata(docs_sitedata docs_sitedata)
		throws SystemException {
		return docs_sitedataPersistence.remove(docs_sitedata);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(docs_sitedata.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return docs_sitedataPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return docs_sitedataPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public docs_sitedata fetchdocs_sitedata(long docs_sitedataId)
		throws SystemException {
		return docs_sitedataPersistence.fetchByPrimaryKey(docs_sitedataId);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public docs_sitedata getdocs_sitedata(long docs_sitedataId)
		throws PortalException, SystemException {
		return docs_sitedataPersistence.findByPrimaryKey(docs_sitedataId);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return docs_sitedataPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<docs_sitedata> getdocs_sitedatas(int start, int end)
		throws SystemException {
		return docs_sitedataPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getdocs_sitedatasCount() throws SystemException {
		return docs_sitedataPersistence.countAll();
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public docs_sitedata updatedocs_sitedata(docs_sitedata docs_sitedata)
		throws SystemException {
		return updatedocs_sitedata(docs_sitedata, true);
	}
	...
	public docs_sitedata updatedocs_sitedata(docs_sitedata docs_sitedata,
		...
		return docs_sitedataPersistence.update(docs_sitedata, merge);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.iucn.whp.dbservice.model.docs_sitedata",
			docs_sitedataLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.iucn.whp.dbservice.model.docs_sitedata");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = docs_sitedataPersistence.getDataSource();
	...
	private docs_sitedataLocalServiceClpInvoker _clpInvoker = new docs_sitedataLocalServiceClpInvoker();
}