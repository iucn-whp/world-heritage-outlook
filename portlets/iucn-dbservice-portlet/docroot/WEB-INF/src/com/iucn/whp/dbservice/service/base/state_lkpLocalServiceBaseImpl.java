...
/**
 * The base implementation of the state_lkp local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.iucn.whp.dbservice.service.impl.state_lkpLocalServiceImpl}.
 * </p>
 *
 * @author alok.sen
 * @see com.iucn.whp.dbservice.service.impl.state_lkpLocalServiceImpl
 * @see com.iucn.whp.dbservice.service.state_lkpLocalServiceUtil
 * @generated
 */
public abstract class state_lkpLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements state_lkpLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.iucn.whp.dbservice.service.state_lkpLocalServiceUtil} to access the state_lkp local service.
	 */
	...
	public state_lkp addstate_lkp(state_lkp state_lkp)
		throws SystemException {
		state_lkp.setNew(true);

		return state_lkpPersistence.update(state_lkp, false);
	}
	 ...
	 */
	public state_lkp createstate_lkp(long state_id) {
		return state_lkpPersistence.create(state_id);
	}
	...
	public state_lkp deletestate_lkp(long state_id)
		throws PortalException, SystemException {
		return state_lkpPersistence.remove(state_id);
	}
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public state_lkp deletestate_lkp(state_lkp state_lkp)
		throws SystemException {
		return state_lkpPersistence.remove(state_lkp);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(state_lkp.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return state_lkpPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return state_lkpPersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return state_lkpPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public state_lkp fetchstate_lkp(long state_id) throws SystemException {
		return state_lkpPersistence.fetchByPrimaryKey(state_id);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public state_lkp getstate_lkp(long state_id)
		throws PortalException, SystemException {
		return state_lkpPersistence.findByPrimaryKey(state_id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return state_lkpPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<state_lkp> getstate_lkps(int start, int end)
		throws SystemException {
		return state_lkpPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getstate_lkpsCount() throws SystemException {
		return state_lkpPersistence.countAll();
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public state_lkp updatestate_lkp(state_lkp state_lkp)
		throws SystemException {
		return updatestate_lkp(state_lkp, true);
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public state_lkp updatestate_lkp(state_lkp state_lkp, boolean merge)
		throws SystemException {
		state_lkp.setNew(false);

		return state_lkpPersistence.update(state_lkp, merge);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.iucn.whp.dbservice.model.state_lkp",
			state_lkpLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.iucn.whp.dbservice.model.state_lkp");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = state_lkpPersistence.getDataSource();
	...
	private state_lkpLocalServiceClpInvoker _clpInvoker = new state_lkpLocalServiceClpInvoker();
}