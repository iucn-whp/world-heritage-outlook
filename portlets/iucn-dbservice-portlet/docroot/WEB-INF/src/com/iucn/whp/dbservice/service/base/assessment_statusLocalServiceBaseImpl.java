...
/**
 * The base implementation of the assessment_status local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.iucn.whp.dbservice.service.impl.assessment_statusLocalServiceImpl}.
 * </p>
 *
 * @author alok.sen
 * @see com.iucn.whp.dbservice.service.impl.assessment_statusLocalServiceImpl
 * @see com.iucn.whp.dbservice.service.assessment_statusLocalServiceUtil
 * @generated
 */
public abstract class assessment_statusLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements assessment_statusLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.iucn.whp.dbservice.service.assessment_statusLocalServiceUtil} to access the assessment_status local service.
	 */
	...
	public assessment_status addassessment_status(
		assessment_status assessment_status) throws SystemException {
		assessment_status.setNew(true);

		return assessment_statusPersistence.update(assessment_status, false);
	}
	 ...
	 */
	public assessment_status createassessment_status(long statusid) {
		return assessment_statusPersistence.create(statusid);
	}
	...
	public assessment_status deleteassessment_status(long statusid)
		throws PortalException, SystemException {
		return assessment_statusPersistence.remove(statusid);
	}
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public assessment_status deleteassessment_status(
		assessment_status assessment_status) throws SystemException {
		return assessment_statusPersistence.remove(assessment_status);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(assessment_status.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return assessment_statusPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return assessment_statusPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public assessment_status fetchassessment_status(long statusid)
		throws SystemException {
		return assessment_statusPersistence.fetchByPrimaryKey(statusid);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public assessment_status getassessment_status(long statusid)
		throws PortalException, SystemException {
		return assessment_statusPersistence.findByPrimaryKey(statusid);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return assessment_statusPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<assessment_status> getassessment_statuses(int start, int end)
		throws SystemException {
		return assessment_statusPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getassessment_statusesCount() throws SystemException {
		return assessment_statusPersistence.countAll();
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public assessment_status updateassessment_status(
		assessment_status assessment_status) throws SystemException {
		return updateassessment_status(assessment_status, true);
	}
	...
	public assessment_status updateassessment_status(
		...
		return assessment_statusPersistence.update(assessment_status, merge);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.iucn.whp.dbservice.model.assessment_status",
			assessment_statusLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.iucn.whp.dbservice.model.assessment_status");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = assessment_statusPersistence.getDataSource();
	...
	private assessment_statusLocalServiceClpInvoker _clpInvoker = new assessment_statusLocalServiceClpInvoker();
}