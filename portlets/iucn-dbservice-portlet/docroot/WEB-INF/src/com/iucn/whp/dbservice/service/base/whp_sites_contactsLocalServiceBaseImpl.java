...
/**
 * The base implementation of the whp_sites_contacts local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.iucn.whp.dbservice.service.impl.whp_sites_contactsLocalServiceImpl}.
 * </p>
 *
 * @author alok.sen
 * @see com.iucn.whp.dbservice.service.impl.whp_sites_contactsLocalServiceImpl
 * @see com.iucn.whp.dbservice.service.whp_sites_contactsLocalServiceUtil
 * @generated
 */
public abstract class whp_sites_contactsLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements whp_sites_contactsLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.iucn.whp.dbservice.service.whp_sites_contactsLocalServiceUtil} to access the whp_sites_contacts local service.
	 */
	...
	public whp_sites_contacts addwhp_sites_contacts(
		whp_sites_contacts whp_sites_contacts) throws SystemException {
		whp_sites_contacts.setNew(true);

		return whp_sites_contactsPersistence.update(whp_sites_contacts, false);
	}
	 ...
	 */
	public whp_sites_contacts createwhp_sites_contacts(
		long whp_sites_contacts_id) {
		return whp_sites_contactsPersistence.create(whp_sites_contacts_id);
	}
	...
	public whp_sites_contacts deletewhp_sites_contacts(
		long whp_sites_contacts_id) throws PortalException, SystemException {
		return whp_sites_contactsPersistence.remove(whp_sites_contacts_id);
	}
	...
	public whp_sites_contacts deletewhp_sites_contacts(
		whp_sites_contacts whp_sites_contacts) throws SystemException {
		return whp_sites_contactsPersistence.remove(whp_sites_contacts);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(whp_sites_contacts.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return whp_sites_contactsPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return whp_sites_contactsPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public whp_sites_contacts fetchwhp_sites_contacts(
		long whp_sites_contacts_id) throws SystemException {
		return whp_sites_contactsPersistence.fetchByPrimaryKey(whp_sites_contacts_id);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public whp_sites_contacts getwhp_sites_contacts(long whp_sites_contacts_id)
		throws PortalException, SystemException {
		return whp_sites_contactsPersistence.findByPrimaryKey(whp_sites_contacts_id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return whp_sites_contactsPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<whp_sites_contacts> getwhp_sites_contactses(int start, int end)
		throws SystemException {
		return whp_sites_contactsPersistence.findAll(start, end);
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public whp_sites_contacts updatewhp_sites_contacts(
		whp_sites_contacts whp_sites_contacts) throws SystemException {
		return updatewhp_sites_contacts(whp_sites_contacts, true);
	}
	...
	public whp_sites_contacts updatewhp_sites_contacts(
		...
		return whp_sites_contactsPersistence.update(whp_sites_contacts, merge);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.iucn.whp.dbservice.model.whp_sites_contacts",
			whp_sites_contactsLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.iucn.whp.dbservice.model.whp_sites_contacts");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = whp_sites_contactsPersistence.getDataSource();
	...
	private whp_sites_contactsLocalServiceClpInvoker _clpInvoker = new whp_sites_contactsLocalServiceClpInvoker();
}