...
/**
 * The base implementation of the benefits local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.iucn.whp.dbservice.service.impl.benefitsLocalServiceImpl}.
 * </p>
 *
 * @author alok.sen
 * @see com.iucn.whp.dbservice.service.impl.benefitsLocalServiceImpl
 * @see com.iucn.whp.dbservice.service.benefitsLocalServiceUtil
 * @generated
 */
public abstract class benefitsLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements benefitsLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.iucn.whp.dbservice.service.benefitsLocalServiceUtil} to access the benefits local service.
	 */
	...
	public benefits addbenefits(benefits benefits) throws SystemException {
		benefits.setNew(true);

		return benefitsPersistence.update(benefits, false);
	}
	 ...
	 */
	public benefits createbenefits(long benefits_id) {
		return benefitsPersistence.create(benefits_id);
	}
	...
	public benefits deletebenefits(long benefits_id)
		throws PortalException, SystemException {
		return benefitsPersistence.remove(benefits_id);
	}
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public benefits deletebenefits(benefits benefits) throws SystemException {
		return benefitsPersistence.remove(benefits);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(benefits.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return benefitsPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return benefitsPersistence.findWithDynamicQuery(dynamicQuery, start, end);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end,
		...
		return benefitsPersistence.findWithDynamicQuery(dynamicQuery, start,
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return benefitsPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public benefits fetchbenefits(long benefits_id) throws SystemException {
		return benefitsPersistence.fetchByPrimaryKey(benefits_id);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public benefits getbenefits(long benefits_id)
		throws PortalException, SystemException {
		return benefitsPersistence.findByPrimaryKey(benefits_id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return benefitsPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<benefits> getbenefitses(int start, int end)
		throws SystemException {
		return benefitsPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getbenefitsesCount() throws SystemException {
		return benefitsPersistence.countAll();
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public benefits updatebenefits(benefits benefits) throws SystemException {
		return updatebenefits(benefits, true);
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public benefits updatebenefits(benefits benefits, boolean merge)
		throws SystemException {
		benefits.setNew(false);

		return benefitsPersistence.update(benefits, merge);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.iucn.whp.dbservice.model.benefits",
			benefitsLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.iucn.whp.dbservice.model.benefits");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = benefitsPersistence.getDataSource();
	...
	private benefitsLocalServiceClpInvoker _clpInvoker = new benefitsLocalServiceClpInvoker();
}