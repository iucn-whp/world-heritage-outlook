...
import com.iucn.whp.dbservice.model.advance_query_assessmentModel;
...
/**
 * The base model implementation for the advance_query_assessment service. Represents a row in the &quot;whp_advance_query_assessment&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This implementation and its corresponding interface {@link com.iucn.whp.dbservice.model.advance_query_assessmentModel} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link advance_query_assessmentImpl}.
 * </p>
 *
 * @author alok.sen
 * @see advance_query_assessmentImpl
 * @see com.iucn.whp.dbservice.model.advance_query_assessment
 * @see com.iucn.whp.dbservice.model.advance_query_assessmentModel
 * @generated
 */
public class advance_query_assessmentModelImpl extends BaseModelImpl<advance_query_assessment>
	implements advance_query_assessmentModel {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. All methods that expect a advance_query_assessment model instance should use the {@link com.iucn.whp.dbservice.model.advance_query_assessment} interface instead.
	 */
	public static final String TABLE_NAME = "whp_advance_query_assessment";
	...
	public static final long LOCK_EXPIRATION_TIME = GetterUtil.getLong(com.liferay.util.service.ServiceProps.get(
				"lock.expiration.time.com.iucn.whp.dbservice.model.advance_query_assessment"));

	public advance_query_assessmentModelImpl() {
	}
	...
	public ExpandoBridge getExpandoBridge() {
		return ExpandoBridgeFactoryUtil.getExpandoBridge(0,
			advance_query_assessment.class.getName(), getPrimaryKey());
	}
	...
	public advance_query_assessment toEscapedModel() {
		if (_escapedModelProxy == null) {
			_escapedModelProxy = (advance_query_assessment)ProxyUtil.newProxyInstance(_classLoader,
	...
	public Object clone() {
		...
		advance_query_assessmentImpl.setId(getId());
		advance_query_assessmentImpl.setBase_search_val(getBase_search_val());
		advance_query_assessmentImpl.setBase_tab_name(getBase_tab_name());
		advance_query_assessmentImpl.setBase_tab_pk(getBase_tab_pk());
		advance_query_assessmentImpl.setBase_tab_field_disp(getBase_tab_field_disp());
		advance_query_assessmentImpl.setBase_tab_field_actual(getBase_tab_field_actual());
		advance_query_assessmentImpl.setRelate_tab_available(getRelate_tab_available());
		advance_query_assessmentImpl.setRelate_table_name(getRelate_table_name());
		advance_query_assessmentImpl.setRelate_tab_fk(getRelate_tab_fk());
		advance_query_assessmentImpl.setHas_lookup(getHas_lookup());
		advance_query_assessmentImpl.setLookup_table_name(getLookup_table_name());
		advance_query_assessmentImpl.setLookup_pk(getLookup_pk());
		advance_query_assessmentImpl.setLkp_display_field(getLkp_display_field());
		advance_query_assessmentImpl.setCustom_sql(getCustom_sql());
		advance_query_assessmentImpl.setIsboolean(getIsboolean());
	...
	public boolean equals(Object obj) {
		...
		advance_query_assessment advance_query_assessment = null;

		try {
			advance_query_assessment = (advance_query_assessment)obj;
		}
	...
	public void resetOriginalValues() {
		advance_query_assessmentModelImpl advance_query_assessmentModelImpl = this;

		advance_query_assessmentModelImpl._originalBase_search_val = advance_query_assessmentModelImpl._base_search_val;

		advance_query_assessmentModelImpl._originalBase_tab_name = advance_query_assessmentModelImpl._base_tab_name;

		advance_query_assessmentModelImpl._columnBitmask = 0;
	}

	@Override
	public CacheModel<advance_query_assessment> toCacheModel() {
		advance_query_assessmentCacheModel advance_query_assessmentCacheModel = new advance_query_assessmentCacheModel();

		advance_query_assessmentCacheModel.id = getId();

		advance_query_assessmentCacheModel.base_search_val = getBase_search_val();

		String base_search_val = advance_query_assessmentCacheModel.base_search_val;

		if ((base_search_val != null) && (base_search_val.length() == 0)) {
			advance_query_assessmentCacheModel.base_search_val = null;
		}

		advance_query_assessmentCacheModel.base_tab_name = getBase_tab_name();

		String base_tab_name = advance_query_assessmentCacheModel.base_tab_name;

		if ((base_tab_name != null) && (base_tab_name.length() == 0)) {
			advance_query_assessmentCacheModel.base_tab_name = null;
		}

		advance_query_assessmentCacheModel.base_tab_pk = getBase_tab_pk();

		String base_tab_pk = advance_query_assessmentCacheModel.base_tab_pk;

		if ((base_tab_pk != null) && (base_tab_pk.length() == 0)) {
			advance_query_assessmentCacheModel.base_tab_pk = null;
		}

		advance_query_assessmentCacheModel.base_tab_field_disp = getBase_tab_field_disp();

		String base_tab_field_disp = advance_query_assessmentCacheModel.base_tab_field_disp;

		if ((base_tab_field_disp != null) &&
				(base_tab_field_disp.length() == 0)) {
			advance_query_assessmentCacheModel.base_tab_field_disp = null;
		}

		advance_query_assessmentCacheModel.base_tab_field_actual = getBase_tab_field_actual();

		String base_tab_field_actual = advance_query_assessmentCacheModel.base_tab_field_actual;

		if ((base_tab_field_actual != null) &&
				(base_tab_field_actual.length() == 0)) {
			advance_query_assessmentCacheModel.base_tab_field_actual = null;
		}

		advance_query_assessmentCacheModel.relate_tab_available = getRelate_tab_available();

		String relate_tab_available = advance_query_assessmentCacheModel.relate_tab_available;

		if ((relate_tab_available != null) &&
				(relate_tab_available.length() == 0)) {
			advance_query_assessmentCacheModel.relate_tab_available = null;
		}

		advance_query_assessmentCacheModel.relate_table_name = getRelate_table_name();

		String relate_table_name = advance_query_assessmentCacheModel.relate_table_name;

		if ((relate_table_name != null) && (relate_table_name.length() == 0)) {
			advance_query_assessmentCacheModel.relate_table_name = null;
		}

		advance_query_assessmentCacheModel.relate_tab_fk = getRelate_tab_fk();

		String relate_tab_fk = advance_query_assessmentCacheModel.relate_tab_fk;

		if ((relate_tab_fk != null) && (relate_tab_fk.length() == 0)) {
			advance_query_assessmentCacheModel.relate_tab_fk = null;
		}

		advance_query_assessmentCacheModel.has_lookup = getHas_lookup();

		String has_lookup = advance_query_assessmentCacheModel.has_lookup;

		if ((has_lookup != null) && (has_lookup.length() == 0)) {
			advance_query_assessmentCacheModel.has_lookup = null;
		}

		advance_query_assessmentCacheModel.lookup_table_name = getLookup_table_name();

		String lookup_table_name = advance_query_assessmentCacheModel.lookup_table_name;

		if ((lookup_table_name != null) && (lookup_table_name.length() == 0)) {
			advance_query_assessmentCacheModel.lookup_table_name = null;
		}

		advance_query_assessmentCacheModel.lookup_pk = getLookup_pk();

		String lookup_pk = advance_query_assessmentCacheModel.lookup_pk;

		if ((lookup_pk != null) && (lookup_pk.length() == 0)) {
			advance_query_assessmentCacheModel.lookup_pk = null;
		}

		advance_query_assessmentCacheModel.lkp_display_field = getLkp_display_field();

		String lkp_display_field = advance_query_assessmentCacheModel.lkp_display_field;

		if ((lkp_display_field != null) && (lkp_display_field.length() == 0)) {
			advance_query_assessmentCacheModel.lkp_display_field = null;
		}

		advance_query_assessmentCacheModel.custom_sql = getCustom_sql();

		String custom_sql = advance_query_assessmentCacheModel.custom_sql;

		if ((custom_sql != null) && (custom_sql.length() == 0)) {
			advance_query_assessmentCacheModel.custom_sql = null;
		}

		advance_query_assessmentCacheModel.isboolean = getIsboolean();

		String isboolean = advance_query_assessmentCacheModel.isboolean;

		if ((isboolean != null) && (isboolean.length() == 0)) {
			advance_query_assessmentCacheModel.isboolean = null;
		}

		return advance_query_assessmentCacheModel;
	}
	...
	private static ClassLoader _classLoader = advance_query_assessment.class.getClassLoader();
	private static Class<?>[] _escapedModelProxyInterfaces = new Class[] {
			advance_query_assessment.class
		};
	private long _id;
	...
	private advance_query_assessment _escapedModelProxy;
}