...
/**
 * The base implementation of the whp_sites_indigenous_communities local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.iucn.whp.dbservice.service.impl.whp_sites_indigenous_communitiesLocalServiceImpl}.
 * </p>
 *
 * @author alok.sen
 * @see com.iucn.whp.dbservice.service.impl.whp_sites_indigenous_communitiesLocalServiceImpl
 * @see com.iucn.whp.dbservice.service.whp_sites_indigenous_communitiesLocalServiceUtil
 * @generated
 */
public abstract class whp_sites_indigenous_communitiesLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements whp_sites_indigenous_communitiesLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.iucn.whp.dbservice.service.whp_sites_indigenous_communitiesLocalServiceUtil} to access the whp_sites_indigenous_communities local service.
	 */
	...
	public whp_sites_indigenous_communities addwhp_sites_indigenous_communities(
		whp_sites_indigenous_communities whp_sites_indigenous_communities)
		throws SystemException {
		whp_sites_indigenous_communities.setNew(true);

		return whp_sites_indigenous_communitiesPersistence.update(whp_sites_indigenous_communities,
			false);
	}
	 ...
	 */
	public whp_sites_indigenous_communities createwhp_sites_indigenous_communities(
		long whp_sites_indigenous_communities_id) {
		return whp_sites_indigenous_communitiesPersistence.create(whp_sites_indigenous_communities_id);
	}
	...
	public whp_sites_indigenous_communities deletewhp_sites_indigenous_communities(
		long whp_sites_indigenous_communities_id)
		throws PortalException, SystemException {
		return whp_sites_indigenous_communitiesPersistence.remove(whp_sites_indigenous_communities_id);
	}
	...
	public whp_sites_indigenous_communities deletewhp_sites_indigenous_communities(
		whp_sites_indigenous_communities whp_sites_indigenous_communities)
		throws SystemException {
		return whp_sites_indigenous_communitiesPersistence.remove(whp_sites_indigenous_communities);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(whp_sites_indigenous_communities.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return whp_sites_indigenous_communitiesPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return whp_sites_indigenous_communitiesPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public whp_sites_indigenous_communities fetchwhp_sites_indigenous_communities(
		long whp_sites_indigenous_communities_id) throws SystemException {
		return whp_sites_indigenous_communitiesPersistence.fetchByPrimaryKey(whp_sites_indigenous_communities_id);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public whp_sites_indigenous_communities getwhp_sites_indigenous_communities(
		long whp_sites_indigenous_communities_id)
		throws PortalException, SystemException {
		return whp_sites_indigenous_communitiesPersistence.findByPrimaryKey(whp_sites_indigenous_communities_id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return whp_sites_indigenous_communitiesPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<whp_sites_indigenous_communities> getwhp_sites_indigenous_communitieses(
		int start, int end) throws SystemException {
		return whp_sites_indigenous_communitiesPersistence.findAll(start, end);
	}
	...
	public int getwhp_sites_indigenous_communitiesesCount()
		throws SystemException {
		return whp_sites_indigenous_communitiesPersistence.countAll();
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public whp_sites_indigenous_communities updatewhp_sites_indigenous_communities(
		whp_sites_indigenous_communities whp_sites_indigenous_communities)
		throws SystemException {
		return updatewhp_sites_indigenous_communities(whp_sites_indigenous_communities,
			true);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.iucn.whp.dbservice.model.whp_sites_indigenous_communities",
			whp_sites_indigenous_communitiesLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = whp_sites_indigenous_communitiesPersistence.getDataSource();
	...
	private whp_sites_indigenous_communitiesLocalServiceClpInvoker _clpInvoker = new whp_sites_indigenous_communitiesLocalServiceClpInvoker();
}