...
/**
 * The base implementation of the assessment_whvalues local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.iucn.whp.dbservice.service.impl.assessment_whvaluesLocalServiceImpl}.
 * </p>
 *
 * @author alok.sen
 * @see com.iucn.whp.dbservice.service.impl.assessment_whvaluesLocalServiceImpl
 * @see com.iucn.whp.dbservice.service.assessment_whvaluesLocalServiceUtil
 * @generated
 */
public abstract class assessment_whvaluesLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements assessment_whvaluesLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.iucn.whp.dbservice.service.assessment_whvaluesLocalServiceUtil} to access the assessment_whvalues local service.
	 */
	...
	public assessment_whvalues addassessment_whvalues(
		assessment_whvalues assessment_whvalues) throws SystemException {
		assessment_whvalues.setNew(true);

		return assessment_whvaluesPersistence.update(assessment_whvalues, false);
	}
	 ...
	 */
	public assessment_whvalues createassessment_whvalues(long whvalues_id) {
		return assessment_whvaluesPersistence.create(whvalues_id);
	}
	...
	public assessment_whvalues deleteassessment_whvalues(long whvalues_id)
		throws PortalException, SystemException {
		return assessment_whvaluesPersistence.remove(whvalues_id);
	}
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public assessment_whvalues deleteassessment_whvalues(
		assessment_whvalues assessment_whvalues) throws SystemException {
		return assessment_whvaluesPersistence.remove(assessment_whvalues);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(assessment_whvalues.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return assessment_whvaluesPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return assessment_whvaluesPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public assessment_whvalues fetchassessment_whvalues(long whvalues_id)
		throws SystemException {
		return assessment_whvaluesPersistence.fetchByPrimaryKey(whvalues_id);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public assessment_whvalues getassessment_whvalues(long whvalues_id)
		throws PortalException, SystemException {
		return assessment_whvaluesPersistence.findByPrimaryKey(whvalues_id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return assessment_whvaluesPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<assessment_whvalues> getassessment_whvalueses(int start, int end)
		throws SystemException {
		return assessment_whvaluesPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getassessment_whvaluesesCount() throws SystemException {
		return assessment_whvaluesPersistence.countAll();
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public assessment_whvalues updateassessment_whvalues(
		assessment_whvalues assessment_whvalues) throws SystemException {
		return updateassessment_whvalues(assessment_whvalues, true);
	}
	...
	public assessment_whvalues updateassessment_whvalues(
		...
		return assessment_whvaluesPersistence.update(assessment_whvalues, merge);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.iucn.whp.dbservice.model.assessment_whvalues",
			assessment_whvaluesLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.iucn.whp.dbservice.model.assessment_whvalues");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = assessment_whvaluesPersistence.getDataSource();
	...
	private assessment_whvaluesLocalServiceClpInvoker _clpInvoker = new assessment_whvaluesLocalServiceClpInvoker();
}