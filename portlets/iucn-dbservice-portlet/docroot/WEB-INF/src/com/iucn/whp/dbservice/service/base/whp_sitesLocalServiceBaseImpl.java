...
/**
 * The base implementation of the whp_sites local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.iucn.whp.dbservice.service.impl.whp_sitesLocalServiceImpl}.
 * </p>
 *
 * @author alok.sen
 ...
 * @generated
 */
public abstract class whp_sitesLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements whp_sitesLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.iucn.whp.dbservice.service.whp_sitesLocalServiceUtil} to access the whp_sites local service.
	 */
	...
	public whp_sites addwhp_sites(whp_sites whp_sites)
		throws SystemException {
		whp_sites.setNew(true);

		return whp_sitesPersistence.update(whp_sites, false);
	}
	 ...
	 */
	public whp_sites createwhp_sites(long site_id) {
		return whp_sitesPersistence.create(site_id);
	}
	...
	public whp_sites deletewhp_sites(long site_id)
		throws PortalException, SystemException {
		return whp_sitesPersistence.remove(site_id);
	}
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public whp_sites deletewhp_sites(whp_sites whp_sites)
		throws SystemException {
		return whp_sitesPersistence.remove(whp_sites);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(whp_sites.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return whp_sitesPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return whp_sitesPersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return whp_sitesPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public whp_sites fetchwhp_sites(long site_id) throws SystemException {
		return whp_sitesPersistence.fetchByPrimaryKey(site_id);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public whp_sites getwhp_sites(long site_id)
		throws PortalException, SystemException {
		return whp_sitesPersistence.findByPrimaryKey(site_id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return whp_sitesPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<whp_sites> getwhp_siteses(int start, int end)
		throws SystemException {
		return whp_sitesPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getwhp_sitesesCount() throws SystemException {
		return whp_sitesPersistence.countAll();
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public whp_sites updatewhp_sites(whp_sites whp_sites)
		throws SystemException {
		return updatewhp_sites(whp_sites, true);
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public whp_sites updatewhp_sites(whp_sites whp_sites, boolean merge)
		throws SystemException {
		whp_sites.setNew(false);

		return whp_sitesPersistence.update(whp_sites, merge);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.iucn.whp.dbservice.model.whp_sites",
			whp_sitesLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = whp_sitesPersistence.getDataSource();
	...
	private whp_sitesLocalServiceClpInvoker _clpInvoker = new whp_sitesLocalServiceClpInvoker();
}