...
import com.iucn.whp.dbservice.service.persistence.understanding_benefitsPersistence;
import com.iucn.whp.dbservice.service.persistence.understanding_benefits_lkpPersistence;
...
import com.iucn.whp.dbservice.service.understanding_benefitsLocalService;
import com.iucn.whp.dbservice.service.understanding_benefits_lkpLocalService;
...
/**
 * The base implementation of the understanding_benefits local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.iucn.whp.dbservice.service.impl.understanding_benefitsLocalServiceImpl}.
 * </p>
 *
 * @author alok.sen
 * @see com.iucn.whp.dbservice.service.impl.understanding_benefitsLocalServiceImpl
 * @see com.iucn.whp.dbservice.service.understanding_benefitsLocalServiceUtil
 * @generated
 */
public abstract class understanding_benefitsLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements understanding_benefitsLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.iucn.whp.dbservice.service.understanding_benefitsLocalServiceUtil} to access the understanding_benefits local service.
	 */

	/**
	 * Adds the understanding_benefits to the database. Also notifies the appropriate model listeners.
	 *
	 * @param understanding_benefits the understanding_benefits
	 * @return the understanding_benefits that was added
	 * @throws SystemException if a system exception occurred
	 */
	@Indexable(type = IndexableType.REINDEX)
	public understanding_benefits addunderstanding_benefits(
		understanding_benefits understanding_benefits)
		throws SystemException {
		understanding_benefits.setNew(true);

		return understanding_benefitsPersistence.update(understanding_benefits,
			false);
	}
	 ...
	 */
	public understanding_benefits createunderstanding_benefits(
		long understanding_benefits_id) {
		return understanding_benefitsPersistence.create(understanding_benefits_id);
	}

	/**
	 * Deletes the understanding_benefits with the primary key from the database. Also notifies the appropriate model listeners.
	 *
	 ...
	 * @throws PortalException if a understanding_benefits with the primary key could not be found
	 * @throws SystemException if a system exception occurred
	 */
	@Indexable(type = IndexableType.DELETE)
	public understanding_benefits deleteunderstanding_benefits(
		long understanding_benefits_id) throws PortalException, SystemException {
		return understanding_benefitsPersistence.remove(understanding_benefits_id);
	}

	/**
	 * Deletes the understanding_benefits from the database. Also notifies the appropriate model listeners.
	 *
	 * @param understanding_benefits the understanding_benefits
	 * @return the understanding_benefits that was removed
	 * @throws SystemException if a system exception occurred
	...
	public understanding_benefits deleteunderstanding_benefits(
		understanding_benefits understanding_benefits)
		throws SystemException {
		return understanding_benefitsPersistence.remove(understanding_benefits);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(understanding_benefits.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return understanding_benefitsPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return understanding_benefitsPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public understanding_benefits fetchunderstanding_benefits(
		long understanding_benefits_id) throws SystemException {
		return understanding_benefitsPersistence.fetchByPrimaryKey(understanding_benefits_id);
	}

	/**
	 * Returns the understanding_benefits with the primary key.
	 *
	 * @param understanding_benefits_id the primary key of the understanding_benefits
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public understanding_benefits getunderstanding_benefits(
		long understanding_benefits_id) throws PortalException, SystemException {
		return understanding_benefitsPersistence.findByPrimaryKey(understanding_benefits_id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return understanding_benefitsPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<understanding_benefits> getunderstanding_benefitses(int start,
		int end) throws SystemException {
		return understanding_benefitsPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getunderstanding_benefitsesCount() throws SystemException {
		return understanding_benefitsPersistence.countAll();
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public understanding_benefits updateunderstanding_benefits(
		understanding_benefits understanding_benefits)
		throws SystemException {
		return updateunderstanding_benefits(understanding_benefits, true);
	}
	 ...
	 *
	 * @param understanding_benefits the understanding_benefits
	 * @param merge whether to merge the understanding_benefits with the current session. See {@link com.liferay.portal.service.persistence.BatchSession#update(com.liferay.portal.kernel.dao.orm.Session, com.liferay.portal.model.BaseModel, boolean)} for an explanation.
	 * @return the understanding_benefits that was updated
	 * @throws SystemException if a system exception occurred
	 */
	@Indexable(type = IndexableType.REINDEX)
	...
	/**
	 * Returns the understanding_benefits local service.
	 *
	 * @return the understanding_benefits local service
	 */
	public understanding_benefitsLocalService getunderstanding_benefitsLocalService() {
		return understanding_benefitsLocalService;
	}

	/**
	 * Sets the understanding_benefits local service.
	 *
	 * @param understanding_benefitsLocalService the understanding_benefits local service
	 */
	public void setunderstanding_benefitsLocalService(
		understanding_benefitsLocalService understanding_benefitsLocalService) {
		this.understanding_benefitsLocalService = understanding_benefitsLocalService;
	}

	/**
	 * Returns the understanding_benefits persistence.
	 *
	 * @return the understanding_benefits persistence
	 */
	public understanding_benefitsPersistence getunderstanding_benefitsPersistence() {
		return understanding_benefitsPersistence;
	}

	/**
	 * Sets the understanding_benefits persistence.
	 *
	 * @param understanding_benefitsPersistence the understanding_benefits persistence
	 */
	public void setunderstanding_benefitsPersistence(
		understanding_benefitsPersistence understanding_benefitsPersistence) {
		this.understanding_benefitsPersistence = understanding_benefitsPersistence;
	}

	/**
	 * Returns the understanding_benefits_lkp local service.
	 *
	 * @return the understanding_benefits_lkp local service
	 */
	public understanding_benefits_lkpLocalService getunderstanding_benefits_lkpLocalService() {
		return understanding_benefits_lkpLocalService;
	}

	/**
	 * Sets the understanding_benefits_lkp local service.
	 *
	 * @param understanding_benefits_lkpLocalService the understanding_benefits_lkp local service
	 */
	public void setunderstanding_benefits_lkpLocalService(
		understanding_benefits_lkpLocalService understanding_benefits_lkpLocalService) {
		this.understanding_benefits_lkpLocalService = understanding_benefits_lkpLocalService;
	}

	/**
	 * Returns the understanding_benefits_lkp persistence.
	 *
	 * @return the understanding_benefits_lkp persistence
	 */
	public understanding_benefits_lkpPersistence getunderstanding_benefits_lkpPersistence() {
		return understanding_benefits_lkpPersistence;
	}

	/**
	 * Sets the understanding_benefits_lkp persistence.
	 *
	 * @param understanding_benefits_lkpPersistence the understanding_benefits_lkp persistence
	 */
	public void setunderstanding_benefits_lkpPersistence(
		understanding_benefits_lkpPersistence understanding_benefits_lkpPersistence) {
		this.understanding_benefits_lkpPersistence = understanding_benefits_lkpPersistence;
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.iucn.whp.dbservice.model.understanding_benefits",
			understanding_benefitsLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.iucn.whp.dbservice.model.understanding_benefits");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = understanding_benefitsPersistence.getDataSource();
	...
	@BeanReference(type = understanding_benefitsLocalService.class)
	protected understanding_benefitsLocalService understanding_benefitsLocalService;
	...
	@BeanReference(type = understanding_benefits_lkpLocalService.class)
	protected understanding_benefits_lkpLocalService understanding_benefits_lkpLocalService;
	...
	private understanding_benefitsLocalServiceClpInvoker _clpInvoker = new understanding_benefitsLocalServiceClpInvoker();
}