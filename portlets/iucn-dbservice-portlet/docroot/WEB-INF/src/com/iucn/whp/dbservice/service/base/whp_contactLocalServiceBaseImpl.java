...
/**
 * The base implementation of the whp_contact local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.iucn.whp.dbservice.service.impl.whp_contactLocalServiceImpl}.
 * </p>
 *
 * @author alok.sen
 * @see com.iucn.whp.dbservice.service.impl.whp_contactLocalServiceImpl
 * @see com.iucn.whp.dbservice.service.whp_contactLocalServiceUtil
 * @generated
 */
public abstract class whp_contactLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements whp_contactLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.iucn.whp.dbservice.service.whp_contactLocalServiceUtil} to access the whp_contact local service.
	 */
	...
	public whp_contact addwhp_contact(whp_contact whp_contact)
		throws SystemException {
		whp_contact.setNew(true);

		return whp_contactPersistence.update(whp_contact, false);
	}
	 ...
	 */
	public whp_contact createwhp_contact(int contact_id) {
		return whp_contactPersistence.create(contact_id);
	}
	...
	public whp_contact deletewhp_contact(int contact_id)
		throws PortalException, SystemException {
		return whp_contactPersistence.remove(contact_id);
	}
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public whp_contact deletewhp_contact(whp_contact whp_contact)
		throws SystemException {
		return whp_contactPersistence.remove(whp_contact);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(whp_contact.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return whp_contactPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return whp_contactPersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return whp_contactPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public whp_contact fetchwhp_contact(int contact_id)
		throws SystemException {
		return whp_contactPersistence.fetchByPrimaryKey(contact_id);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public whp_contact getwhp_contact(int contact_id)
		throws PortalException, SystemException {
		return whp_contactPersistence.findByPrimaryKey(contact_id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return whp_contactPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<whp_contact> getwhp_contacts(int start, int end)
		throws SystemException {
		return whp_contactPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getwhp_contactsCount() throws SystemException {
		return whp_contactPersistence.countAll();
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public whp_contact updatewhp_contact(whp_contact whp_contact)
		throws SystemException {
		return updatewhp_contact(whp_contact, true);
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public whp_contact updatewhp_contact(whp_contact whp_contact, boolean merge)
		throws SystemException {
		whp_contact.setNew(false);

		return whp_contactPersistence.update(whp_contact, merge);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.iucn.whp.dbservice.model.whp_contact",
			whp_contactLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.iucn.whp.dbservice.model.whp_contact");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = whp_contactPersistence.getDataSource();
	...
	private whp_contactLocalServiceClpInvoker _clpInvoker = new whp_contactLocalServiceClpInvoker();
}