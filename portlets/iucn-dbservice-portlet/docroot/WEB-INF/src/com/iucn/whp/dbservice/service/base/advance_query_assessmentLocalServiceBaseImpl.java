...
/**
 * The base implementation of the advance_query_assessment local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.iucn.whp.dbservice.service.impl.advance_query_assessmentLocalServiceImpl}.
 * </p>
 *
 * @author alok.sen
 ...
 * @generated
 */
public abstract class advance_query_assessmentLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements advance_query_assessmentLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.iucn.whp.dbservice.service.advance_query_assessmentLocalServiceUtil} to access the advance_query_assessment local service.
	 */
	...
	public advance_query_assessment addadvance_query_assessment(
		advance_query_assessment advance_query_assessment)
		throws SystemException {
		advance_query_assessment.setNew(true);

		return advance_query_assessmentPersistence.update(advance_query_assessment,
			false);
	}
	 ...
	 */
	public advance_query_assessment createadvance_query_assessment(long id) {
		return advance_query_assessmentPersistence.create(id);
	}
	...
	public advance_query_assessment deleteadvance_query_assessment(long id)
		throws PortalException, SystemException {
		return advance_query_assessmentPersistence.remove(id);
	}
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public advance_query_assessment deleteadvance_query_assessment(
		advance_query_assessment advance_query_assessment)
		throws SystemException {
		return advance_query_assessmentPersistence.remove(advance_query_assessment);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(advance_query_assessment.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return advance_query_assessmentPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return advance_query_assessmentPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public advance_query_assessment fetchadvance_query_assessment(long id)
		throws SystemException {
		return advance_query_assessmentPersistence.fetchByPrimaryKey(id);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public advance_query_assessment getadvance_query_assessment(long id)
		throws PortalException, SystemException {
		return advance_query_assessmentPersistence.findByPrimaryKey(id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return advance_query_assessmentPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<advance_query_assessment> getadvance_query_assessments(
		int start, int end) throws SystemException {
		return advance_query_assessmentPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getadvance_query_assessmentsCount() throws SystemException {
		return advance_query_assessmentPersistence.countAll();
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public advance_query_assessment updateadvance_query_assessment(
		advance_query_assessment advance_query_assessment)
		throws SystemException {
		return updateadvance_query_assessment(advance_query_assessment, true);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.iucn.whp.dbservice.model.advance_query_assessment",
			advance_query_assessmentLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = advance_query_assessmentPersistence.getDataSource();
	...
	private advance_query_assessmentLocalServiceClpInvoker _clpInvoker = new advance_query_assessmentLocalServiceClpInvoker();
}