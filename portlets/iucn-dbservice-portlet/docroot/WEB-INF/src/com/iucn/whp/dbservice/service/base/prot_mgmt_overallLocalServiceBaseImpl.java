...
/**
 * The base implementation of the prot_mgmt_overall local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.iucn.whp.dbservice.service.impl.prot_mgmt_overallLocalServiceImpl}.
 * </p>
 *
 * @author alok.sen
 ...
 * @generated
 */
public abstract class prot_mgmt_overallLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements prot_mgmt_overallLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.iucn.whp.dbservice.service.prot_mgmt_overallLocalServiceUtil} to access the prot_mgmt_overall local service.
	 */
	...
	public prot_mgmt_overall addprot_mgmt_overall(
		prot_mgmt_overall prot_mgmt_overall) throws SystemException {
		prot_mgmt_overall.setNew(true);

		return prot_mgmt_overallPersistence.update(prot_mgmt_overall, false);
	}
	 ...
	 */
	public prot_mgmt_overall createprot_mgmt_overall(long pmo_id) {
		return prot_mgmt_overallPersistence.create(pmo_id);
	}
	...
	public prot_mgmt_overall deleteprot_mgmt_overall(long pmo_id)
		throws PortalException, SystemException {
		return prot_mgmt_overallPersistence.remove(pmo_id);
	}
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public prot_mgmt_overall deleteprot_mgmt_overall(
		prot_mgmt_overall prot_mgmt_overall) throws SystemException {
		return prot_mgmt_overallPersistence.remove(prot_mgmt_overall);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(prot_mgmt_overall.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return prot_mgmt_overallPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return prot_mgmt_overallPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public prot_mgmt_overall fetchprot_mgmt_overall(long pmo_id)
		throws SystemException {
		return prot_mgmt_overallPersistence.fetchByPrimaryKey(pmo_id);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public prot_mgmt_overall getprot_mgmt_overall(long pmo_id)
		throws PortalException, SystemException {
		return prot_mgmt_overallPersistence.findByPrimaryKey(pmo_id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return prot_mgmt_overallPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<prot_mgmt_overall> getprot_mgmt_overalls(int start, int end)
		throws SystemException {
		return prot_mgmt_overallPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getprot_mgmt_overallsCount() throws SystemException {
		return prot_mgmt_overallPersistence.countAll();
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public prot_mgmt_overall updateprot_mgmt_overall(
		prot_mgmt_overall prot_mgmt_overall) throws SystemException {
		return updateprot_mgmt_overall(prot_mgmt_overall, true);
	}
	...
	public prot_mgmt_overall updateprot_mgmt_overall(
		...
		return prot_mgmt_overallPersistence.update(prot_mgmt_overall, merge);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.iucn.whp.dbservice.model.prot_mgmt_overall",
			prot_mgmt_overallLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = prot_mgmt_overallPersistence.getDataSource();
	...
	private prot_mgmt_overallLocalServiceClpInvoker _clpInvoker = new prot_mgmt_overallLocalServiceClpInvoker();
}