...
/**
 * The base implementation of the benefit_checktype_lkp local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.iucn.whp.dbservice.service.impl.benefit_checktype_lkpLocalServiceImpl}.
 * </p>
 *
 * @author alok.sen
 ...
 * @generated
 */
public abstract class benefit_checktype_lkpLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements benefit_checktype_lkpLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.iucn.whp.dbservice.service.benefit_checktype_lkpLocalServiceUtil} to access the benefit_checktype_lkp local service.
	 */
	...
	public benefit_checktype_lkp addbenefit_checktype_lkp(
		benefit_checktype_lkp benefit_checktype_lkp) throws SystemException {
		benefit_checktype_lkp.setNew(true);

		return benefit_checktype_lkpPersistence.update(benefit_checktype_lkp,
			false);
	}
	 ...
	 */
	public benefit_checktype_lkp createbenefit_checktype_lkp(long benefit_id) {
		return benefit_checktype_lkpPersistence.create(benefit_id);
	}
	...
	public benefit_checktype_lkp deletebenefit_checktype_lkp(long benefit_id)
		throws PortalException, SystemException {
		return benefit_checktype_lkpPersistence.remove(benefit_id);
	}
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public benefit_checktype_lkp deletebenefit_checktype_lkp(
		benefit_checktype_lkp benefit_checktype_lkp) throws SystemException {
		return benefit_checktype_lkpPersistence.remove(benefit_checktype_lkp);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(benefit_checktype_lkp.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return benefit_checktype_lkpPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return benefit_checktype_lkpPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public benefit_checktype_lkp fetchbenefit_checktype_lkp(long benefit_id)
		throws SystemException {
		return benefit_checktype_lkpPersistence.fetchByPrimaryKey(benefit_id);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public benefit_checktype_lkp getbenefit_checktype_lkp(long benefit_id)
		throws PortalException, SystemException {
		return benefit_checktype_lkpPersistence.findByPrimaryKey(benefit_id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return benefit_checktype_lkpPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<benefit_checktype_lkp> getbenefit_checktype_lkps(int start,
		int end) throws SystemException {
		return benefit_checktype_lkpPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getbenefit_checktype_lkpsCount() throws SystemException {
		return benefit_checktype_lkpPersistence.countAll();
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public benefit_checktype_lkp updatebenefit_checktype_lkp(
		benefit_checktype_lkp benefit_checktype_lkp) throws SystemException {
		return updatebenefit_checktype_lkp(benefit_checktype_lkp, true);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.iucn.whp.dbservice.model.benefit_checktype_lkp",
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = benefit_checktype_lkpPersistence.getDataSource();
	...
	private benefit_checktype_lkpLocalServiceClpInvoker _clpInvoker = new benefit_checktype_lkpLocalServiceClpInvoker();
}