...
/**
 * The base implementation of the understanding_benefits_lkp local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.iucn.whp.dbservice.service.impl.understanding_benefits_lkpLocalServiceImpl}.
 * </p>
 *
 * @author alok.sen
 * @see com.iucn.whp.dbservice.service.impl.understanding_benefits_lkpLocalServiceImpl
 * @see com.iucn.whp.dbservice.service.understanding_benefits_lkpLocalServiceUtil
 * @generated
 */
public abstract class understanding_benefits_lkpLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements understanding_benefits_lkpLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.iucn.whp.dbservice.service.understanding_benefits_lkpLocalServiceUtil} to access the understanding_benefits_lkp local service.
	 */
	...
	public understanding_benefits_lkp addunderstanding_benefits_lkp(
		understanding_benefits_lkp understanding_benefits_lkp)
		throws SystemException {
		understanding_benefits_lkp.setNew(true);

		return understanding_benefits_lkpPersistence.update(understanding_benefits_lkp,
			false);
	}
	 ...
	 */
	public understanding_benefits_lkp createunderstanding_benefits_lkp(
		long benefits_id) {
		return understanding_benefits_lkpPersistence.create(benefits_id);
	}
	...
	public understanding_benefits_lkp deleteunderstanding_benefits_lkp(
		long benefits_id) throws PortalException, SystemException {
		return understanding_benefits_lkpPersistence.remove(benefits_id);
	}
	...
	public understanding_benefits_lkp deleteunderstanding_benefits_lkp(
		understanding_benefits_lkp understanding_benefits_lkp)
		throws SystemException {
		return understanding_benefits_lkpPersistence.remove(understanding_benefits_lkp);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(understanding_benefits_lkp.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return understanding_benefits_lkpPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return understanding_benefits_lkpPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public understanding_benefits_lkp fetchunderstanding_benefits_lkp(
		long benefits_id) throws SystemException {
		return understanding_benefits_lkpPersistence.fetchByPrimaryKey(benefits_id);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public understanding_benefits_lkp getunderstanding_benefits_lkp(
		long benefits_id) throws PortalException, SystemException {
		return understanding_benefits_lkpPersistence.findByPrimaryKey(benefits_id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return understanding_benefits_lkpPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<understanding_benefits_lkp> getunderstanding_benefits_lkps(
		int start, int end) throws SystemException {
		return understanding_benefits_lkpPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getunderstanding_benefits_lkpsCount() throws SystemException {
		return understanding_benefits_lkpPersistence.countAll();
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public understanding_benefits_lkp updateunderstanding_benefits_lkp(
		understanding_benefits_lkp understanding_benefits_lkp)
		throws SystemException {
		return updateunderstanding_benefits_lkp(understanding_benefits_lkp, true);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.iucn.whp.dbservice.model.understanding_benefits_lkp",
			understanding_benefits_lkpLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.iucn.whp.dbservice.model.understanding_benefits_lkp");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = understanding_benefits_lkpPersistence.getDataSource();
	...
	private understanding_benefits_lkpLocalServiceClpInvoker _clpInvoker = new understanding_benefits_lkpLocalServiceClpInvoker();
}