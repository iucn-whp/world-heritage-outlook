...
/**
 * The base implementation of the whp_sites_boundary_modification local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.iucn.whp.dbservice.service.impl.whp_sites_boundary_modificationLocalServiceImpl}.
 * </p>
 *
 * @author alok.sen
 * @see com.iucn.whp.dbservice.service.impl.whp_sites_boundary_modificationLocalServiceImpl
 * @see com.iucn.whp.dbservice.service.whp_sites_boundary_modificationLocalServiceUtil
 * @generated
 */
public abstract class whp_sites_boundary_modificationLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements whp_sites_boundary_modificationLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.iucn.whp.dbservice.service.whp_sites_boundary_modificationLocalServiceUtil} to access the whp_sites_boundary_modification local service.
	 */
	...
	public whp_sites_boundary_modification addwhp_sites_boundary_modification(
		whp_sites_boundary_modification whp_sites_boundary_modification)
		throws SystemException {
		whp_sites_boundary_modification.setNew(true);

		return whp_sites_boundary_modificationPersistence.update(whp_sites_boundary_modification,
			false);
	}
	 ...
	 */
	public whp_sites_boundary_modification createwhp_sites_boundary_modification(
		long whp_sites_boundary_modification_id) {
		return whp_sites_boundary_modificationPersistence.create(whp_sites_boundary_modification_id);
	}
	...
	public whp_sites_boundary_modification deletewhp_sites_boundary_modification(
		long whp_sites_boundary_modification_id)
		throws PortalException, SystemException {
		return whp_sites_boundary_modificationPersistence.remove(whp_sites_boundary_modification_id);
	}
	...
	public whp_sites_boundary_modification deletewhp_sites_boundary_modification(
		whp_sites_boundary_modification whp_sites_boundary_modification)
		throws SystemException {
		return whp_sites_boundary_modificationPersistence.remove(whp_sites_boundary_modification);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(whp_sites_boundary_modification.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return whp_sites_boundary_modificationPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return whp_sites_boundary_modificationPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public whp_sites_boundary_modification fetchwhp_sites_boundary_modification(
		long whp_sites_boundary_modification_id) throws SystemException {
		return whp_sites_boundary_modificationPersistence.fetchByPrimaryKey(whp_sites_boundary_modification_id);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public whp_sites_boundary_modification getwhp_sites_boundary_modification(
		long whp_sites_boundary_modification_id)
		throws PortalException, SystemException {
		return whp_sites_boundary_modificationPersistence.findByPrimaryKey(whp_sites_boundary_modification_id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return whp_sites_boundary_modificationPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<whp_sites_boundary_modification> getwhp_sites_boundary_modifications(
		int start, int end) throws SystemException {
		return whp_sites_boundary_modificationPersistence.findAll(start, end);
	}
	...
	public int getwhp_sites_boundary_modificationsCount()
		throws SystemException {
		return whp_sites_boundary_modificationPersistence.countAll();
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public whp_sites_boundary_modification updatewhp_sites_boundary_modification(
		whp_sites_boundary_modification whp_sites_boundary_modification)
		throws SystemException {
		return updatewhp_sites_boundary_modification(whp_sites_boundary_modification,
			true);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.iucn.whp.dbservice.model.whp_sites_boundary_modification",
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = whp_sites_boundary_modificationPersistence.getDataSource();
	...
	private whp_sites_boundary_modificationLocalServiceClpInvoker _clpInvoker = new whp_sites_boundary_modificationLocalServiceClpInvoker();
}