...
/**
 * The base implementation of the threat_categories_lkp local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.iucn.whp.dbservice.service.impl.threat_categories_lkpLocalServiceImpl}.
 * </p>
 *
 * @author alok.sen
 * @see com.iucn.whp.dbservice.service.impl.threat_categories_lkpLocalServiceImpl
 * @see com.iucn.whp.dbservice.service.threat_categories_lkpLocalServiceUtil
 * @generated
 */
public abstract class threat_categories_lkpLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements threat_categories_lkpLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.iucn.whp.dbservice.service.threat_categories_lkpLocalServiceUtil} to access the threat_categories_lkp local service.
	 */
	...
	public threat_categories_lkp addthreat_categories_lkp(
		threat_categories_lkp threat_categories_lkp) throws SystemException {
		threat_categories_lkp.setNew(true);

		return threat_categories_lkpPersistence.update(threat_categories_lkp,
			false);
	}
	 ...
	 */
	public threat_categories_lkp createthreat_categories_lkp(
		long threatCategoryid) {
		return threat_categories_lkpPersistence.create(threatCategoryid);
	}
	...
	public threat_categories_lkp deletethreat_categories_lkp(
		long threatCategoryid) throws PortalException, SystemException {
		return threat_categories_lkpPersistence.remove(threatCategoryid);
	}
	...
	public threat_categories_lkp deletethreat_categories_lkp(
		threat_categories_lkp threat_categories_lkp) throws SystemException {
		return threat_categories_lkpPersistence.remove(threat_categories_lkp);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(threat_categories_lkp.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return threat_categories_lkpPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return threat_categories_lkpPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public threat_categories_lkp fetchthreat_categories_lkp(
		long threatCategoryid) throws SystemException {
		return threat_categories_lkpPersistence.fetchByPrimaryKey(threatCategoryid);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public threat_categories_lkp getthreat_categories_lkp(long threatCategoryid)
		throws PortalException, SystemException {
		return threat_categories_lkpPersistence.findByPrimaryKey(threatCategoryid);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return threat_categories_lkpPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<threat_categories_lkp> getthreat_categories_lkps(int start,
		int end) throws SystemException {
		return threat_categories_lkpPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getthreat_categories_lkpsCount() throws SystemException {
		return threat_categories_lkpPersistence.countAll();
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public threat_categories_lkp updatethreat_categories_lkp(
		threat_categories_lkp threat_categories_lkp) throws SystemException {
		return updatethreat_categories_lkp(threat_categories_lkp, true);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.iucn.whp.dbservice.model.threat_categories_lkp",
			threat_categories_lkpLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.iucn.whp.dbservice.model.threat_categories_lkp");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = threat_categories_lkpPersistence.getDataSource();
	...
	private threat_categories_lkpLocalServiceClpInvoker _clpInvoker = new threat_categories_lkpLocalServiceClpInvoker();
}