...
/**
 * The base implementation of the whp_sites_dsocr local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.iucn.whp.dbservice.service.impl.whp_sites_dsocrLocalServiceImpl}.
 * </p>
 *
 * @author alok.sen
 * @see com.iucn.whp.dbservice.service.impl.whp_sites_dsocrLocalServiceImpl
 * @see com.iucn.whp.dbservice.service.whp_sites_dsocrLocalServiceUtil
 * @generated
 */
public abstract class whp_sites_dsocrLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements whp_sites_dsocrLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.iucn.whp.dbservice.service.whp_sites_dsocrLocalServiceUtil} to access the whp_sites_dsocr local service.
	 */
	...
	public whp_sites_dsocr addwhp_sites_dsocr(whp_sites_dsocr whp_sites_dsocr)
		throws SystemException {
		whp_sites_dsocr.setNew(true);

		return whp_sites_dsocrPersistence.update(whp_sites_dsocr, false);
	}
	 ...
	 */
	public whp_sites_dsocr createwhp_sites_dsocr(long whp_sites_dsocr_id) {
		return whp_sites_dsocrPersistence.create(whp_sites_dsocr_id);
	}
	...
	public whp_sites_dsocr deletewhp_sites_dsocr(long whp_sites_dsocr_id)
		throws PortalException, SystemException {
		return whp_sites_dsocrPersistence.remove(whp_sites_dsocr_id);
	}
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public whp_sites_dsocr deletewhp_sites_dsocr(
		whp_sites_dsocr whp_sites_dsocr) throws SystemException {
		return whp_sites_dsocrPersistence.remove(whp_sites_dsocr);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(whp_sites_dsocr.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return whp_sites_dsocrPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return whp_sites_dsocrPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public whp_sites_dsocr fetchwhp_sites_dsocr(long whp_sites_dsocr_id)
		throws SystemException {
		return whp_sites_dsocrPersistence.fetchByPrimaryKey(whp_sites_dsocr_id);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public whp_sites_dsocr getwhp_sites_dsocr(long whp_sites_dsocr_id)
		throws PortalException, SystemException {
		return whp_sites_dsocrPersistence.findByPrimaryKey(whp_sites_dsocr_id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return whp_sites_dsocrPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<whp_sites_dsocr> getwhp_sites_dsocrs(int start, int end)
		throws SystemException {
		return whp_sites_dsocrPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getwhp_sites_dsocrsCount() throws SystemException {
		return whp_sites_dsocrPersistence.countAll();
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public whp_sites_dsocr updatewhp_sites_dsocr(
		whp_sites_dsocr whp_sites_dsocr) throws SystemException {
		return updatewhp_sites_dsocr(whp_sites_dsocr, true);
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	public whp_sites_dsocr updatewhp_sites_dsocr(
		whp_sites_dsocr whp_sites_dsocr, boolean merge)
		throws SystemException {
		whp_sites_dsocr.setNew(false);

		return whp_sites_dsocrPersistence.update(whp_sites_dsocr, merge);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.iucn.whp.dbservice.model.whp_sites_dsocr",
			whp_sites_dsocrLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = whp_sites_dsocrPersistence.getDataSource();
	...
	private whp_sites_dsocrLocalServiceClpInvoker _clpInvoker = new whp_sites_dsocrLocalServiceClpInvoker();
}