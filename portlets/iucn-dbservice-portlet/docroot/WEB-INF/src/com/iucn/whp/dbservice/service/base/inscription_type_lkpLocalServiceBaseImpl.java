...
/**
 * The base implementation of the inscription_type_lkp local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.iucn.whp.dbservice.service.impl.inscription_type_lkpLocalServiceImpl}.
 * </p>
 *
 * @author alok.sen
 * @see com.iucn.whp.dbservice.service.impl.inscription_type_lkpLocalServiceImpl
 * @see com.iucn.whp.dbservice.service.inscription_type_lkpLocalServiceUtil
 * @generated
 */
public abstract class inscription_type_lkpLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements inscription_type_lkpLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.iucn.whp.dbservice.service.inscription_type_lkpLocalServiceUtil} to access the inscription_type_lkp local service.
	 */
	...
	public inscription_type_lkp addinscription_type_lkp(
		inscription_type_lkp inscription_type_lkp) throws SystemException {
		inscription_type_lkp.setNew(true);

		return inscription_type_lkpPersistence.update(inscription_type_lkp,
			false);
	}
	 ...
	 */
	public inscription_type_lkp createinscription_type_lkp(
		int incription_type_id) {
		return inscription_type_lkpPersistence.create(incription_type_id);
	}
	...
	public inscription_type_lkp deleteinscription_type_lkp(
		int incription_type_id) throws PortalException, SystemException {
		return inscription_type_lkpPersistence.remove(incription_type_id);
	}
	...
	public inscription_type_lkp deleteinscription_type_lkp(
		inscription_type_lkp inscription_type_lkp) throws SystemException {
		return inscription_type_lkpPersistence.remove(inscription_type_lkp);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(inscription_type_lkp.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return inscription_type_lkpPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return inscription_type_lkpPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public inscription_type_lkp fetchinscription_type_lkp(
		int incription_type_id) throws SystemException {
		return inscription_type_lkpPersistence.fetchByPrimaryKey(incription_type_id);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public inscription_type_lkp getinscription_type_lkp(int incription_type_id)
		throws PortalException, SystemException {
		return inscription_type_lkpPersistence.findByPrimaryKey(incription_type_id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return inscription_type_lkpPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<inscription_type_lkp> getinscription_type_lkps(int start,
		int end) throws SystemException {
		return inscription_type_lkpPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getinscription_type_lkpsCount() throws SystemException {
		return inscription_type_lkpPersistence.countAll();
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public inscription_type_lkp updateinscription_type_lkp(
		inscription_type_lkp inscription_type_lkp) throws SystemException {
		return updateinscription_type_lkp(inscription_type_lkp, true);
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	public inscription_type_lkp updateinscription_type_lkp(
		inscription_type_lkp inscription_type_lkp, boolean merge)
		throws SystemException {
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.iucn.whp.dbservice.model.inscription_type_lkp",
			inscription_type_lkpLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.iucn.whp.dbservice.model.inscription_type_lkp");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = inscription_type_lkpPersistence.getDataSource();
	...
	private inscription_type_lkpLocalServiceClpInvoker _clpInvoker = new inscription_type_lkpLocalServiceClpInvoker();
}