	...
	<td class="lblTD">
		<label class="popuplbl">Select Inside/Outside Site:</label>
				...
				<td class="valueTD">
						...
						<aui:input type="checkbox" onClick= "insideSiteShowBlock()" name = "insideSite" id = "insideSite" label=""
		...
		<td>
			...
			<div style="width: 33%; float: left">
				<label><input type="checkbox" id = "notKnownThreat" <c:if test="<%= \"Extent of threat not known\".equals(threadExtentValue)%>">checked</c:if>
							  onClick= "selectOnlyThis(this)"  data-thread-extent="notKnownThreat" /> Extent of threat not known</label>
			</div>
			<div style="width: 33%; float: left">
