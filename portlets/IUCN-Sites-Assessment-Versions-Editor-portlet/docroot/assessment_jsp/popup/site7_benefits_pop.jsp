...
<!-- 	<select id="benefitSubtype" name="benefitSubtype" multiple  size="6"   style="width:400px;" >
 -->
				<div class="checkboxList" id="subtype">
					...
					<input type="checkbox" name="benefitSubtype" id="benefitSubtype" checked value="<%=tempbenefit_checksubtype_lkp.getSubbenefit_id() %>"><%=tempbenefit_checksubtype_lkp.getBenefit_checksubtype()%>
					<br>
					...
					<input type="checkbox" name="benefitSubtype" id="benefitSubtype" value="<%=tempbenefit_checksubtype_lkp.getSubbenefit_id() %>"><%=tempbenefit_checksubtype_lkp.getBenefit_checksubtype()%>
					<br>
					<%
								}
							}
		...
		<tr>
			<td class="lblTD" colspan="2"><label class="popuplbl">Factors negatively affecting provision of selected benefit:</label></td>
		</tr>
		...
		<tr>
			...
			<td>
				<div>
					<aui:select label="" id="habitatChangeLevel" name="habitatChangeLevel" cssClass="negative-factors-table">
					...
					<aui:select label="" id="habitatChangeTrend" name="habitatChangeTrend" cssClass="negative-factors-table">
						<aui:option value="0">Select</aui:option>
		...
		<tr>
			...
			<td>
				<div>
					<aui:select label="" id="overExploitationLevel" name="overExploitationLevel" cssClass="negative-factors-table">
						<aui:option value="0">Select</aui:option>
						<c:forEach items="${negativeLevels}" var="negativeFactorLevel">
					...
					<aui:select label="" id="overExploitationTrend" name="overExploitationTrend" cssClass="negative-factors-table">
						<aui:option value="0">Select</aui:option>
						<c:forEach items="${trends}" var="negativeFactorTrend">
		...
		<tr>
			...
			<td>
				<div>
					<aui:select label="" id="climateChangeLevel" name="climateChangeLevel" cssClass="negative-factors-table">
						<aui:option value="0">Select</aui:option>
						<c:forEach items="${negativeLevels}" var="negativeFactorLevel">
					...
					<aui:select label="" id="climateChangeTrend" name="climateChangeTrend" cssClass="negative-factors-table">
						<aui:option value="0">Select</aui:option>
						<c:forEach items="${trends}" var="negativeFactorTrend">
		...
		<tr>
			...
			<td>
				<div>
					<aui:select label="" id="invasiveSpeciesLevel" name="invasiveSpeciesLevel" cssClass="negative-factors-table">
						<aui:option value="0">Select</aui:option>
						<c:forEach items="${negativeLevels}" var="negativeFactorLevel">
					...
					<aui:select label="" id="invasiveSpeciesTrend" name="invasiveSpeciesTrend" cssClass="negative-factors-table">
						<aui:option value="0">Select</aui:option>
						<c:forEach items="${trends}" var="negativeFactorTrend">
		...
		<tr>
			<td class="lblTD">
				<label class="popuplbl"> Any comments: </label>
			</td>
			<td spellcheck="true" class="valueTD">
