...
<%
   ...
   if(userId<=0){
    ...
    // assessmentCycleID.equals("2016")
    if(assessmentCycleID.equals("2017") || assessmentCycleID.equals("2014")){
        ...
        for(SiteAssessmentDTO siteAssessmentDTOListObj : siteAssessmentDTOList){
            ...
            if(siteAssessmentDTOListObj.getSite_Assessment().getAssessment_cycle().equals(assessmentCycleID) ){
