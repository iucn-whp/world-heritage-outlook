...
<liferay-ui:icon-menu>
   ...
   <%----%>
    <%----%>
    <%--&lt;%&ndash; <portlet:actionURL var="publishAssessmentURL" name="publishAssessmentAction" >--%>
         <%--<portlet:param name="assessmentId" value="<%= primKey %>" />--%>
         <%--<portlet:param name="userId" value="<%= String.valueOf(user.getUserId()) %>" />--%>
    <%--</portlet:actionURL> &ndash;%&gt;--%>
    <%----%>
    <%--<%--%>
    ...
    <%-- Compare and publish versions --%>
    <%--<c:if test="">--%>

        <portlet:actionURL var="compareVersionsURL" name="compareVersions">
            <portlet:param name="userId" value="<%= String.valueOf(user.getUserId()) %>"/>
            <portlet:param name="siteId" value="<%= String.valueOf(siteId) %>"/>
        </portlet:actionURL>

        <liferay-ui:icon image="edit" message="<%=AssessmentContstant.COMPARE_VERSIONS %>" url="<%=compareVersionsURL %>" />
