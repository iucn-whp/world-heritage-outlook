...
<div class="mainBlock siteInfoMainBlock">
    <div class="tableWrapper tableWrapperSiteInfoContacts">
        ...
        <div id="step3Div">
            ...
            <div class="infoSection">
                <h2 class="siteAssessmentSubHeadings">Assessing Protection &amp; Management
                    <a href="#"
                       onclick="javascript:getPopupStepThree('/assessment_jsp/popup/addStep3_protection_mgt.jsp','','Assessing Protection and Management',event); return false;"
                       class="addBtn hideAdminAction">+Assess Protection & Management</a>

                </h2>
                <div class="tipsSection">
                    <p class="tiptext">
                        Assess the state of protection and management of the World Heritage site below. Determine
                        the effectiveness of protection and management under each topic by selecting one of five
                        ratings: Highly Effective, Mostly Effective, Some Concern, Serious Concern and Data
                        Deficient. These ratings are defined in Table 3.1 of the Guidelines, and questions to
                        help guide the assessment are provided in Table 3.2. The 'Justification for assessment' must
                        be systematically referenced, e.g. (SOC report, 2009). <a target="_blank" href="<%= themeDisplay.getURLPortal().concat("/")
        ...
        <div class="infoSection">
            <h2 class="siteAssessmentSubHeadings">Overall assessment of protection and management</h2>
            <div class="tipsSection">
    ...
    <div class="wizardFooter">
        ...
        <a href="#" class="roundedcornerBTN" onclick="javascript:$('#step4').click();"><span>Save and continue &#62;&#62;</span></a>
    </div>
...
<div class="buttonsSiteAssessment hideAdminAction">
    ...
    <c:if test="<%= AssessmentActionUtil.hasLinkVisible(currentAssessmentId, user.getUserId(), AssessmentContstant.ACTION_VIEW_DIFFERENCES) %>">
        <input type="button" value="View Differences" onClick="javascript:viewDiff_3();"/>
    </c:if>
    <c:if test="<%= AssessmentActionUtil.hasLinkVisible(currentAssessmentId, user.getUserId(), AssessmentContstant.ACTION_CLEAR_HIGHLIGHTS) %>">
        <input type="button" value="Clear Highlights" onClick="javascript:removeDiff_3();"/>
    </c:if>
