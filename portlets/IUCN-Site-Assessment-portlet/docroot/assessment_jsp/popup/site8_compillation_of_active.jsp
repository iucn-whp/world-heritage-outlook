...
>
	...
	<table class="formBlock">
	    ...
	    <aui:input
	        name="acpid"
	        id="acpid"
	        value="<%= active_conservation.getAcpid() %>"
	        type="hidden"
	    />
	...
	<td>
		<aui:input 
			...
			id="organisation" 
			name= "organisation" 
			value= "<%=active_conservation.getOrganization_individual() %>"
			style="width:440px;"/>
	</td>
	</tr>
	...
	<td spellcheck="true" class="valueTD">
		<aui:input 
			...
			id="description" 
			name= "description" 
			value= "<%=active_conservation.getDescription() %>"
			/>
	</td>
	</tr>
	<tr>
	...
	<aui:input 
			...
			id="contact" 
			name= "contact" 
			value= "<%=active_conservation.getContact_details() %>"
			/>	
	</td>
	</tr>
