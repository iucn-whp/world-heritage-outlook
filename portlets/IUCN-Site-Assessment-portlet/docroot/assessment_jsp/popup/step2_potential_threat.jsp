        ...
        <tr>
            ...
            <td>
                <select name="threatSubCategory" id="threatSubCategory"
                    ...
                    %>
                    <option value="<%=potential_Threat.getSub_cat_id() %>"
                            title="<%=threatCatStr%>-<%=threatSubCatStr%>">
        ...
        <tr>
            ...
            <td class="valueTD">
                <div class="floatLeftX">
                    ...
                    <aui:input type="checkbox" cssClass="insideSite" name="insideSite" onClick="insideSiteShowBlock()"
                               id="insideSite" label=""
                ...
                <div class="floatLeftX">
                    ...
                    <aui:input type="checkbox" cssClass="outsideSite" name="outsideSite" id="outsideSite" label=""
            ...
            <td>
                ...
                <div style="width: 33%; float: left">
                    <label><input type="checkbox" id="throughout"
                                  ...
                                  onClick="selectOnlyThis(this)" data-thread-extent="throughout"/>
                        Throughout(>50%)</label>
                </div>
                <div style="width: 33%; float: left">
                ...
                <div style="width: 33%; float: left">
                    <label><input type="checkbox" id="notKnownThreat"
                                  ...
                                  onClick="selectOnlyThis(this)" data-thread-extent="notKnownThreat"/> Extent of threat
                        not
                        known</label>
                </div>
                <div style="width: 33%; float: left">
                    <label><input type="checkbox" id="notApplicable"
                                  ...
                                  onClick="selectOnlyThis(this)" data-thread-extent="notApplicable"/> Not
                        applicable</label>
                </div>
