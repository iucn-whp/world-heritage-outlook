...
<table class="tab_data" cellpadding="0" cellspacing="0">
    ...
    <tr>
        ...
        <td class="editIcons hideAdminAction">
            <div class="editDelete">
                <a href="#" onclick="javascript:dynamicPopup('/assessment_jsp/popup/editstep3_pro_iothreat.jsp','<%= objeffective_prot_mgmt_iothreats != null ? objeffective_prot_mgmt_iothreats.getId() :"" %>','Assessment of the effectiveness of protection ',event); return false;"
                   class="edit">edit</a>
            </div>
        </td>
    ...
    <tr>
        ...
        <td class="editIcons hideAdminAction">
            <div class="editDelete">
                <a href="#"
                   onclick="javascript:dynamicPopup('/assessment_jsp/popup/editstep3_pro_overall.jsp','<%=objoverall!=null ? objoverall.getPrimaryKey() :"" %>','Overall assessment of protection and management',event); return false;"
                   class="edit">edit</a>
            </div>
        </td>
    ...
    <tr>
        ...
        <td class="editIcons hideAdminAction">
            <div class="editDelete">
                <a href="#"
                   onclick="javascript:dynamicPopup('/assessment_jsp/popup/editstep3_best_practices.jsp','<%=objbest_practices!=null ? objbest_practices.getPrimaryKey() :"" %>','Best Practice Examples',event); return false;"
                   class="edit">edit</a>
            </div>
        </td>
